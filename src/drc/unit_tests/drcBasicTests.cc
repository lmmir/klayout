...
TEST(2) {
  ...
  drc.set_text(
      ...
      "compare((0.1.um + 120.dbu), 0.22, \"unexpected value when adding "
      "values\")\n"
      ...
      "compare(1.micron, 1.0, \"unexpected value when convering integer "
      "micron\")\n"
      "compare(1.um2, 1.0, \"unexpected value when converting integer um2\")\n"
      "compare(1.mm2, 1000000.0, \"unexpected value when converting integer "
      "mm2\")\n"
      "compare((1.um + 120.dbu), 1.12, \"unexpected value when adding integer "
      "values\")\n"
      "compare(1.mm, 1000.0, \"unexpected value when converting integer mm\")\n"
      "compare(1.m, 1000000.0, \"unexpected value when converting integer "
      "m\")\n");
  drc.set_interpreter(lym::Macro::DSLInterpreter);
  drc.set_dsl_interpreter("drc-dsl");
