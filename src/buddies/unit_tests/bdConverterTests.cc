...
TEST(1) {
  ...
  EXPECT_EQ(bd::converter_main(sizeof(argv) / sizeof(argv[0]), (char **)argv,
                               bd::GenericWriterOptions::cif_format_name),
            0);
...
TEST(2) {
  ...
  EXPECT_EQ(bd::converter_main(sizeof(argv) / sizeof(argv[0]), (char **)argv,
                               bd::GenericWriterOptions::dxf_format_name),
            0);
...
TEST(3) {
  ...
  EXPECT_EQ(bd::converter_main(sizeof(argv) / sizeof(argv[0]), (char **)argv,
                               bd::GenericWriterOptions::gds2_format_name),
            0);
...
TEST(4) {
  ...
  EXPECT_EQ(bd::converter_main(sizeof(argv) / sizeof(argv[0]), (char **)argv,
                               bd::GenericWriterOptions::gds2text_format_name),
            0);
...
TEST(5) {
  ...
  EXPECT_EQ(bd::converter_main(sizeof(argv) / sizeof(argv[0]), (char **)argv,
                               bd::GenericWriterOptions::oasis_format_name),
            0);
...
TEST(6) {
  ...
  const char *argv[] = {"x", input.c_str(), output.c_str(),
                        "--magic-lambda-out=0.005"};

  EXPECT_EQ(bd::converter_main(sizeof(argv) / sizeof(argv[0]), (char **)argv,
                               bd::GenericWriterOptions::mag_format_name),
            0);
