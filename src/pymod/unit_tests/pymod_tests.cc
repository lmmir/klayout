...
//  So if the PYTHONPATH is something like build.linux-released, the "linux"
//  macro set to 1 will make this "build.1-release". So STRINGIFY isn't a real
//  solution. On the other hand that is the only documented way to turn a macro
//  into a string. This will prevent that issue:
#undef linux
