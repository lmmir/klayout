 ...
 *
 *  "self" is a reference to the object that the method is called on or 0 if
 * there is no such object.
 */
VALUE pop_arg(const gsi::ArgType &atype, Proxy *self, gsi::SerialArgs &aserial,
              tl::Heap &heap);
 ...
 * requested class if atype is a ptr: argument must be a boxed type of the
 * required type or an object of the requested class or nil if atype is a cptr:
