...
RdbInserter::RdbInserter(rdb::Database *rdb, rdb::id_type cell_id,
...
TiledRdbOutputReceiver::TiledRdbOutputReceiver(rdb::Database *rdb,
                                               size_t cell_id,
                                               size_t category_id)
    : mp_rdb(rdb), m_cell_id(cell_id), m_category_id(category_id) {
  //  .. nothing yet ..
...
void TiledRdbOutputReceiver::put(size_t /*ix*/, size_t /*iy*/,
                                 const db::Box &tile, size_t /*id*/,
