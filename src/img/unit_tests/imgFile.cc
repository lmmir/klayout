...
TEST(1_FloatMono) {
  img::Object image(12, 8,
                    db::DCplxTrans(1.5, 90.0, true, db::DVector(17, -42)),
                    false, false);
  ...
  dm.false_color_nodes.push_back(std::make_pair(
      0.5, std::make_pair(tl::Color(255, 0, 0), tl::Color(0, 255, 0))));
  dm.false_color_nodes.push_back(std::make_pair(
...
TEST(3_ByteMono) {
  img::Object image(
      12, 8,
      db::Matrix3d(db::DCplxTrans(1.5, 90.0, true, db::DVector(17, -42))),
      false, true);
...
TEST(5_FloatColor) {
  img::Object image(12, 8,
                    db::DCplxTrans(1.5, 90.0, true, db::DVector(17, -42)), true,
                    false);
...
TEST(7_ByteColor) {
  img::Object image(
      12, 8, db::DCplxTrans(1.5, 90.0, true, db::DVector(17, -42)), true, true);
