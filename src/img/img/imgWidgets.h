 ...
 *
 *  This widget has two color buttons and a "lock" checkbox which makes both
 * colors identical
 */
class TwoColorWidget : public QFrame {
  Q_OBJECT
...
public:
  ...
  int selected_node() const { return m_selected; }

  bool has_selection() const { return m_selected >= 0; }
