 ...
 */
static PyObject *pya_channel_write(PyObject *self, PyObject *args) {
  const char *msg = 0;
  ...
  if (PythonInterpreter::instance() &&
      PythonInterpreter::instance()->current_console()) {
    PythonInterpreter::instance()->current_console()->write_str(
        msg, channel->channel);
  }
 ...
 */
static PyObject *pya_channel_flush(PyObject * /*self*/, PyObject *args) {
 ...
 */
static PyObject *pya_channel_isatty(PyObject * /*self*/, PyObject *args) {
  if (!PyArg_ParseTuple(args, "")) {
    return NULL;
  }
  ...
  if (PythonInterpreter::instance() &&
      PythonInterpreter::instance()->current_console() &&
      PythonInterpreter::instance()->current_console()->is_tty()) {
    Py_RETURN_TRUE;
  } else {
    Py_RETURN_FALSE;
  }
 ...
 */
static int pya_channel_init(PyObject *self, PyObject *, PyObject *) {
  PYAChannelObject *channel = (PYAChannelObject *)self;
  channel->channel = gsi::Console::OS_none;
  return 0;
}

void PYAChannelObject::make_class(PyObject *module) {
  static PyTypeObject channel_type = {
      PyVarObject_HEAD_INIT(&PyType_Type, 0) "pya._Channel", // tp_name
      sizeof(PYAChannelObject)                               // tp_size
  };

  static PyMethodDef channel_methods[] = {
      {"write", (PyCFunction)&pya_channel_write, METH_VARARGS,
       "internal stdout/stderr redirection object: write method"},
      {"flush", (PyCFunction)&pya_channel_flush, METH_VARARGS,
       "internal stdout/stderr redirection object: flush method"},
      {"isatty", (PyCFunction)&pya_channel_isatty, METH_VARARGS,
       "internal stdout/stderr redirection object: isatty method"},
      {NULL, NULL},
  };
...
PYAChannelObject *PYAChannelObject::create(gsi::Console::output_stream chn) {
  tl_assert(cls != 0);
 ...
 */
static PyObject *pya_static_attribute_descriptor_get(PyObject *self,
                                                     PyObject * /*obj*/,
                                                     PyObject * /*type*/) {
  PYAStaticAttributeDescriptorObject *attr =
      (PYAStaticAttributeDescriptorObject *)self;
  if (attr->getter) {
 ...
 */
static int pya_static_attribute_descriptor_set(PyObject *self,
                                               PyObject * /*obj*/,
                                               PyObject *value) {
  PYAStaticAttributeDescriptorObject *attr =
      (PYAStaticAttributeDescriptorObject *)self;
 ...
 */
static int pya_static_attribute_descriptor_init(PyObject *self, PyObject *,
                                                PyObject *) {
  PYAStaticAttributeDescriptorObject *attr =
      (PYAStaticAttributeDescriptorObject *)self;
  attr->getter = 0;
...
void PYAStaticAttributeDescriptorObject::make_class(PyObject *module) {
  ...
  static_attribute_descriptor_type.tp_init =
      pya_static_attribute_descriptor_init;
  static_attribute_descriptor_type.tp_descr_get =
      pya_static_attribute_descriptor_get;
  static_attribute_descriptor_type.tp_descr_set =
      pya_static_attribute_descriptor_set;
  ...
  PyModule_AddObject(module, "_StaticAttribute",
                     (PyObject *)&static_attribute_descriptor_type);
...
PYAStaticAttributeDescriptorObject::create(const char *n) {
  ...
  PYAStaticAttributeDescriptorObject *desc =
      (PYAStaticAttributeDescriptorObject *)cls->tp_alloc(cls, 0);
  if (desc == NULL) {
    check_error();
  } else {
    desc->name = n;
...
static PyObject *pya_ambiguous_method_dispatcher_get(PyObject *self,
                                                     PyObject *obj,
                                                     PyObject *type) {
...
static int pya_ambiguous_method_dispatcher_set(PyObject * /*self*/,
                                               PyObject * /*obj*/,
                                               PyObject * /*value*/) {
...
static void pya_ambiguous_method_dispatcher_deallocate(PyObject *self) {
  PYAAmbiguousMethodDispatcher *attr = (PYAAmbiguousMethodDispatcher *)self;
...
void PYAAmbiguousMethodDispatcher::make_class(PyObject *module) {
  static PyTypeObject static_ambiguous_method_dispatcher_type = {
      PyVarObject_HEAD_INIT(&PyType_Type,
                            0) "pya._AmbiguousMethodDispatcher", // tp_name
      sizeof(PYAAmbiguousMethodDispatcher)                       // tp_size
  };

  static_ambiguous_method_dispatcher_type.tp_flags = Py_TPFLAGS_DEFAULT;
  static_ambiguous_method_dispatcher_type.tp_dealloc =
      pya_ambiguous_method_dispatcher_deallocate;
  static_ambiguous_method_dispatcher_type.tp_descr_get =
      pya_ambiguous_method_dispatcher_get;
  static_ambiguous_method_dispatcher_type.tp_descr_set =
      pya_ambiguous_method_dispatcher_set;
  ...
  PyModule_AddObject(module, "_AmbiguousMethodDispatcher",
                     (PyObject *)&static_ambiguous_method_dispatcher_type);
...
PYAAmbiguousMethodDispatcher::create(PyObject *ai, PyObject *ac) {
  tl_assert(cls != 0);
  PYAAmbiguousMethodDispatcher *desc =
      (PYAAmbiguousMethodDispatcher *)cls->tp_alloc(cls, 0);
  if (desc == NULL) {
    Py_XDECREF(ai);
    Py_XDECREF(ac);
    check_error();
 ...
 */
static PyObject *pya_plain_iterator_iter(PyObject *self) {
  //  we have to return a new reference -> when using self, we have to increment
  //  out count
  Py_INCREF(self);
  return self;
}
 ...
 */
static PyObject *pya_plain_iterator_next(PyObject *self) {
...
static void pya_plain_iterator_deallocate(PyObject *self) {
...
PYAIteratorObject *PYAIteratorObject::create(PyObject *origin,
  ...
  if (iter_obj == NULL) {
    ...
    if (origin) {
      //  The iterator will keep a reference to the origin object of the
      //  iterator
      Py_INCREF(origin);
    }
 ...
 */
static PyObject *pya_signal_add(PyObject *self, PyObject *args) {
  PyObject *callable = 0;
...
static PyObject *pya_signal_inplace_add(PyObject *self, PyObject *callable) {
  if (!PyCallable_Check(callable)) {
    std::string msg;
    msg += tl::to_string(tr("Signal's += operator needs a callable object"));
    PyErr_SetString(PyExc_AttributeError, msg.c_str());
 ...
 */
static PyObject *pya_signal_remove(PyObject *self, PyObject *args) {
  PyObject *callable = 0;
  if (!PyArg_ParseTuple(args, "O", &callable)) {
    return NULL;
  }
 ...
 *  @brief Removes a callable from the signal
 */
static PyObject *pya_signal_inplace_remove(PyObject *self, PyObject *callable) {
  if (!PyCallable_Check(callable)) {
    std::string msg;
    msg += tl::to_string(tr("Signal's -= operator needs a callable object"));
    PyErr_SetString(PyExc_AttributeError, msg.c_str());
 ...
 */
static PyObject *pya_signal_set(PyObject *self, PyObject *args) {
  PyObject *callable = 0;
  if (!PyArg_ParseTuple(args, "O", &callable)) {
    return NULL;
  }
 ...
 */
static PyObject *pya_signal_call(PyObject *self, PyObject *args,
                                 PyObject * /*kw*/) {
 ...
 */
static PyObject *pya_signal_clear(PyObject *self, PyObject * /*args*/) {
  PYASignal *signal = (PYASignal *)self;
  if (signal->handler) {
    signal->handler->clear();
  }
...
static void pya_signal_deallocate(PyObject *self) {
...
void PYASignal::make_class(PyObject *module) {
  ...
  static PyMethodDef signal_methods[] = {
      {"add", (PyCFunction)&pya_signal_add, METH_VARARGS,
       "internal signal proxy object: += operator"},
      {"remove", (PyCFunction)&pya_signal_remove, METH_VARARGS,
       "internal signal proxy object: -= operator"},
      {"set", (PyCFunction)&pya_signal_set, METH_VARARGS,
       "internal signal proxy object: assignment"},
      {"clear", (PyCFunction)&pya_signal_clear, METH_NOARGS,
...
PYASignal *PYASignal::create(PyObject *origin, pya::SignalHandler *handler) {
  tl_assert(cls != 0);
