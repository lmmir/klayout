...
SelectionService::SelectionService(lay::LayoutViewBase *view)
    :
      ...
      m_buttons(0), m_hover(false), m_hover_wait(false),
...
bool SelectionService::wheel_event(int /*delta*/, bool /*horizontal*/,
                                   const db::DPoint & /*p*/,
...
bool SelectionService::mouse_move_event(const db::DPoint &p,
                                        unsigned int buttons, bool prio) {
  if (prio) {
...
bool SelectionService::mouse_double_click_event(const db::DPoint & /*p*/,
...
bool SelectionService::mouse_press_event(const db::DPoint &p,
                                         unsigned int buttons, bool prio) {
  hover_reset();
...
bool SelectionService::mouse_click_event(const db::DPoint &p,
                                         unsigned int buttons, bool prio) {
  if (prio) {
    reset_box();
  }

  if (prio && mp_view && ui()->mouse_event_viewport().contains(p) &&
      (buttons & lay::LeftButton) != 0) {
...
bool SelectionService::mouse_release_event(const db::DPoint & /*p*/,
                                           unsigned int /*buttons*/,
                                           bool prio) {
  hover_reset();
