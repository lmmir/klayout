 ...
 */
class LAYBASIC_PUBLIC BookmarkListElement : public DisplayState {
public:
  BookmarkListElement() {
    //  .. nothing yet ..
  }

  BookmarkListElement(const DisplayState &state) : DisplayState(state) {
    //  .. nothing yet ..
  }
 ...
 */
class LAYBASIC_PUBLIC BookmarkList : public tl::Object {
public:
   ...
   */
  void add(const BookmarkListElement &e) { m_list.push_back(e); }
   ...
   */
  void reserve(size_t n) { m_list.reserve(n); }
   ...
   */
  const std::string &name(size_t index) const { return m_list[index].name(); }

  /**
   *  @brief Set the state of the element with the given index
   */
  void state(size_t index, const DisplayState &state) { m_list[index] = state; }

  /**
   *  @brief Obtain the name of the element with the given index
   */
  const DisplayState &state(size_t index) const { return m_list[index]; }
