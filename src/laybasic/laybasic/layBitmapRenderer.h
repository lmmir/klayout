 ...
 */
class LAYBASIC_PUBLIC BitmapRenderer : public Renderer {
public:
  /**
  ...
  /**
   *  @brief Insert a box with a transformation (because it may not be
   * orthogonal)
   */
   ...
   */
  void insert(const db::DBox &box, const std::string &text, db::Font font,
  ...
  virtual void draw(const db::Shape &shape, const db::CplxTrans &trans,
                    ...
                    lay::CanvasPlane *vertices, lay::CanvasPlane *texts);
...
private:
  ...
  static void render_box(double xmin, double ymin, double xmax, double ymax,
