...
public:
   ...
   *  @brief ctor
   */
  FixedFont(unsigned int h, unsigned int lh, unsigned int w, unsigned char c0,
            unsigned char nc, uint32_t *d, unsigned int stride);
   ...
   */
  static int default_font_size() { return ms_default_font_size; }
   ...
   */
  unsigned int line_height() const { return m_line_height; }
   ...
   */
  unsigned char first_char() const { return m_first_char; }

  /**
   *  @brief Number of characters
   */
  unsigned char n_chars() const { return m_n_chars; }

  /**
   *  @brief Character data
   */
  const uint32_t *data() const { return mp_data; }
