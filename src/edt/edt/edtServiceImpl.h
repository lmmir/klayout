 ...
 */
class ShapeEditService : public edt::Service {
public:
  ShapeEditService(db::Manager *manager, lay::LayoutViewBase *view,
...
protected:
  std::pair<bool, db::DPoint> interpolate(const db::DPoint &m,
                                          const db::DPoint &o,
 ...
 */
class PolygonService : public ShapeEditService {
public:
 ...
 */
class BoxService : public ShapeEditService {
public:
 ...
 */
class PointService : public ShapeEditService {
public:
 ...
 */
class TextService : public ShapeEditService {
public:
 ...
 */
class PathService : public ShapeEditService {
public:
 ...
 */
class InstService : public edt::Service {
public:
