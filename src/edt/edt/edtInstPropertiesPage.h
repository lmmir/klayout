...
class InstPropertiesPage : public lay::PropertiesPage,
                           public Ui::InstPropertiesPage {
  Q_OBJECT

public:
  InstPropertiesPage(edt::Service *service, db::Manager *manager,
                     QWidget *parent);
  ~InstPropertiesPage();
...
protected:
  ...
  create_applicator(db::Cell &cell, const db::Instance &inst, double dbu);
