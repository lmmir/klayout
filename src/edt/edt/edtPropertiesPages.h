...
class ShapePropertiesPage : public lay::PropertiesPage {
  Q_OBJECT

public:
  ShapePropertiesPage(const std::string &description, edt::Service *service,
  ...
  virtual QIcon icon(int w, int h) const {
    return lay::PropertiesPage::icon(w, h);
  }
  virtual void leave();
...
private:
  ...
  void
  recompute_selection_ptrs(const std::vector<lay::ObjectInstPath> &new_sel);
...
protected:
  ...
  create_applicator(db::Shapes &shapes, const db::Shape &shape, double dbu) = 0;
...
class PolygonPropertiesPage : public ShapePropertiesPage,
                              public Ui::PolygonPropertiesPage {
  Q_OBJECT

public:
  PolygonPropertiesPage(edt::Service *service, db::Manager *manager,
                        QWidget *parent);

  virtual std::string description(size_t entry) const;
  virtual std::string description() const {
    return ShapePropertiesPage::description();
  }
  virtual void do_update(const db::Shape &shape, double dbu,
                         const std::string &lname);
  virtual ChangeApplicator *
  create_applicator(db::Shapes &shapes, const db::Shape &shape, double dbu);
...
class BoxPropertiesPage : public ShapePropertiesPage,
                          public Ui::BoxPropertiesPage {
  Q_OBJECT

public:
  BoxPropertiesPage(edt::Service *service, db::Manager *manager,
                    QWidget *parent);
...
class PointPropertiesPage : public ShapePropertiesPage,
                            public Ui::PointPropertiesPage {
  Q_OBJECT

public:
  PointPropertiesPage(edt::Service *service, db::Manager *manager,
                      QWidget *parent);
...
class TextPropertiesPage : public ShapePropertiesPage,
                           public Ui::TextPropertiesPage {
  Q_OBJECT

public:
  TextPropertiesPage(edt::Service *service, db::Manager *manager,
                     QWidget *parent);
...
class PathPropertiesPage : public ShapePropertiesPage,
                           public Ui::PathPropertiesPage {
  Q_OBJECT

public:
  PathPropertiesPage(edt::Service *service, db::Manager *manager,
                     QWidget *parent);
...
class EditablePathPropertiesPage : public ShapePropertiesPage,
                                   public Ui::EditablePathPropertiesPage {
  Q_OBJECT

public:
  EditablePathPropertiesPage(edt::Service *service, db::Manager *manager,
                             QWidget *parent);
