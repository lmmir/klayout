...
TEST(1_Circle) {
  ...
  std::pair<bool, db::pcell_id_type> pc =
      lib_basic->layout().pcell_by_name("CIRCLE");
  tl_assert(pc.first);
  ...
  EXPECT_EQ(ly.get_pcell_parameters(circle->cell_index())[p_radius].to_double(),
            0.0);
  ...
  EXPECT_EQ(ly.get_pcell_parameters(circle->cell_index())[p_radius].to_double(),
            10.0);
  EXPECT_EQ(ly.get_pcell_parameters(circle->cell_index())[p_actual_radius]
                .to_double(),
            10.0);
  ...
  //  as the radius is an input parameter, only after Library::refresh the other
  ...
  //  as the handle is an input parameter, only after Library::refresh the other
  //  parameters get updated
  EXPECT_EQ(ly.get_pcell_parameters(circle->cell_index())[p_actual_radius]
                .to_double(),
            9.0);
  ...
  EXPECT_EQ(
      lib_basic->layout().pcell_declaration(pc.second)->can_create_from_shape(
          ly, s, l1),
      true);
  EXPECT_EQ(lib_basic->layout()
                .pcell_declaration(pc.second)
                ->transformation_from_shape(ly, s, l1)
                .to_string(),
            "r0 2500,3500");
  plist =
      lib_basic->layout().pcell_declaration(pc.second)->parameters_from_shape(
          ly, s, l1);
...
TEST(2_Pie) {
  ...
  std::pair<bool, db::pcell_id_type> pc =
      lib_basic->layout().pcell_by_name("PIE");
  tl_assert(pc.first);
  ...
  //  has radius 10um, but bbox isn't correct for now (because handle was not
  //  updated)
  ...
  EXPECT_EQ(ly.get_pcell_parameters(pie->cell_index())[p_radius].to_double(),
            0.0);
  ...
  EXPECT_EQ(ly.get_pcell_parameters(pie->cell_index())[p_radius].to_double(),
            10.0);
  EXPECT_EQ(
      ly.get_pcell_parameters(pie->cell_index())[p_actual_radius].to_double(),
      10.0);
  EXPECT_EQ(
      ly.get_pcell_parameters(pie->cell_index())[p_start_angle].to_double(),
      -90);
  EXPECT_EQ(ly.get_pcell_parameters(pie->cell_index())[p_actual_start_angle]
                .to_double(),
            -90);
  EXPECT_EQ(ly.get_pcell_parameters(pie->cell_index())[p_end_angle].to_double(),
            0);
  EXPECT_EQ(ly.get_pcell_parameters(pie->cell_index())[p_actual_end_angle]
                .to_double(),
            0);
  ...
  EXPECT_EQ(ly.get_pcell_parameters(pie->cell_index())[p_handle1].to_string(),
            "0,-9");
  EXPECT_EQ(ly.get_pcell_parameters(pie->cell_index())[p_handle2].to_string(),
            "9,0");
  EXPECT_EQ(
      ly.get_pcell_parameters(pie->cell_index())[p_actual_handle1].to_string(),
      "0,-9");
  EXPECT_EQ(
      ly.get_pcell_parameters(pie->cell_index())[p_actual_handle2].to_string(),
      "9,0");
  EXPECT_EQ(ly.get_pcell_parameters(pie->cell_index())[p_radius].to_double(),
            9.0);
  EXPECT_EQ(
  ...
  //  as the end angle is an input parameter, only after Library::refresh the
  //  other parameters get updated
  EXPECT_EQ(ly.get_pcell_parameters(pie->cell_index())[p_end_angle].to_double(),
            0.0);
  ...
  EXPECT_EQ(
      ...
      9.0);
  EXPECT_EQ(
      ly.get_pcell_parameters(pie->cell_index())[p_start_angle].to_double(), 0);
  EXPECT_EQ(ly.get_pcell_parameters(pie->cell_index())[p_actual_start_angle]
                .to_double(),
            0);
  EXPECT_EQ(ly.get_pcell_parameters(pie->cell_index())[p_end_angle].to_double(),
...
TEST(3_Arc) {
  ...
  std::pair<bool, db::pcell_id_type> pc =
      lib_basic->layout().pcell_by_name("ARC");
  tl_assert(pc.first);
  ...
  //  only after Library::refresh the parameters get updated and bbox is correct
  EXPECT_EQ(ly.get_pcell_parameters(arc->cell_index())[p_radius1].to_double(),
            0.0);
  ...
  EXPECT_EQ(ly.get_pcell_parameters(arc->cell_index())[p_radius1].to_double(),
            4.0);
  EXPECT_EQ(
      ly.get_pcell_parameters(arc->cell_index())[p_actual_radius1].to_double(),
      4.0);
  EXPECT_EQ(ly.get_pcell_parameters(arc->cell_index())[p_radius2].to_double(),
            10.0);
  EXPECT_EQ(
      ly.get_pcell_parameters(arc->cell_index())[p_actual_radius2].to_double(),
      10.0);
  EXPECT_EQ(
      ly.get_pcell_parameters(arc->cell_index())[p_start_angle].to_double(),
      -90);
  EXPECT_EQ(ly.get_pcell_parameters(arc->cell_index())[p_actual_start_angle]
                .to_double(),
            -90);
  EXPECT_EQ(ly.get_pcell_parameters(arc->cell_index())[p_end_angle].to_double(),
            0);
  EXPECT_EQ(ly.get_pcell_parameters(arc->cell_index())[p_actual_end_angle]
                .to_double(),
            0);
  ...
  EXPECT_EQ(ly.get_pcell_parameters(arc->cell_index())[p_handle1].to_string(),
            "0,-4");
  EXPECT_EQ(ly.get_pcell_parameters(arc->cell_index())[p_handle2].to_string(),
            "9,0");
  EXPECT_EQ(
      ly.get_pcell_parameters(arc->cell_index())[p_actual_handle1].to_string(),
      "0,-4");
  EXPECT_EQ(
      ly.get_pcell_parameters(arc->cell_index())[p_actual_handle2].to_string(),
      "9,0");
  EXPECT_EQ(ly.get_pcell_parameters(arc->cell_index())[p_radius1].to_double(),
            4.0);
  EXPECT_EQ(
  ...
  EXPECT_EQ(
      ...
      9.0);
  EXPECT_EQ(
      ly.get_pcell_parameters(arc->cell_index())[p_start_angle].to_double(), 0);
  EXPECT_EQ(ly.get_pcell_parameters(arc->cell_index())[p_actual_start_angle]
                .to_double(),
            0);
  EXPECT_EQ(ly.get_pcell_parameters(arc->cell_index())[p_end_angle].to_double(),
...
TEST(4_Donut) {
  ...
  std::pair<bool, db::pcell_id_type> pc =
      lib_basic->layout().pcell_by_name("DONUT");
  tl_assert(pc.first);
  ...
  //  only after Library::refresh the parameters get updated and bbox is correct
  EXPECT_EQ(ly.get_pcell_parameters(donut->cell_index())[p_radius1].to_double(),
            0.0);
  ...
  EXPECT_EQ(ly.get_pcell_parameters(donut->cell_index())[p_radius1].to_double(),
            4.0);
  EXPECT_EQ(ly.get_pcell_parameters(donut->cell_index())[p_actual_radius1]
                .to_double(),
            4.0);
  EXPECT_EQ(ly.get_pcell_parameters(donut->cell_index())[p_radius2].to_double(),
            10.0);
  EXPECT_EQ(ly.get_pcell_parameters(donut->cell_index())[p_actual_radius2]
                .to_double(),
            10.0);
  ...
  EXPECT_EQ(ly.get_pcell_parameters(donut->cell_index())[p_handle1].to_string(),
            "-4,0");
  EXPECT_EQ(ly.get_pcell_parameters(donut->cell_index())[p_handle2].to_string(),
            "-9,0");
  EXPECT_EQ(ly.get_pcell_parameters(donut->cell_index())[p_radius1].to_double(),
            4.0);
  EXPECT_EQ(ly.get_pcell_parameters(donut->cell_index())[p_actual_radius1]
...
TEST(5_Ellipse) {
  ...
  std::pair<bool, db::pcell_id_type> pc =
      lib_basic->layout().pcell_by_name("ELLIPSE");
  tl_assert(pc.first);
  ...
  EXPECT_EQ(ellipse->get_display_name(),
            "Basic.ELLIPSE(l=1/0,rx=4,ry=10,n=64)");

  //  only after Library::refresh the parameters get updated and bbox is correct
  EXPECT_EQ(
      ly.get_pcell_parameters(ellipse->cell_index())[p_radius_x].to_double(),
      0.0);
  ...
  EXPECT_EQ(
      ly.get_pcell_parameters(ellipse->cell_index())[p_radius_x].to_double(),
      4.0);
  EXPECT_EQ(ly.get_pcell_parameters(ellipse->cell_index())[p_actual_radius_x]
                .to_double(),
            4.0);
  EXPECT_EQ(
      ly.get_pcell_parameters(ellipse->cell_index())[p_radius_y].to_double(),
      10.0);
  EXPECT_EQ(ly.get_pcell_parameters(ellipse->cell_index())[p_actual_radius_y]
                .to_double(),
            10.0);
  ...
  EXPECT_EQ(
      ly.get_pcell_parameters(ellipse->cell_index())[p_handle_x].to_string(),
      "-4,0");
  EXPECT_EQ(
      ly.get_pcell_parameters(ellipse->cell_index())[p_handle_y].to_string(),
      "0,9");
  EXPECT_EQ(
      ly.get_pcell_parameters(ellipse->cell_index())[p_radius_x].to_double(),
      4.0);
...
TEST(10) {
  ...
  db::compare_layouts(_this, ly,
                      tl::testdata() + "/gds/basic_instances_au.gds");
}
