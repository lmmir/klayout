...
public:
   ...
   *
   *  If "tentative" is non-null, assignments will be recorded in the
   * TentativeMapping audit object and can be undone afterwards when
   * backtracking recursion happens.
   */
   ...
   *
   *  This method will analyze the given nodes and call "derive_node_identities"
   * for all nodes with a proposed identity.
   */
...
private:
  ...
  size_t derive_node_identities(size_t net_index, size_t depth, size_t n_branch,
  ...
  size_t derive_node_identities_for_edges(
      ...
      TentativeNodeMapping *tentative) const;
  size_t derive_node_identities_from_ambiguity_group(
      ...
      TentativeNodeMapping *tentative) const;
  size_t derive_node_identities_from_singular_match(
