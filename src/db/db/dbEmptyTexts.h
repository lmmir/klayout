 ...
 */
class DB_PUBLIC EmptyTexts : public TextsDelegate {
public:
  EmptyTexts();
  ...
  virtual TextsDelegate *filter_in_place(const TextFilterBase &) {
    return this;
  }
  ...
  processed_to_polygons(const TextToPolygonProcessorBase &) const;
  ...
  virtual void insert_into_as_polygons(Layout *, db::cell_index_type,
                                       unsigned int, db::Coord) const {}
