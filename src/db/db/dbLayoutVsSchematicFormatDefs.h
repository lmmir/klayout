 ...
 *
 *  [description]:
 *    description(<text>)              - an arbitrary description text [short
 * key: B]
 *
 *  [layout-netlist]:
 *    layout(...)                      - layout netlist part [short key: J]
 *                                       Content is the LayoutToNetlist dump
 * without version and description
 *
 *  [reference-netlist]:
 *    reference(...)
 *                                     - reference netlist part [short key: H]
 *                                       Content is the Netlist dump (reduced
 * version of LayoutToNetlist)
 *
 *  [xrefs]:
 ...
 *                                     - circuit cross-reference part [short
 * key: Z]
 *
 *  [xref-pin]:
...
template <>
struct DB_PUBLIC keys<true> : public l2n_std_format::keys<true>,
                              public ShortKeys {
...
template <>
struct DB_PUBLIC keys<false> : public l2n_std_format::keys<false>,
                               public LongKeys {
