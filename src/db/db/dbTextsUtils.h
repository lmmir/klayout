...
struct DB_PUBLIC TextStringFilter : public TextFilterBase {
  /**
   *  @brief Constructor
   *
 ...
 *
 *  It will filter all texts for which the string matches the given glob-style
 * pattern. There is an "invert" flag which allows selecting all texts not
 *  matching the criterion.
 */

struct DB_PUBLIC TextPatternFilter : public TextFilterBase {
  /**
   *  @brief Constructor
   *
...
/**
 *  @brief A helper class for the text ref to region interaction functionality
 * which acts as an text receiver
 *
 *  Note: This special scanner uses pointers to two different objects: texts and
 ...
 */
template <class OutputContainer, class TextType,
