...
typedef shape_collection_processor<db::EdgePair, db::Polygon>
    EdgePairToPolygonProcessorBase;
typedef shape_collection_processor<db::EdgePair, db::Edge>
    EdgePairToEdgeProcessorBase;

class DB_PUBLIC EdgePairToPolygonProcessor
    : public EdgePairToPolygonProcessorBase {
public:
  EdgePairToPolygonProcessor(db::Coord e) : m_e(e) {}
...
class DB_PUBLIC EdgePairToEdgesProcessor : public EdgePairToEdgeProcessorBase {
public:
...
class DB_PUBLIC EdgePairToFirstEdgesProcessor
...
class DB_PUBLIC EdgePairToSecondEdgesProcessor
    : public EdgePairToEdgeProcessorBase {
public:
...
class DB_PUBLIC EdgePairToLesserEdgesProcessor
    : public EdgePairToEdgeProcessorBase {
public:
...
class DB_PUBLIC EdgePairToGreaterEdgesProcessor
    : public EdgePairToEdgeProcessorBase {
public:
 ...
 */
typedef db::generic_shape_iterator_delegate_base<db::EdgePair>
    EdgePairsIteratorDelegate;

/**
 *  @brief The delegate for the actual edge set implementation
 */
class DB_PUBLIC EdgePairsDelegate : public ShapeCollectionDelegateBase {
public:
  ...
  //  dummy features to harmonize the interface of region, edges and edge pair
  //  delegates
  ...
  virtual EdgePairsDelegate *
  filter_in_place(const EdgePairFilterBase &filter) = 0;
  virtual EdgePairsDelegate *
  filtered(const EdgePairFilterBase &filter) const = 0;
  virtual RegionDelegate *
  processed_to_polygons(const EdgePairToPolygonProcessorBase &filter) const = 0;
  virtual EdgesDelegate *
  processed_to_edges(const EdgePairToEdgeProcessorBase &filter) const = 0;
