...
template <class C> struct edge_defs {
  ...
  static C *new_xyxy(coord_type x1, coord_type y1, coord_type x2,
                     coord_type y2) {
    return new C(point_type(x1, y1), point_type(x2, y2));
  }

  static box_type bbox(const C *e) { return box_type(e->p1(), e->p2()); }
  ...
  static void set_p1(C *e, const point_type &p) { *e = C(p, e->p2()); }

  static void set_p2(C *e, const point_type &p) { *e = C(e->p1(), p); }
  ...
  static size_t hash_value(const C *e) { return std::hfunc(*e); }

  static gsi::Methods methods() {
    return constructor("new", &new_v,
                       "@brief Default constructor: creates a degenerated edge "
                       "0,0 to 0,0") +
           constructor("new|#new_xyxy", &new_xyxy, gsi::arg("x1"),
                       gsi::arg("y1"), gsi::arg("x2"), gsi::arg("y2"),
                       "@brief Constructor with two coordinates given as "
                       "single values\n"
                       "\n"
           ...
           method("<", &C::less, gsi::arg("e"),
                  ...
                  "@return True, if the edge is 'less' as the other edge with "
                  "respect to first and second point") +
           ...
           method_ext("hash", &hash_value,
                      ...
                      "Returns a hash value for the given edge. This method "
                      "enables edges as hash keys.\n"
                      "\n"
           ...
           method("extended", &C::extended, gsi::arg("d"),
                  ...
                  "that the first point is shifted by -d along the edge, the "
                  "second by d.\n"
           ...
           method("extend", &C::extend, gsi::arg("d"),
                  ...
                  "The length of the edge will increase by 2*d.\n"
                  "\n"
                  "\\extended is a version that does not modify self but "
                  "returns the extended edges.\n"
                  "\n"
                  "This method has been introduced in version 0.23.\n"
                  "\n"
                  "@param d The distance by which to shift the end points.\n"
           ...
           method("shifted", &C::shifted, gsi::arg("d"),
                  ...
                  "shifted edge. The edge is not modified. Shifting by a "
                  "positive value "
                  "will produce an edge which is shifted by d to the left. "
           ...
           method("shift", &C::shift, gsi::arg("d"),
                  ...
                  "will produce an edge which is shifted by d to the right.\n"
                  "\n"
                  "\\shifted is a version that does not modify self but "
                  "returns the extended edges.\n"
                  "\n"
                  "This method has been introduced in version 0.23.\n"
                  "\n"
           ...
           method("transformed|#transformed_cplx",
                  &C::template transformed<complex_trans_type>, gsi::arg("t"),
                  "@brief Transform the edge.\n"
                  "\n"
           ...
           method("enlarge", &C::enlarge, gsi::arg("p"),
                  ...
                  "\n"
                  "@return The enlarged edge.\n") +
           method("p1", &C::p1, "@brief The first point.\n") +
           method_ext("p1=", &set_p1, gsi::arg("point"),
                      "@brief Sets the first point.\n"
                      "This method has been added in version 0.23.") +
           method("p2", &C::p2, "@brief The second point.\n") +
           method_ext("p2=", &set_p2, gsi::arg("point"),
                      "@brief Sets the second point.\n"
                      "This method has been added in version 0.23.") +
           method("dx", &C::dx, "@brief The horizontal extend of the edge.\n") +
           method("dy", &C::dy, "@brief The vertical extend of the edge.\n") +
           method("x1", &C::x1, "@brief Shortcut for p1.x\n") +
           method_ext("x1=", &set_x1, gsi::arg("coord"),
                      "@brief Sets p1.x\n"
                      "This method has been added in version 0.23.") +
           method("y1", &C::y1, "@brief Shortcut for p1.y\n") +
           method_ext("y1=", &set_y1, gsi::arg("coord"),
                      "@brief Sets p1.y\n"
                      "This method has been added in version 0.23.") +
           method("x2", &C::x2, "@brief Shortcut for p2.x\n") +
           method_ext("x2=", &set_x2, gsi::arg("coord"),
                      "@brief Sets p2.x\n"
                      "This method has been added in version 0.23.") +
           method("y2", &C::y2, "@brief Shortcut for p2.y\n") +
           method_ext("y2=", &set_y2, gsi::arg("coord"),
                      "@brief Sets p2.y\n"
                      "This method has been added in version 0.23.") +
           method("dx_abs", &C::dx_abs,
                  "@brief The absolute value of the horizontal extend of the "
                  "edge.\n") +
           method("dy_abs", &C::dy_abs,
                  "@brief The absolute value of the vertical extend of the "
                  "edge.\n") +
           ...
           method("is_degenerate?", &C::is_degenerate,
                  ...
                  "\n"
                  "An edge is degenerate, if both end and start point are "
                  "identical.") +
           method("length", &C::length, "@brief The length of the edge\n") +
           ...
           method("contains_excl?", &C::contains_excl, gsi::arg("p"),
                  "@brief Tests whether a point is on an edge excluding the "
                  "endpoints.\n"
                  "\n"
                  "A point is on a edge if it is on (or at least closer \n"
                  "than a grid point to) the edge.\n"
                  ...
                  "@param p The point to test with the edge.\n"
                  "\n"
                  "@return True if the point is on the edge but not equal p1 "
                  "or p2.\n") +
           ...
           method("intersects?|#intersect?", &C::intersect, gsi::arg("e"),
                  ...
                  "\n"
                  "Returns true if the edges intersect. Two edges intersect if "
                  "they share at least one point. \n"
                  "If the edges coincide, they also intersect.\n"
                  "If one of the edges is degenerate (both points are "
                  "identical), that point is "
                  "required to sit exaclty on the other edge. If both edges "
                  "are degenerate, their "
                  "points are required to be identical.\n"
                  "\n"
                  "@param e The edge to test.\n"
                  "\n"
                  "The 'intersects' (with an 's') synonym has been introduced "
                  "in version 0.28.12.\n") +
           method_ext("intersection_point", &intersect_point, gsi::arg("e"),
                      "@brief Returns the intersection point of two edges. \n"
                      "\n"
                      "This method delivers the intersection point. If the "
                      "edges do not intersect, the result will be nil.\n"
                      "\n"
                      "@param e The edge to test.\n"
                      "@return The point where the edges intersect.\n"
                      "\n"
                      "This method has been introduced in version 0.19.\n"
                      "From version 0.26.2, this method will return nil in "
                      "case of non-intersection.\n") +
           method_ext("cut_point", &cut_point, gsi::arg("e"),
                      "@brief Returns the intersection point of the lines "
                      "through the two edges.\n"
                      "\n"
                      "This method delivers the intersection point between the "
                      "lines through the two edges. If the lines are parallel "
                      "and do not intersect, the result will be nil.\n"
                      "In contrast to \\intersection_point, this method will "
                      "regard the edges as infinitely extended and "
                      "intersection is not confined to the edge span.\n"
                      "\n"
                      "@param e The edge to test.\n"
           ...
           method_ext("clipped", &clipped, gsi::arg("box"),
                      ...
                      "@return The clipped edge or nil if the edge does not "
                      "intersect with the box.\n"
                      "\n"
                      "This method has been introduced in version 0.26.2.\n") +
           method_ext("clipped_line", &clipped_line, gsi::arg("box"),
                      "@brief Returns the line through the edge clipped at the "
                      "given box\n"
                      "\n"
                      "@param box The clip box.\n"
                      "@return The part of the line through the box or nil if "
                      "the line does not intersect with the box.\n"
                      "\n"
                      "In contrast to \\clipped, this method will consider the "
                      "edge extended infinitely (a \"line\"). "
                      "The returned edge will be the part of this line going "
                      "through the box.\n"
                      "\n"
                      "This method has been introduced in version 0.26.2.\n") +
           method("d", &C::d,
           ...
           method(
               ...
               "\"right\" of the edge and positive if the point is to the "
               "\"left\".\n"
               "The distance is measured by projecting the point onto the\n"
               "line through the edge. If the edge is degenerated, the "
               "distance\n"
               "is not defined.\n"
               "\n"
           ...
           method("side_of", &C::side_of, gsi::arg("p"),
                  "@brief Indicates at which side the point is located "
           ...
           method("swap_points", &C::swap_points,
                  ...
                  "\n"
                  "This version modifies self. A version that does not modify "
                  "self is \\swapped_points. "
                  "Swapping the points basically reverses the direction of the "
                  "edge.\n"
                  "\n"
                  "This method has been introduced in version 0.23.\n") +
           method("swapped_points", &C::swapped_points,
                  ...
                  "This method has been introduced in version 0.23.\n") +
           method(
               "crossed_by?", &C::crossed_by, gsi::arg("e"),
               "@brief Checks, if the line given by self is crossed by the "
               "edge e\n"
               "\n"
               "self if considered an infinite line. This predicate renders "
               "true "
               ...
               "\n"
               "@param e The edge representing the line that the edge must be "
               "crossing.\n") +
           method_ext(
               "crossing_point", &crossing_point, gsi::arg("e"),
               "@brief Returns the crossing point on two edges. \n"
               "\n"
               "This method delivers the point where the given line (self) "
               "crosses the edge given "
               "by the argument \"e\". self is considered infinitely long and "
               "is required to cut "
               "through the edge \"e\". If self does not cut this line, the "
               "result is undefined. "
               "See \\crossed_by? for a description of the crossing "
               "predicate.\n"
               "\n"
               "@param e The edge representing the line that self must be "
               "crossing.\n"
...
static db::Edge *edge_from_dedge(const db::DEdge &e) { return new db::Edge(e); }

static db::DEdge edge_to_dedge(const db::Edge *e, double dbu) {
  return db::DEdge(*e * dbu);
}

Class<db::Edge> decl_Edge(
    "db", "Edge",
    constructor("new|#from_dedge", &edge_from_dedge, gsi::arg("dedge"),
                "@brief Creates an integer coordinate edge from a "
                "floating-point coordinate edge\n"
                "\n"
                "This constructor has been introduced in version 0.25 and "
                "replaces the previous static method 'from_dedge'.") +
        method_ext(
            "to_dtype", &edge_to_dedge, gsi::arg("dbu", 1.0),
            "@brief Converts the edge to a floating-point coordinate edge\n"
            "\n"
            "The database unit can be specified to translate the "
            "integer-coordinate edge into a floating-point coordinate "
            "edge in micron units. The database unit is basically a scaling "
            "factor.\n"
            "\n"
            "This method has been introduced in version 0.25.") +
        method("transformed", &db::Edge::transformed<db::ICplxTrans>,
               ...
               "@param t The transformation to apply.\n"
               "\n"
               "@return The transformed edge (in this case an integer "
               "coordinate edge).\n"
               "\n"
    ...
    "@brief An edge class\n"
    "\n"
    "An edge is a connection between points, usually participating in a larger "
    "context "
    "such as a polygon. An edge has a defined direction (from p1 to p2). "
    "Edges play a role in the database as parts of polygons and to describe a "
    "line through both points.\n"
    "Although supported, edges are rarely used as individual database "
    "objects.\n"
    "\n"
...
Class<db::DEdge> decl_DEdge(
    "db", "DEdge",
    constructor("new|#from_iedge", &dedge_from_iedge, gsi::arg("edge"),
                "@brief Creates a floating-point coordinate edge from an "
                "integer coordinate edge\n"
                "\n"
                "This constructor has been introduced in version 0.25 and "
                "replaces the previous static method 'from_iedge'.") +
        method_ext("to_itype", &dedge_to_edge, gsi::arg("dbu", 1.0),
                   ...
                   "edge in micron units to an integer-coordinate edge in "
                   "database units. The edges "
                   "coordinates will be divided by the database unit.\n"
                   "\n"
                   "This method has been introduced in version 0.25.") +
        method(
            "transformed", &db::DEdge::transformed<db::VCplxTrans>,
            gsi::arg("t"),
            "@brief Transforms the edge with the given complex transformation\n"
            "\n"
            "@param t The magnifying transformation to apply\n"
            "@return The transformed edge (in this case an integer coordinate "
            "edge)\n"
            "\n"
            "This method has been introduced in version 0.25.\n") +
    ...
    "Edges play a role in the database as parts of polygons and to describe a "
    "line through both points.\n"
    "The \\Edge object is also used inside the boolean processor "
    "(\\EdgeProcessor).\n"
    "Although supported, edges are rarely used as individual database "
    "objects.\n"
    "\n"
