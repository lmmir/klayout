...
typedef shape_collection_processor<db::Text, db::Polygon>
    TextToPolygonProcessorBase;

typedef db::generic_shape_iterator_delegate_base<db::Text>
    TextsIteratorDelegate;

/**
 *  @brief The delegate for the actual edge set implementation
 */
class DB_PUBLIC TextsDelegate : public ShapeCollectionDelegateBase {
public:
  ...
  processed_to_polygons(const TextToPolygonProcessorBase &filter) const = 0;
