...
template <class C> struct point_defs {
  ...
  static C *new_vec(const db::vector<coord_type> &v) { return new C(C() + v); }

  static C *new_xy(coord_type x, coord_type y) { return new C(x, y); }

  static db::vector<coord_type> to_vector(const C *p) { return *p - C(); }
  ...
  static gsi::Methods methods() {
    return constructor("new", &new_v,
           ...
           method_ext("to_v", &to_vector,
                      ...
                      "This method returns a vector representing the distance "
           ...
           method("+", (C(C::*)(const db::vector<coord_type> &) const) & C::add,
                  ...
                  "\n"
                  "Starting with version 0.25, this method expects a vector "
                  "argument.") +
           method("-",
                  (db::vector<coord_type>(C::*)(const C &) const) & C::subtract,
                  gsi::arg("p"),
                  "@brief Subtract one point from another\n"
                  "\n"
                  "\n"
                  "Subtract point p from self by subtracting the coordinates. "
                  "This renders a vector.\n"
                  "\n"
                  "Starting with version 0.25, this method renders a vector.") +
           method("-",
                  (C(C::*)(const db::vector<coord_type> &) const) & C::subtract,
                  gsi::arg("v"),
                  "@brief Subtract one vector from a point\n"
                  "\n"
                  "\n"
                  "Subtract vector v from from self by subtracting the "
                  "coordinates. This renders a point.\n"
                  "\n"
           ...
           method_ext("hash", &hash_value,
                      ...
                      "Returns a hash value for the given point. This method "
           ...
           method_ext("/=", &idiv, gsi::arg("d"),
                      ...
                      "necessary rounded.") +
           method("distance",
                  (double (C::*)(const C &) const) & C::double_distance,
                  gsi::arg("d"),
           ...
           method("sq_distance",
                  (double (C::*)(const C &) const) & C::sq_double_distance,
                  gsi::arg("d"),
           ...
           method("abs", (double (C::*)() const) & C::double_distance,
                  "@brief The absolute value of the point (Euclidian distance "
                  "to 0,0)\n"
                  "\n"
           ...
           method("sq_abs", (double (C::*)() const) & C::sq_double_distance,
                  "@brief The square of the absolute value of the point "
...
Class<db::DPoint> decl_DPoint(
    ...
    constructor("new|#from_ipoint", &dpoint_from_ipoint, gsi::arg("point"),
        ...
        method_ext("to_itype", &dpoint_to_point, gsi::arg("dbu", 1.0),
                   ...
                   "point in micron units to an integer-coordinate point in "
                   "database units. The point's' "
    ...
    "Points represent a coordinate in the two-dimensional coordinate space of "
    "layout. "
    "They are not geometrical objects by itself. But they are frequently used "
    "in the database API "
    "for various purposes. Other than the integer variant (\\Point), points "
...
Class<db::Point> decl_Point(
    "db", "Point",
    constructor("new|#from_dpoint", &point_from_dpoint, gsi::arg("dpoint"),
                "@brief Creates an integer coordinate point from a "
                "floating-point coordinate point\n"
                "\n"
                "This constructor has been introduced in version 0.25 and "
                "replaces the previous static method 'from_dpoint'.") +
        method_ext(
            "to_dtype", &point_to_dpoint, gsi::arg("dbu", 1.0),
            "@brief Converts the point to a floating-point coordinate point\n"
            "\n"
            "The database unit can be specified to translate the "
            "integer-coordinate point into a floating-point coordinate "
            "point in micron units. The database unit is basically a scaling "
            "factor.\n"
            "\n"
            "This method has been introduced in version 0.25.") +
