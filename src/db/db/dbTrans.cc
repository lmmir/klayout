...
void _extractor_impl(tl::Extractor &ex, db::combined_trans<C1, C2> &t) {
  if (!_test_extractor_impl(ex, t)) {
    ex.error(tl::to_string(
        tr("Expected transformation/magnification specification")));
  }
}
...
template <> void DB_PUBLIC extractor_impl(tl::Extractor &ex, db::FTrans &t) {
  if (!test_extractor_impl(ex, t)) {
    ex.error(tl::to_string(tr(
        "Expected rotation/mirror code (r0,r90,r180,r270,m0,m45,m90,m135)")));
  }
}

template <> void DB_PUBLIC extractor_impl(tl::Extractor &ex, db::Trans &t) {
  _extractor_impl(ex, t);
}

template <> void DB_PUBLIC extractor_impl(tl::Extractor &ex, db::DTrans &t) {
  _extractor_impl(ex, t);
}

template <> void DB_PUBLIC extractor_impl(tl::Extractor &ex, db::Disp &t) {
  _extractor_impl(ex, t);
}

template <> void DB_PUBLIC extractor_impl(tl::Extractor &ex, db::DDisp &t) {
  _extractor_impl(ex, t);
}

template <> void DB_PUBLIC extractor_impl(tl::Extractor &ex, db::CplxTrans &t) {
  _extractor_impl(ex, t);
}

template <>
DB_PUBLIC void extractor_impl(tl::Extractor &ex, db::ICplxTrans &t) {
  _extractor_impl(ex, t);
}

template <>
DB_PUBLIC void extractor_impl(tl::Extractor &ex, db::DCplxTrans &t) {
  _extractor_impl(ex, t);
}

template <>
DB_PUBLIC void extractor_impl(tl::Extractor &ex, db::VCplxTrans &t) {
  _extractor_impl(ex, t);
}
...
template <>
DB_PUBLIC bool test_extractor_impl(tl::Extractor &ex, db::Trans &t) {
...
template <>
DB_PUBLIC bool test_extractor_impl(tl::Extractor &ex, db::DDisp &t) {
  return _test_extractor_impl(ex, t);
}
