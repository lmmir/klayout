...
template <class C> struct box_defs {
  ...
  static C world() { return C::world(); }

  static C *new_v() { return new C(); }

  static C *new_sq(coord_type s) { return new C(-s / 2, -s / 2, s / 2, s / 2); }
  ...
  static size_t hash_value(const C *box) { return std::hfunc(*box); }

  static const C &bbox(const C *box) { return *box; }

  static gsi::Methods methods() {
    return constructor("new", &new_v,
                       "@brief Creates an empty (invalid) box\n"
                       "\n"
                       "Empty boxes don't modify a box when joined with it. "
                       "The intersection between an empty and any other "
                       "box is also an empty box. The width, height, p1 and p2 "
                       "attributes of an empty box are undefined. "
                       "Use \\empty? to get a value indicating whether the box "
                       "is empty.\n") +
           constructor("new", &new_sq, gsi::arg("w"),
                       "@brief Creates a square with the given dimensions "
                       "centered around the origin\n"
                       "\n"
                       "Note that for integer-unit boxes, the dimension has to "
                       "be an even number to avoid rounding.\n"
                       "\n"
                       "This convenience constructor has been introduced in "
                       "version 0.28.") +
           constructor("new", &new_wh, gsi::arg("w"), gsi::arg("h"),
                       "@brief Creates a rectangle with given width and "
                       "height, centered around the origin\n"
                       "\n"
                       "Note that for integer-unit boxes, the dimensions have "
                       "to be an even number to avoid rounding.\n"
                       "\n"
                       "This convenience constructor has been introduced in "
                       "version 0.28.") +
           constructor("new", &new_lbrt, gsi::arg("left"), gsi::arg("bottom"),
                       gsi::arg("right"), gsi::arg("top"),
                       "@brief Creates a box with four coordinates\n"
                       "\n"
                       "\n"
                       "Four coordinates are given to create a new box. If the "
                       "coordinates "
                       "are not provided in the correct order (i.e. right < "
                       "left), these are "
                       "swapped.") +
           constructor(
               "new", &new_pp, gsi::arg("lower_left"), gsi::arg("upper_right"),
               "@brief Creates a box from two points\n"
               "\n"
               "\n"
               "Two points are given to create a new box. If the coordinates "
               "are not provided in the correct order (i.e. right < left), "
               "these are "
               "swapped.") +
           method("world", &world,
                  "@brief Gets the 'world' box\n"
                  "The world box is the biggest box that can be represented. "
                  "So it is basically 'all'. The "
                  "world box behaves neutral on intersections for example. In "
                  "other operations such as displacement or transformations, "
                  "the world box may render unexpected results because of "
                  "coordinate overflow.\n"
                  "\n"
                  ...
                  "  @li in relations (\\contains?, \\overlaps?, \\touches?) "
                  "@/li\n"
           ...
           method("center", &C::center, "@brief Gets the center of the box\n") +
           method("left", &C::left,
           ...
           method("width", &C::width, "@brief Gets the width of the box\n") +
           method("height", &C::height, "@brief Gets the height of the box\n") +
           ...
           method_ext("bbox", &bbox,
                      ...
                      "This method is provided for consistency of the shape "
                      "API is returns the box itself.\n"
                      "\n"
                      "This method has been introduced in version 0.27.") +
           method_ext(
               "contains?", &box_defs<C>::contains, gsi::arg("x"),
               gsi::arg("y"),
               "@brief Returns true if the box contains the given point\n"
               "\n"
               "\n"
               "Tests whether a point (x, y) is inside the box.\n"
               "It also returns true if the point is exactly on the box "
               "contour.\n"
               "\n"
           ...
           method("empty?", &C::empty,
                  ...
                  "\n"
                  "An empty box may be created with the default constructor "
                  "for example. "
                  "Such a box is neutral when combining it with other boxes "
                  "and renders empty boxes "
                  "if used in box intersections and false in geometrical "
                  "relationship tests. ") +
           method("inside?", &C::inside, gsi::arg("box"),
                  "@brief Tests if this box is inside the argument box\n"
                  "\n"
                  "\n"
                  "Returns true, if this box is inside the given box, i.e. the "
                  "box intersection renders this box") +
           method("touches?", &C::touches, gsi::arg("box"),
                  "@brief Tests if this box touches the argument box\n"
                  "\n"
                  "\n"
                  "Two boxes touch if they overlap or their boundaries share "
                  "at least one common point. "
                  "Touching is equivalent to a non-empty intersection ('!(b1 & "
                  "b2).empty?').") +
           method("overlaps?", &C::overlaps, gsi::arg("box"),
                  "@brief Tests if this box overlaps the argument box\n"
                  "\n"
                  "\n"
                  "Returns true, if the intersection box of this box with the "
                  "argument box exists and has a non-vanishing area") +
           ...
           method("perimeter", &C::perimeter,
                  ...
                  "\n"
                  "This method is equivalent to 2*(width+height). For empty "
                  "boxes, this method returns 0.\n"
                  "\n"
           ...
           method_ext("+", &box_defs<C>::join_with_point, gsi::arg("point"),
                      ...
                      "\n"
                      "\n"
                      "The + operator joins a point with the box. The "
                      "resulting box will enclose both the original "
                      "box and the point.\n"
                      "\n"
           ...
           method(
               "*", &C::convolved, gsi::arg("box"),
               "@brief Returns the convolution product from this box with "
               "another box\n"
               "\n"
               "\n"
               "The * operator convolves the firstbox with the one given as \n"
               "the second argument. The box resulting from \"convolution\" is "
               "the\n"
           ...
           method("*", &C::scaled, gsi::arg("scale_factor"),
                  ...
                  "\n"
                  "\n"
                  "The * operator scales the box with the given factor and "
                  "returns the result.\n"
                  "\n"
           ...
           method_ext("move", &box_defs<C>::move, gsi::arg("dx"),
                      gsi::arg("dy"),
                      "@brief Moves the box by a certain distance\n"
                      "\n"
                      "\n"
                      "This is a convenience method which takes two values "
                      "instead of a Point object.\n"
                      "This method has been introduced in version 0.23.\n"
                      "\n"
                      "@return A reference to this box.\n") +
           method_ext("moved", &box_defs<C>::moved, gsi::arg("dx"),
                      gsi::arg("dy"),
                      "@brief Moves the box by a certain distance\n"
                      "\n"
                      "\n"
           ...
           method("move", &C::move, gsi::arg("distance"),
                  ...
                  "@return A reference to this box.\n") +
           method(
               "moved", &C::moved, gsi::arg("distance"),
               ...
               "\n"
               "@return The moved box.\n") +
           method_ext("enlarge", &box_defs<C>::enlarge, gsi::arg("dx"),
                      gsi::arg("dy"),
                      ...
                      "@return A reference to this box.\n") +
           method_ext(
               "enlarge", &box_defs<C>::enlarge1, gsi::arg("d"),
               "@brief Enlarges the box by a certain amount on all sides.\n"
               "\n"
               "This is a convenience method which takes one values instead of "
               "two values. It will apply the given enlargement in both "
               "directions.\n"
               "This method has been introduced in version 0.28.\n"
               "\n"
               "@return A reference to this box.\n") +
           method_ext("enlarged", &box_defs<C>::enlarged, gsi::arg("dx"),
                      gsi::arg("dy"),
                      "@brief Enlarges the box by a certain amount.\n"
                      "\n"
                      "\n"
           ...
           method_ext(
               "enlarged", &box_defs<C>::enlarged1, gsi::arg("d"),
               "@brief Enlarges the box by a certain amount on all sides.\n"
               "\n"
               "This is a convenience method which takes one values instead of "
               "two values. It will apply the given enlargement in both "
           ...
           method("enlarge", &C::enlarge, gsi::arg("enlargement"),
                  ...
                  "overflows.\n"
                  "\n"
                  "@param enlargement The grow or shrink amount in x and y "
                  "direction\n"
                  "\n"
                  "@return A reference to this box.\n") +
           ...
           method("transformed", &C::template transformed<simple_trans_type>,
                  gsi::arg("t"),
                  "@brief Returns the box transformed with the given simple "
                  "transformation\n"
                  "\n"
                  "\n"
           ...
           method("transformed", &C::template transformed<complex_trans_type>,
                  gsi::arg("t"),
                  "@brief Returns the box transformed with the given complex "
                  "transformation\n"
                  "\n"
                  "\n"
           ...
           method("<", &C::less, gsi::arg("box"),
                  ...
                  "Returns true, if this box is 'less' with respect to first "
                  "and second point (in this order)") +
           ...
           method_ext("hash", &hash_value,
                      ...
                      "Returns a hash value for the given box. This method "
                      "enables boxes as hash keys.\n"
                      "\n"
           ...
           method("to_s", &C::to_string, gsi::arg("dbu", 0.0),
                  ...
                  "\n"
                  "This string can be turned into a box again by using "
                  "\\from_s\n. "
...
static db::Box *box_from_dbox(const db::DBox &b) { return new db::Box(b); }

static db::DBox box_to_dbox(const db::Box *b, double dbu) {
  return db::DBox(*b) * dbu;
}

Class<db::Box> decl_Box(
    "db", "Box",
    constructor("new|#from_dbox", &box_from_dbox, gsi::arg("dbox"),
                "@brief Creates an integer coordinate box from a "
                "floating-point coordinate box\n"
                "\n"
                "This constructor has been introduced in version 0.25 and "
                "replaces the previous static method 'from_dbox'.") +
        method_ext(
            "to_dtype", &box_to_dbox, gsi::arg("dbu", 1.0),
            "@brief Converts the box to a floating-point coordinate box\n"
            "\n"
            "The database unit can be specified to translate the "
            "integer-coordinate box into a floating-point coordinate "
            "box in micron units. The database unit is basically a scaling "
            "factor.\n"
            "\n"
            "This method has been introduced in version 0.25.") +
        method(
            "transformed", &db::Box::transformed<db::ICplxTrans>, gsi::arg("t"),
            "@brief Transforms the box with the given complex transformation\n"
            "\n"
            "\n"
            "@param t The magnifying transformation to apply\n"
            "@return The transformed box (in this case an integer coordinate "
            "box)\n"
            "\n"
    ...
    "upper right one. If a box is constructed from two points (or four "
    "coordinates), the \n"
    "coordinates are sorted accordingly.\n"
    "\n"
    "A box can be empty. An empty box represents no area\n"
    "(not even a point). Empty boxes behave neutral with respect to most "
    "operations. \n"
...
static db::DBox *dbox_from_ibox(const db::Box &b) { return new db::DBox(b); }

static db::Box dbox_to_box(const db::DBox *b, double dbu) {
  return db::Box(*b * (1.0 / dbu));
}

Class<db::DBox> decl_DBox(
    "db", "DBox",
    constructor("new|#from_ibox", &dbox_from_ibox, gsi::arg("box"),
                "@brief Creates a floating-point coordinate box from an "
                "integer coordinate box\n"
                "\n"
                "This constructor has been introduced in version 0.25 and "
                "replaces the previous static method 'from_ibox'.") +
        method_ext("to_itype", &dbox_to_box, gsi::arg("dbu", 1.0),
                   ...
                   "box in micron units to an integer-coordinate box in "
                   "database units. The boxes "
                   "coordinates will be divided by the database unit.\n"
                   "\n"
                   "This method has been introduced in version 0.25.") +
        method(
            "transformed", &db::DBox::transformed<db::VCplxTrans>,
            gsi::arg("t"),
            "@brief Transforms the box with the given complex transformation\n"
            "\n"
            "\n"
