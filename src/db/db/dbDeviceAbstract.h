 ...
 *
 *  A device abstract represents the geometrical properties of a device. It
 * basically links to a cell and clusters for indicating the terminal geometry
 * of the device.
 */
class DB_PUBLIC DeviceAbstract : public tl::Object {
public:
  /**
   ...
   */
  DeviceAbstract(db::DeviceClass *device_class,
   ...
   *  In the layout, a device is represented by a cell. This attribute gives the
   * index of this cell.
   */
  ...
  void mem_stat(MemStatistics *stat, MemStatistics::purpose_t purpose, int cat,
    ...
    db::mem_stat(stat, purpose, cat, m_terminal_cluster_ids, true,
                 (void *)this);
  }
...
inline void mem_stat(MemStatistics *stat, MemStatistics::purpose_t purpose,
                     int cat, const DeviceAbstract &x, bool no_self,
                     void *parent) {
