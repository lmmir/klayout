...
std::string collect(db::RecursiveShapeIterator &s, const db::Layout &layout,
                    bool with_layer = false) {
  std::string res;
  while (!s.at_end()) {
    if (!res.empty()) {
      res += "/";
...
std::string collect_with_copy(db::RecursiveShapeIterator s,
...
TEST(1) {
  ...
  c0.insert(db::CellInstArray(db::CellInst(c2.cell_index()),
                              db::Trans(db::Vector(100, -100))));
  c0.insert(db::CellInstArray(db::CellInst(c3.cell_index()), db::Trans(1)));
  c2.insert(db::CellInstArray(db::CellInst(c3.cell_index()),
                              db::Trans(db::Vector(1100, 0))));
  ...
  x = collect(i0s, g);
  EXPECT_EQ(x,
            "[$1](0,100;1000,1200)/[$2](0,100;1000,1200)/[$3](100,0;1100,1100)/"
            "[$4](1200,0;2200,1100)/[$4](-1200,0;-100,1000)");
  EXPECT_EQ(i0s.bbox().to_string(), "(-1200,0;2200,1200)");

  i0s.set_global_trans(db::ICplxTrans(2.0));
  x = collect(i0s, g);
  EXPECT_EQ(x,
            "[$1](0,200;2000,2400)/[$2](0,200;2000,2400)/[$3](200,0;2200,2200)/"
            "[$4](2400,0;4400,2200)/[$4](-2400,0;-200,2000)");
  EXPECT_EQ(i0s.bbox().to_string(), "(-2400,0;4400,2400)");

  db::RecursiveShapeIterator i1(g, c0, 0, db::Box(0, 0, 100, 100));
  x = collect(i1, g);
  EXPECT_EQ(
      x, "[$1](0,100;1000,1200)/[$2](0,100;1000,1200)/[$3](100,0;1100,1100)");
  ...
  EXPECT_EQ(
      x,
      "[$1](10,120;1010,1220)/[$2](10,120;1010,1220)/[$3](110,20;1110,1120)");
  x = collect_with_copy(i1, g);
  EXPECT_EQ(
      x,
      "[$1](10,120;1010,1220)/[$2](10,120;1010,1220)/[$3](110,20;1110,1120)");
  ...
  x = collect(i2, g);
  EXPECT_EQ(x, "[$1](0,100;1000,1200)/[$2](0,100;1000,1200)/"
               "[$3](100,0;1100,1100)/[$4](-1200,0;-100,1000)");
  ...
  EXPECT_EQ(
      x,
      "[$1](0,100;1000,1200)/[$4](1200,0;2200,1100)/[$4](-1200,0;-100,1000)");
  x = collect_with_copy(ii, g);
  EXPECT_EQ(
      x,
      "[$1](0,100;1000,1200)/[$4](1200,0;2200,1100)/[$4](-1200,0;-100,1000)");
...
TEST(1a) {
  ...
  x = collect_with_copy(i2, g);
  EXPECT_EQ(
      x, "[$2](0,100;1000,1200)/[$3](100,0;1100,1100)/[$4](-1200,0;-100,1000)");
  x = collect(i2, g);
  EXPECT_EQ(
      x, "[$2](0,100;1000,1200)/[$3](100,0;1100,1100)/[$4](-1200,0;-100,1000)");
  db::RecursiveShapeIterator i2o(g, c0, 0, db::Box(-100, 0, 100, 100), true);
  ...
  EXPECT_EQ(x, "[$2](0,100;1000,1200)*0/[$3](100,0;1100,1100)*0/"
               "[$4](1200,0;2200,1100)*0/[$4](-1200,0;-100,1000)*0");
  ...
  EXPECT_EQ(
      x,
      "[$2](0,100;1000,1200)*0/[$3](100,0;1100,1100)*0/[$3](101,1;1101,1101)*1/"
      "[$4](1200,0;2200,1100)*0/[$4](-1200,0;-100,1000)*0");
...
TEST(1b) {
  ...
  db::RecursiveShapeIterator i(g, c0, 0,
                               db::Box(1000000, 1000000, 10001000, 10001000));
  std::string x;
  x = collect_with_copy(i, g);
  EXPECT_EQ(x,
            "[$2](1998000,0;2000000,2000000)/[$2](0,1998000;2000000,2000000)/"
            "[$2](1998000,0;2000000,2000000)/[$2](0,1998000;2000000,2000000)");
  x = collect(i, g);
  EXPECT_EQ(x,
            "[$2](1998000,0;2000000,2000000)/[$2](0,1998000;2000000,2000000)/"
  ...
  db::RecursiveShapeIterator i2(g, c0, 0,
                                db::Box(1000000, 1000000, 1001000, 1001000));
  x = collect_with_copy(i2, g);
  EXPECT_EQ(x, "");
  x = collect(i2, g);
  EXPECT_EQ(x, "");
...
TEST(2) {
  ...
  db::Trans tt;
  c0.insert(db::CellInstArray(db::CellInst(c1.cell_index()), tt,
                              db::Vector(0, 6000), db::Vector(6000, 0), 2, 2));
  c1.insert(db::CellInstArray(db::CellInst(c2.cell_index()), tt,
                              db::Vector(0, 2000), db::Vector(3000, 1000), 2,
                              2));
  ...
  x = collect_with_copy(i, g);
  EXPECT_EQ(x, "[$3](1000,-500;2000,500)/[$3](1000,1500;2000,2500)/"
               "[$3](4000,500;5000,1500)/[$3](4000,2500;5000,3500)/"
               "[$3](1000,5500;2000,6500)/[$3](1000,7500;2000,8500)/"
               "[$3](4000,6500;5000,7500)/[$3](4000,8500;5000,9500)/"
               "[$3](7000,-500;8000,500)/[$3](7000,1500;8000,2500)/"
               "[$3](10000,500;11000,1500)/[$3](10000,2500;11000,3500)/"
               "[$3](7000,5500;8000,6500)/[$3](7000,7500;8000,8500)/"
               "[$3](10000,6500;11000,7500)/[$3](10000,8500;11000,9500)");
  x = collect(i, g);
  EXPECT_EQ(x, "[$3](1000,-500;2000,500)/[$3](1000,1500;2000,2500)/"
               "[$3](4000,500;5000,1500)/[$3](4000,2500;5000,3500)/"
               "[$3](1000,5500;2000,6500)/[$3](1000,7500;2000,8500)/"
  ...
  EXPECT_EQ(x, "[$3](7000,5500;8000,6500)/[$3](7000,7500;8000,8500)/"
               "[$3](10000,6500;11000,7500)");
  x = collect(i3, g);
  EXPECT_EQ(x, "[$3](7000,5500;8000,6500)/[$3](7000,7500;8000,8500)/"
               "[$3](10000,6500;11000,7500)");

  db::RecursiveShapeIterator i2o(g, c0, 0, db::Box(3400, 3450, 5600, 6500),
                                 true);
  x = collect_with_copy(i2o, g);
  ...
  db::RecursiveShapeIterator i3o(g, c0, 0, db::Box(6650, 5300, 10000, 7850),
                                 true);
...
TEST(3) {
  ...
  db::RecursiveShapeIterator i2(g, c0, 0,
                                db::Region(db::Box(3400, 3450, 5600, 6500)));
  ...
  db::RecursiveShapeIterator i3(g, c0, 0,
                                db::Region(db::Box(6650, 5300, 10000, 7850)));
  x = collect_with_copy(i3, g);
  EXPECT_EQ(x, "[$3](7000,5500;8000,6500)/[$3](7000,7500;8000,8500)/"
               "[$3](10000,6500;11000,7500)");
  x = collect(i3, g);
  ...
  db::RecursiveShapeIterator i2o(
      g, c0, 0, db::Region(db::Box(3400, 3450, 5600, 6500)), true);
  x = collect_with_copy(i2o, g);
  EXPECT_EQ(x, "[$3](4000,2500;5000,3500)");
  x = collect(i2o, g);
  EXPECT_EQ(x, "[$3](4000,2500;5000,3500)");

  db::RecursiveShapeIterator i3o(
      g, c0, 0, db::Region(db::Box(6650, 5300, 10000, 7850)), true);
  x = collect_with_copy(i3o, g);
  EXPECT_EQ(x, "[$3](7000,5500;8000,6500)/[$3](7000,7500;8000,8500)");
  x = collect(i3o, g);
  EXPECT_EQ(x, "[$3](7000,5500;8000,6500)/[$3](7000,7500;8000,8500)");
  ...
  EXPECT_EQ(i23o.complex_region().to_string(),
            "(3400,3450;3400,6500;5600,6500;5600,3450);(6650,5300;6650,7850;"
            "10000,7850;10000,5300)");

  db::RecursiveShapeIterator i23ocopy = i23o;

  x = collect_with_copy(i23o, g);
  EXPECT_EQ(x, "[$3](4000,2500;5000,3500)/[$3](7000,5500;8000,6500)/"
               "[$3](7000,7500;8000,8500)");
  x = collect(i23o, g);
  EXPECT_EQ(x, "[$3](4000,2500;5000,3500)/[$3](7000,5500;8000,6500)/"
               "[$3](7000,7500;8000,8500)");
...
static db::Layout boxes2layout(const std::set<db::Box> &boxes) {
  ...
  for (std::set<db::Box>::const_iterator b = boxes.begin(); b != boxes.end();
       ++b) {
...
class FlatPusher : public db::RecursiveShapeReceiver {
public:
  FlatPusher(std::set<db::Box> *boxes) : mp_boxes(boxes) {}

  void shape(const db::RecursiveShapeIterator * /*iter*/,
             const db::Shape &shape, const db::ICplxTrans & /*always_apply*/,
...
TEST(4) {
  ...
  for (db::RecursiveShapeIterator iter =
           db::RecursiveShapeIterator(g, c0, 0, search_box, true);
       !iter.at_end(); ++iter) {
  ...
  EXPECT_EQ(db::compare_layouts(
                boxes2layout(selected_boxes), boxes2layout(selected_boxes2),
                db::layout_diff::f_verbose, 0, 100 /*max diff lines*/),
            true);
  ...
  for (db::RecursiveShapeIterator iter =
           db::RecursiveShapeIterator(g, c0, 0, reg, true);
       !iter.at_end(); ++iter) {
    selected_boxes.insert(iter->bbox());
  }
...
TEST(5) {
  ...
  for (int i = 0; i < 100000; ++i) {
    ...
    c0.insert(db::CellInstArray(db::CellInst(c1.cell_index()),
...
class LoggingReceiver : public db::RecursiveShapeReceiver {
public:
  LoggingReceiver() {}
  ...
  virtual void end(const db::RecursiveShapeIterator * /*iter*/) {
    m_text += "end\n";
  }

  virtual void enter_cell(const db::RecursiveShapeIterator *iter,
                          const db::Cell *cell, const db::Box & /*region*/,
                          const box_tree_type * /*complex_region*/) {
    m_text += std::string("enter_cell(") +
              iter->layout()->cell_name(cell->cell_index()) + ")\n";
  }

  virtual void leave_cell(const db::RecursiveShapeIterator *iter,
                          const db::Cell *cell) {
    m_text += std::string("leave_cell(") +
              iter->layout()->cell_name(cell->cell_index()) + ")\n";
  }

  virtual new_inst_mode new_inst(const db::RecursiveShapeIterator *iter,
                                 const db::CellInstArray &inst,
                                 const db::ICplxTrans & /*always_apply*/,
                                 const db::Box & /*region*/,
                                 const box_tree_type * /*complex_region*/,
                                 bool all) {
    m_text += std::string("new_inst(") +
              iter->layout()->cell_name(inst.object().cell_index());
    if (all) {
      m_text += ",all";
    }
    m_text += ")\n";
  ...
  virtual bool new_inst_member(const db::RecursiveShapeIterator *iter,
                               const db::CellInstArray &inst,
                               const db::ICplxTrans &always_apply,
                               ...
                               const box_tree_type * /*complex_region*/,
                               bool all) {
    m_text += std::string("new_inst_member(") +
              iter->layout()->cell_name(inst.object().cell_index()) + "," +
              tl::to_string(always_apply * trans);
    if (all) {
      m_text += ",all";
    }
    m_text += ")\n";
  ...
  virtual void shape(const db::RecursiveShapeIterator * /*iter*/,
...
class ReceiverRejectingACellInstanceArray : public LoggingReceiver {
public:
  ReceiverRejectingACellInstanceArray(db::cell_index_type rejected)
      : m_rejected(rejected) {}
  ...
  virtual new_inst_mode new_inst(const db::RecursiveShapeIterator *iter,
                                 ...
                                 const box_tree_type *complex_region,
                                 bool all) {
    LoggingReceiver::new_inst(iter, inst, always_apply, region, complex_region,
                              all);
...
class ReceiverRejectingACellInstanceArrayExceptOne : public LoggingReceiver {
public:
  ReceiverRejectingACellInstanceArrayExceptOne(db::cell_index_type rejected)
      : m_rejected(rejected) {}
...
class ReceiverRejectingACellInstance : public LoggingReceiver {
public:
  ReceiverRejectingACellInstance(db::cell_index_type rejected,
                                 const db::ICplxTrans &trans_rejected)
      : m_rejected(rejected), m_trans_rejected(trans_rejected) {}
  ...
  virtual bool new_inst_member(const db::RecursiveShapeIterator *iter,
    ...
    LoggingReceiver::new_inst_member(iter, inst, always_apply, trans, region,
                                     complex_region, all);
    return inst.object().cell_index() != m_rejected ||
           trans != m_trans_rejected;
  }
...
TEST(10) {
  ...
  EXPECT_EQ(lr1.text(),
            ...
            //  It's a bit weird to have shape events after new_inst_member, but
            //  remember, new_inst_member is a query callback, not an event.
...
TEST(11_LayoutIsWeakPointer) {
  ...
  //  now the layout is gone and the iterator stays silent (weak pointer to
  //  layout) NOTE: this only works on reset or re-initialization. Not during
  //  iteration.
  i1.reset();
  x = collect(i1, *g);
  EXPECT_EQ(x, "");
