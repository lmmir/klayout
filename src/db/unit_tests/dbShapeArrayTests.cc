...
TEST(1) {
  ...
  shapes.insert(p1);
  shapes.insert(db::array<db::SimplePolygonPtr, db::Disp>(
      db::SimplePolygonPtr(p2, *rep), db::Disp(db::Vector(100, -200)),
...
TEST(2) {
  ...
  for (unsigned int k = 0; k < 2; ++k) {
    ...
    db::Polygon pref_org[9] = {
        ...
        db::Trans(0, false, db::Vector(2000, 0) + db::Vector(100, -200)) * p1,
        db::Trans(0, false, db::Vector(0, -2500) + db::Vector(100, -200)) * p1,
        db::Trans(0, false, db::Vector(2000, -2500) + db::Vector(100, -200)) *
            p1,
        db::Trans(0, false, db::Vector(0, -5000) + db::Vector(100, -200)) * p1,
        db::Trans(0, false, db::Vector(2000, -5000) + db::Vector(100, -200)) *
            p1,
    };
