...
TEST(4) {
  ...
  db::ShapeIterator si(
      s.begin(db::ShapeIterator::Polygons | db::ShapeIterator::Boxes));
...
TEST(8) {
  ...
  db::BoxWithProperties bx2 = db::BoxWithProperties(
      db::Box(db::Point(0, 1000), db::Point(100, 2000)), id1);
  s.insert(bx2);
  ...
  si = db::ShapeIterator(
      s.begin(db::ShapeIterator::Polygons | db::ShapeIterator::Boxes, &prop_sel,
              false));
...
TEST(9) {
  ...
  s.insert(db::EdgePair(db::Edge(db::Point(100, 200), db::Point(200, 400)),
                        db::Edge(db::Point(0, 300), db::Point(100, 500))));
  ...
  s.insert(db::EdgeWithProperties(
      db::Edge(db::Point(100, 200), db::Point(200, 400)), 2));
  s.insert(db::EdgePairWithProperties(
      db::EdgePair(db::Edge(db::Point(100, 200), db::Point(200, 400)),
                   db::Edge(db::Point(0, 300), db::Point(100, 500))),
      3));
  ...
  EXPECT_EQ(si->to_string(),
            "edge_pair (100,200;200,400)/(0,300;100,500) prop_id=3");
  EXPECT_EQ(si->edge_pair().to_string(), "(100,200;200,400)/(0,300;100,500)");
