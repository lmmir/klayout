...
static void compare_lvsdbs(tl::TestBase *_this, const std::string &path,
...
TEST(1_BasicFlow) {
  ...
  std::unique_ptr<db::Region> rmetal2_lbl(
      lvs.make_layer(metal2_lbl, "metal2_lbl"));
  ...
  std::string au_path = tl::combine_path(
      tl::combine_path(tl::testdata(), "algo"), "lvs_test1_au.lvsdb");
  ...
  std::string au_path2 = tl::combine_path(
      tl::combine_path(tl::testdata(), "algo"), "lvs_test1b_au.lvsdb");
...
TEST(2_FlowWithErrors) {
  ...
  std::string au_path = tl::combine_path(
      tl::combine_path(tl::testdata(), "algo"), "lvs_test2_au.lvsdb");
  ...
  std::string au_path2 = tl::combine_path(
      tl::combine_path(tl::testdata(), "algo"), "lvs_test2b_au.lvsdb");
...
TEST(3_ReaderFuture) {
  ...
  std::string in_path = tl::combine_path(
      tl::combine_path(tl::testdata(), "algo"), "lvs_test3.lvsdb");
  lvs.load(in_path);
  ...
  std::string au_path = tl::combine_path(
      tl::combine_path(tl::testdata(), "algo"), "lvs_test3_au.lvsdb");
