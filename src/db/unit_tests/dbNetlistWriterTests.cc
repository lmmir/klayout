...
static void compare_netlists(tl::TestBase *_this, const std::string &path,
                             const std::string &au_path) {
...
TEST(1_WriterResistorDevices) {
  ...
  std::string au_path = tl::combine_path(
      tl::combine_path(tl::testdata(), "algo"), "nwriter1_au.txt");
...
TEST(1_WriterResistorDevicesWithBulk) {
  ...
  std::string au_path = tl::combine_path(
      tl::combine_path(tl::testdata(), "algo"), "nwriter1b_au.txt");
...
TEST(2_WriterCapacitorDevices) {
  ...
  std::string au_path = tl::combine_path(
      tl::combine_path(tl::testdata(), "algo"), "nwriter2_au.txt");
...
TEST(2_WriterCapacitorDevicesNoName) {
  ...
  std::string au_path = tl::combine_path(
      tl::combine_path(tl::testdata(), "algo"), "nwriter2b_au.txt");
...
TEST(2_WriterCapacitorDevicesWithBulk) {
  ...
  std::string au_path = tl::combine_path(
      tl::combine_path(tl::testdata(), "algo"), "nwriter2c_au.txt");
...
TEST(2_WriterCapacitorDevicesWithBulkNoName) {
  ...
  std::string au_path = tl::combine_path(
      tl::combine_path(tl::testdata(), "algo"), "nwriter2d_au.txt");
...
TEST(3_WriterInductorDevices) {
  ...
  std::string au_path = tl::combine_path(
      tl::combine_path(tl::testdata(), "algo"), "nwriter3_au.txt");
...
TEST(4_WriterDiodeDevices) {
  ...
  std::string au_path = tl::combine_path(
      tl::combine_path(tl::testdata(), "algo"), "nwriter4_au.txt");
...
TEST(5_WriterMOS3Devices) {
  ...
  std::string au_path = tl::combine_path(
      tl::combine_path(tl::testdata(), "algo"), "nwriter5_au.txt");
...
TEST(6_WriterMOS4Devices) {
  ...
  std::string au_path = tl::combine_path(
      tl::combine_path(tl::testdata(), "algo"), "nwriter6_au.txt");
...
TEST(7_WriterAnyDevices) {
  ...
  std::string au_path = tl::combine_path(
      tl::combine_path(tl::testdata(), "algo"), "nwriter7_au.txt");
...
TEST(8_WriterSubcircuits) {
...

  {
    ...
    ddev1->set_parameter_value(db::DeviceClassMOS3Transistor::param_id_W, 0.18);
    ddev1->set_parameter_value(db::DeviceClassMOS3Transistor::param_id_AS, 1.2);
    ddev1->set_parameter_value(db::DeviceClassMOS3Transistor::param_id_AD,
                               0.75);
    ddev1->set_parameter_value(db::DeviceClassMOS3Transistor::param_id_PS, 2.2);
    ddev1->set_parameter_value(db::DeviceClassMOS3Transistor::param_id_PD,
                               1.75);
    db::Device *ddev2 = new db::Device(m4cls);
    ddev2->set_parameter_value(db::DeviceClassMOS3Transistor::param_id_L, 1.4);
    ddev2->set_parameter_value(db::DeviceClassMOS3Transistor::param_id_W, 0.25);
    ddev2->set_parameter_value(db::DeviceClassMOS3Transistor::param_id_AS, 1.3);
    ddev2->set_parameter_value(db::DeviceClassMOS3Transistor::param_id_AD,
                               0.85);
    ddev2->set_parameter_value(db::DeviceClassMOS3Transistor::param_id_PS, 2.3);
    ddev2->set_parameter_value(db::DeviceClassMOS3Transistor::param_id_PD,
                               1.85);
    circuit1->add_device(ddev1);
    circuit1->add_device(ddev2);
    ...
    ddev1->connect_terminal(ddev1->device_class()->terminal_id_for_name("S"),
                            n1);
    ddev1->connect_terminal(ddev1->device_class()->terminal_id_for_name("G"),
                            n4);
    ddev1->connect_terminal(ddev1->device_class()->terminal_id_for_name("D"),
                            n3);
    ddev1->connect_terminal(ddev1->device_class()->terminal_id_for_name("B"),
                            n5);
    ddev2->connect_terminal(ddev2->device_class()->terminal_id_for_name("S"),
                            n3);
    ddev2->connect_terminal(ddev1->device_class()->terminal_id_for_name("G"),
                            n4);
    ddev2->connect_terminal(ddev2->device_class()->terminal_id_for_name("D"),
                            n2);
    ddev2->connect_terminal(ddev1->device_class()->terminal_id_for_name("B"),
                            n5);
  }
  ...
  std::string au_path = tl::combine_path(
      tl::combine_path(tl::testdata(), "algo"), "nwriter8_au.txt");
...
TEST(9_WriterNetNamesInsteadOfNumbers) {
...

  {
    ...
    ddev1->connect_terminal(ddev1->device_class()->terminal_id_for_name("A"),
                            n1);
    ddev1->connect_terminal(ddev1->device_class()->terminal_id_for_name("B"),
                            n3);
    ddev2->connect_terminal(ddev2->device_class()->terminal_id_for_name("A"),
                            n3);
    ddev2->connect_terminal(ddev2->device_class()->terminal_id_for_name("B"),
                            n2);
  }
  ...
  std::string au_path = tl::combine_path(
      tl::combine_path(tl::testdata(), "algo"), "nwriter9_au.txt");
...
TEST(10_WriterLongLines) {
  ...
  db::Circuit *circuit1 = new db::Circuit();
  circuit1->set_name("C1withaverylongextensionthatgoesbeyondmultiplelinesunless"
                     "ipasteeverythingtogetherwhichmakesithardtoreadbutexactlyt"
                     "hatisthereasonwhyiwriteitthisway");
  nl.add_circuit(circuit1);
  ...
  std::string au_path = tl::combine_path(
      tl::combine_path(tl::testdata(), "algo"), "nwriter10_au.txt");
...
TEST(11_WriterNonConnectedPins) {
...

  {
    db::Net *n1, *n2, *n3, *n4, *n5;
    n1 = new db::Net();
    //  this gives a clash with the auto-generated node names with non-connected
    //  subcircuit pins and terminals - we test proper generation of such names
    //  this way
    n1->set_name("nc_10");
    circuit2->add_net(n1);
    n2 = new db::Net();
  ...
  std::string au_path = tl::combine_path(
      tl::combine_path(tl::testdata(), "algo"), "nwriter11_au.txt");
  ...
  au_path = tl::combine_path(tl::combine_path(tl::testdata(), "algo"),
                             "nwriter11b_au.txt");
...
TEST(12_UniqueNetNames) {
  ...
  std::string l2n_path = tl::combine_path(
      tl::combine_path(tl::testdata(), "algo"), "same_net_names.l2n");
  l2n.load(l2n_path);
  ...
  std::string au_path = tl::combine_path(
      tl::combine_path(tl::testdata(), "algo"), "nwriter12_au.txt");
...
TEST(13_WriterBJT3Devices) {
  ...
  std::string au_path = tl::combine_path(
      tl::combine_path(tl::testdata(), "algo"), "nwriter13_au.txt");
...
TEST(14_WriterBJT4Devices) {
  ...
  std::string au_path = tl::combine_path(
      tl::combine_path(tl::testdata(), "algo"), "nwriter14_au.txt");
...
class MyDelegate : public db::NetlistSpiceWriterDelegate {
public:
  MyDelegate() : db::NetlistSpiceWriterDelegate() {}

  void write_header() const { emit_line("*** My special header"); }
...
TEST(20_Delegate) {
  ...
  std::string au_path = tl::combine_path(
      tl::combine_path(tl::testdata(), "algo"), "nwriter20_au.txt");
