...
TEST(1) {
  ...
  if (db::default_editable_mode()) {
    s2.erase(db::Box::tag(), db::stable_layer_tag(),
             s2.begin(db::Box::tag(), db::stable_layer_tag()));
...
std::string shapes_to_string_norm(tl::TestBase *_this, const db::Shapes &shapes,
  ...
  for (db::Shapes::shape_iterator shape =
           shapes.begin(db::Shapes::shape_iterator::All);
       !shape.at_end(); ++shape) {
    std::string r;
    if (shape->is_polygon()) {
...
std::string shapes_to_string_norm(tl::TestBase *_this,
                                  const db::Shapes &shapes) {
  std::vector<std::string> strings;
  for (db::Shapes::shape_iterator shape =
           shapes.begin(db::Shapes::shape_iterator::All);
       !shape.at_end(); ++shape) {
...
unsigned int read_testdata(db::Layout &layout, unsigned int what = 0xff) {
  ...
  if ((what & 0x1) != 0) {
    ...
    shapes.insert(p2);
    shapes.insert(p3);
    shapes.insert(db::Shape::simple_polygon_ref_type(
        &p1, db::Trans(db::Vector(-10, 15))));
    shapes.insert(db::Shape::simple_polygon_ref_type(
        &p2, db::Trans(db::Vector(-110, 115))));
    shapes.insert(db::Shape::simple_polygon_ref_type(
        &p3, db::Trans(db::Vector(-210, 215))));
    if (with_arrays)
      shapes.insert(db::Shape::simple_polygon_ptr_array_type(
          db::Shape::simple_polygon_ptr_type(&p1, db::UnitTrans()),
          db::Disp(db::Vector(0, 5)), db::Vector(0, 10000),
          db::Vector(11000, 0), 3, 4));
    ...
    shapes.insert(
        db::object_with_properties<db::Shape::simple_polygon_ref_type>(
            db::Shape::simple_polygon_ref_type(&p1,
                                               db::Trans(db::Vector(-10, 15))),
            5));
    shapes.insert(
        db::object_with_properties<db::Shape::simple_polygon_ref_type>(
            db::Shape::simple_polygon_ref_type(
                &p2, db::Trans(db::Vector(-110, 115))),
            6));
    shapes.insert(
        db::object_with_properties<db::Shape::simple_polygon_ref_type>(
  ...
  if ((what & 0x2) != 0) {
    ...
    shapes.insert(q3);
    shapes.insert(
        db::Shape::polygon_ref_type(&q1, db::Trans(db::Vector(-10, 15))));
    shapes.insert(
        db::Shape::polygon_ref_type(&q2, db::Trans(db::Vector(-110, 115))));
    shapes.insert(
        db::Shape::polygon_ref_type(&q3, db::Trans(db::Vector(-210, 215))));
    if (with_arrays)
      shapes.insert(db::Shape::polygon_ptr_array_type(
          db::Shape::polygon_ptr_type(&q1, db::UnitTrans()),
          db::Disp(db::Vector(0, 5)), db::Vector(0, 10000),
          db::Vector(11000, 0), 3, 4));
    ...
    shapes.insert(db::object_with_properties<db::Shape::polygon_ref_type>(
        db::Shape::polygon_ref_type(&q1, db::Trans(db::Vector(-10, 15))), 5));
    shapes.insert(db::object_with_properties<db::Shape::polygon_ref_type>(
        db::Shape::polygon_ref_type(&q2, db::Trans(db::Vector(-110, 115))), 6));
    shapes.insert(db::object_with_properties<db::Shape::polygon_ref_type>(
        db::Shape::polygon_ref_type(&q3, db::Trans(db::Vector(-210, 215))), 7));
    if (with_arrays)
      shapes.insert(
          db::object_with_properties<db::Shape::polygon_ptr_array_type>(
              db::Shape::polygon_ptr_array_type(
                  db::Shape::polygon_ptr_type(&q1, db::UnitTrans()),
                  db::Disp(db::Vector(0, 5)), db::Vector(0, 10000),
                  db::Vector(11000, 0), 3, 4),
              8));
  ...
  if ((what & 0x4) != 0) {
    ...
    static db::Path r2;
    static db::Path r3;
    db::Point pts1[] = {db::Point(0, 100), db::Point(0, 500),
                        db::Point(200, 700)};
    db::Point pts2[] = {db::Point(0, 1100), db::Point(0, 1500),
                        db::Point(200, 1300)};
    db::Point pts3[] = {db::Point(0, 2100), db::Point(0, 2500),
                        db::Point(-200, 2700)};
    ...
    shapes.insert(r3);
    shapes.insert(
        db::Shape::path_ref_type(&r1, db::Trans(db::Vector(-10, 15))));
    shapes.insert(
        db::Shape::path_ref_type(&r2, db::Trans(db::Vector(-110, 115))));
    shapes.insert(
        db::Shape::path_ref_type(&r3, db::Trans(db::Vector(-210, 215))));
    if (with_arrays)
      shapes.insert(db::Shape::path_ptr_array_type(
          db::Shape::path_ptr_type(&r1, db::UnitTrans()),
          db::Disp(db::Vector(0, 5)), db::Vector(0, 10000),
          db::Vector(11000, 0), 3, 4));
    ...
    shapes.insert(db::object_with_properties<db::Shape::path_ref_type>(
        db::Shape::path_ref_type(&r1, db::Trans(db::Vector(-10, 15))), 5));
    shapes.insert(db::object_with_properties<db::Shape::path_ref_type>(
        db::Shape::path_ref_type(&r2, db::Trans(db::Vector(-110, 115))), 6));
    shapes.insert(db::object_with_properties<db::Shape::path_ref_type>(
        db::Shape::path_ref_type(&r3, db::Trans(db::Vector(-210, 215))), 7));
    if (with_arrays)
      shapes.insert(db::object_with_properties<db::Shape::path_ptr_array_type>(
  ...
  if ((what & 0x8) != 0) {
    ...
    shapes.insert(
        db::Shape::text_ref_type(&t2, db::Disp(db::Vector(-110, 115))));
    shapes.insert(
        db::Shape::text_ref_type(&t3, db::Disp(db::Vector(-210, 215))));
    if (with_arrays)
      shapes.insert(db::Shape::text_ptr_array_type(
          db::Shape::text_ptr_type(&t1, db::UnitTrans()),
          db::Disp(db::Vector(0, 5)), db::Vector(0, 10000),
          db::Vector(11000, 0), 3, 4));
    ...
    shapes.insert(db::object_with_properties<db::Shape::text_ref_type>(
        db::Shape::text_ref_type(&t1, db::Disp(db::Vector(-10, 15))), 5));
    shapes.insert(db::object_with_properties<db::Shape::text_ref_type>(
        db::Shape::text_ref_type(&t2, db::Disp(db::Vector(-110, 115))), 6));
    shapes.insert(db::object_with_properties<db::Shape::text_ref_type>(
        db::Shape::text_ref_type(&t3, db::Disp(db::Vector(-210, 215))), 7));
    if (with_arrays)
      shapes.insert(db::object_with_properties<db::Shape::text_ptr_array_type>(
          db::Shape::text_ptr_array_type(
              db::Shape::text_ptr_type(&t1, db::UnitTrans()),
              db::Disp(db::Vector(0, 5)), db::Vector(0, 10000),
              db::Vector(11000, 0), 3, 4),
          8));
  ...
  if ((what & 0x10) != 0) {
    ...
    shapes.insert(b3);
    if (with_arrays)
      shapes.insert(db::Shape::box_array_type(
          db::Box(50, -50, 1050, -1050), db::UnitTrans(), db::Vector(0, 10000),
          db::Vector(11000, 0), 3, 4));
    ...
    if (with_arrays)
      shapes.insert(db::object_with_properties<db::Shape::box_array_type>(
          db::Shape::box_array_type(db::Box(50, -50, 1050, -1050),
                                    db::UnitTrans(), db::Vector(0, 10000),
                                    db::Vector(11000, 0), 3, 4),
          20));
  }
  ...
  if ((what & 0x20) != 0) {
    ...
    shapes.insert(s3);
    if (with_arrays)
      shapes.insert(db::Shape::short_box_array_type(
          db::ShortBox(50, -50, 1050, -1050), db::UnitTrans(),
          db::Vector(0, 10000), db::Vector(11000, 0), 3, 4));
    ...
    if (with_arrays)
      shapes.insert(db::object_with_properties<db::Shape::short_box_array_type>(
          db::Shape::short_box_array_type(db::ShortBox(50, -50, 1050, -1050),
                                          db::UnitTrans(), db::Vector(0, 10000),
                                          db::Vector(11000, 0), 3, 4),
          20));
  }
...
struct plus1 {
  ...
  operator()(db::Layout::properties_id_type i) const {
    return i + 1;
  }
};
...
TEST(2) {
  ...
  if (db::default_editable_mode()) {
    ...
    db::Shapes::shape_iterator shape =
        topcell.shapes(lindex).begin(db::Shapes::shape_iterator::All);
    ++shape;
    db::Shape s1 = *shape;
    ...
    EXPECT_EQ(shapes_to_string(_this, copy),
              shapes_to_string(_this, topcell.shapes(lindex)));
    ...
    EXPECT_EQ(shapes_to_string_norm(_this, copy),
              shapes_to_string_norm(_this, topcell.shapes(lindex)));
...
TEST(4) {
  ...
  EXPECT_EQ(
      ...
      "path (33000,20105;33000,20505;33200,20705) w=100 bx=0 ex=0 r=false "
      "#8\n");
  ...
  EXPECT_EQ(
      shapes_to_string(_this, sa_copy),
      "path (0,100;0,500;200,700) w=100 bx=0 ex=0 r=false #0\n"
      "path (0,1100;0,1500;200,1300) w=150 bx=0 ex=0 r=false #0\n"
      "path (0,2100;0,2500;-200,2700) w=200 bx=0 ex=0 r=false #0\n"
      "path (-10,115;-10,515;190,715) w=100 bx=0 ex=0 r=false #0\n"
  ...
  if (db::default_editable_mode()) {
    ...
    EXPECT_EQ(
        ...
        "path (0,20105;0,20505;200,20705) w=100 bx=0 ex=0 r=false #0\n"
        "path (11000,105;11000,505;11200,705) w=100 bx=0 ex=0 r=false #0\n"
        "path (11000,20105;11000,20505;11200,20705) w=100 bx=0 ex=0 r=false "
        "#0\n"
        "path (22000,105;22000,505;22200,705) w=100 bx=0 ex=0 r=false #0\n"
        "path (22000,10105;22000,10505;22200,10705) w=100 bx=0 ex=0 r=false "
        "#0\n"
        "path (22000,20105;22000,20505;22200,20705) w=100 bx=0 ex=0 r=false "
        "#0\n"
        "path (33000,105;33000,505;33200,705) w=100 bx=0 ex=0 r=false #0\n"
        "path (33000,10105;33000,10505;33200,10705) w=100 bx=0 ex=0 r=false "
        "#0\n"
        "path (33000,20105;33000,20505;33200,20705) w=100 bx=0 ex=0 r=false "
        "#0\n"
        "path (-10,115;-10,515;190,715) w=100 bx=0 ex=0 r=false #5\n"
        ...
        "path (0,20105;0,20505;200,20705) w=100 bx=0 ex=0 r=false #8\n"
        "path (11000,105;11000,505;11200,705) w=100 bx=0 ex=0 r=false #8\n"
        "path (11000,10105;11000,10505;11200,10705) w=100 bx=0 ex=0 r=false "
        "#8\n"
        "path (11000,20105;11000,20505;11200,20705) w=100 bx=0 ex=0 r=false "
        "#8\n"
        "path (22000,105;22000,505;22200,705) w=100 bx=0 ex=0 r=false #8\n"
...
TEST(5) {
  ...
  if (db::default_editable_mode()) {
    ...
    //  note: we need "norm" since shapes are subject to normalization because
    //  of potential StringRef's in the source
    EXPECT_EQ(shapes_to_string_norm(_this, copy),
              shapes_to_string_norm(_this, topcell.shapes(lindex)));
...
TEST(7) {
  ...
  if (db::default_editable_mode()) {
    ...
    //  in editable mode, no arrays are stored, thus no expansion problems
    //  occure for short boxes
    EXPECT_EQ(shapes_to_string(_this, copy),
              "box (50,-1050;1050,-50) #0\n"
              "box (50,8950;1050,9950) #0\n"
              "box (50,18950;1050,19950) #0\n"
...
TEST(8) {
  ...
  m.undo();
  EXPECT_EQ(shapes_to_string(_this, topcell.shapes(lindex2)),
            shapes_to_string(_this, topcell.shapes(lindex1)));
}
...
TEST(12A) {
  if (db::default_editable_mode()) {
    ...
    db::Layout layout(&m);
    unsigned int lindex =
        read_testdata(layout, 0x20 | 0x80); // short box, no arrays
    ...
    db::Shapes::shape_iterator shape =
        topcell.shapes(lindex).begin(db::Shapes::shape_iterator::All);
    while (!shape.at_end()) {
      topcell.shapes(lindex).replace(
          *shape, db::Box(shape->box().transformed(db::Trans(1))));
      ++shape;
    }
...
TEST(12B) {
  if (db::default_editable_mode()) {
    ...
    while (!shape.at_end()) {
      topcell.shapes(lindex).replace(
          *shape, db::ShortBox(shape->box().transformed(db::Trans(1))));
      ++shape;
    }
...
TEST(12E) {
  if (db::default_editable_mode()) {
    ...
    db::Layout layout(&m);
    unsigned int lindex =
        read_testdata(layout, 0x01 | 0x80); // simple polygon, no arrays
...
TEST(12G) {
  if (db::default_editable_mode()) {
    ...
    db::Layout layout(&m);
    unsigned int lindex =
        read_testdata(layout, 0x02 | 0x80); // polygon, no arrays
...
TEST(12I) {
  if (db::default_editable_mode()) {
    ...
    EXPECT_EQ(
        ...
        "path (-2315,-210;-2715,-210;-2915,-410) w=200 bx=0 ex=0 r=false #0\n"
        "path (-2315,-210;-2715,-210;-2915,-410) w=200 bx=0 ex=0 r=false "
        "#107\n");
  }
}
...
TEST(13) {
  ...
  if (db::default_editable_mode()) {
    ...
    while (!shape.at_end()) {
      ...
      db::Shape new_shape =
          topcell.shapes(lindex).replace(*shape, shape0.bbox());
      if (*shape == shape0) {
        shape0 = new_shape;
      }
      ++shape;
    ...
    EXPECT_EQ(shapes_to_string_norm(_this, topcell.shapes(lindex)),
              shapes_to_string_norm(_this, ref));
  }
}
...
TEST(14) {
  ...
  if (db::default_editable_mode()) {
    ...
    db::Shapes::shape_iterator shape =
        topcell.shapes(lindex).begin(db::Shapes::shape_iterator::All);
    ++shape;
    topcell.shapes(lindex).transform(
        *shape, db::ICplxTrans(2.5, 45.0, false, db::Vector()));
...
TEST(15) {
  ...
  db::Shapes sa_copy;
  for (db::Shapes::shape_iterator shape = topcell.shapes(lindex).begin_touching(
           db::Box(0, 0, 200, 200), db::Shapes::shape_iterator::All);
       !shape.at_end(); ++shape) {
    sa_copy.insert(*shape);
  }
  ...
  sa_copy.clear();
  for (db::Shapes::shape_iterator shape = topcell.shapes(lindex).begin_touching(
           db::Box::world(), db::Shapes::shape_iterator::All);
       !shape.at_end(); ++shape) {
    sa_copy.insert(*shape);
  }
...
TEST(20) {
  ...
  s = shapes.begin_touching(db::Box(-500, -500, 500, 500),
...
TEST(23) {
  ...
  db::Shapes s2 = s;
  EXPECT_EQ(shapes_to_string_norm(_this, s2),
            "edge_pair (-100,-200;0,0)/(0,-100;100,100) #0\n");

  s2.clear();
  s2.insert(db::EdgePairWithProperties(
      db::EdgePair(db::Edge(0, 0, 1, 1), db::Edge(10, 10, 11, 11)), 17));

  EXPECT_EQ(shapes_to_string_norm(_this, s2),
            "edge_pair (0,0;1,1)/(10,10;11,11) #17\n");
}
...
TEST(24a) {
  ...
  s1.insert(s2);
  EXPECT_EQ(
      shapes_to_string_norm(_this, s1),
      "box (0,0;100,200) #0\nbox (1,1;101,201) #0\nedge (0,0;100,200) #0\n");
  m.commit();
...
TEST(101) {
  ...
  const db::Text &tr1_obj =
      *a.shape_repository().repository(db::Text::tag()).begin();
  EXPECT_EQ(&tr1.obj() == &tr1_obj, true);

  //  polygon sits in "a" shape repo now.
  db::PolygonRef pr1 = sp.polygon_ref();
  const db::Polygon &pr1_obj =
      *a.shape_repository().repository(db::Polygon::tag()).begin();
  EXPECT_EQ(&pr1.obj() == &pr1_obj, true);

  //  path sits in "a" shape repo now.
  db::PathRef qr1 = sq.path_ref();
  const db::Path &qr1_obj =
      *a.shape_repository().repository(db::Path::tag()).begin();
  ...
  const db::Text &tr2_obj =
      *b.shape_repository().repository(db::Text::tag()).begin();
  EXPECT_EQ(&tr2.obj() == &tr2_obj, true);

  //  polygon sits in "b" shape repo now.
  db::PolygonRef pr2 = sp2.polygon_ref();
  const db::Polygon &pr2_obj =
      *b.shape_repository().repository(db::Polygon::tag()).begin();
  EXPECT_EQ(&pr2.obj() == &pr2_obj, true);

  //  path sits in "b" shape repo now.
  db::PathRef qr2 = sq2.path_ref();
  const db::Path &qr2_obj =
      *b.shape_repository().repository(db::Path::tag()).begin();
