...
namespace {
class DummyDeviceExtractor : public db::NetlistDeviceExtractor {
public:
  DummyDeviceExtractor() : db::NetlistDeviceExtractor(std::string("DUMMY")) {
    error("msg1");
...
static std::string error2string(const db::NetlistDeviceExtractorError &e) {
  return e.cell_name() + ":" + e.category_name() + ":" +
         e.category_description() + ":" + e.geometry().to_string() + ":" +
         e.message();
}
...
TEST(2_NetlistDeviceExtractorErrors) {
  ...
  std::vector<db::NetlistDeviceExtractorError> errors(dummy_ex.begin_errors(),
                                                      dummy_ex.end_errors());
  ...
  EXPECT_EQ(error2string(errors[3]),
            ":cat1:desc1:(10,11;10,13;12,13;12,11):msg3");
}

namespace {

class MyDeviceClass : public db::DeviceClassMOS3Transistor {
public:
...
TEST(3_ClassFactoryTest) {
  ...
  //  original layers
  db::Region l1(db::RecursiveShapeIterator(
                    ly, tc, ly.get_layer(db::LayerProperties(1, 0))),
                dss);
  db::Region l2(db::RecursiveShapeIterator(
                    ly, tc, ly.get_layer(db::LayerProperties(2, 0))),
                dss);
  db::Region o1(dss);
  db::Region o2(dss);
  db::Region o3(dss);
  ...
  db::NetlistDeviceExtractorMOS3Transistor ex(
      "MOS3", false, new db::device_class_factory<MyDeviceClass>());
  ...
  EXPECT_EQ(
      dynamic_cast<const MyDeviceClass *>(nl.device_class_by_name("MOS3")) != 0,
      true);
}
...
TEST(10_MOS3DeviceExtractorTest) {
  ...
  EXPECT_EQ(nl.to_string(), "circuit TOP ();\n"
                            "  device MOS3 $1 (S=(null),G=(null),D=(null)) "
                            "(L=0.3,W=0.8,AS=0.4,AD=0.16,PS=2.6,PD=2);\n"
                            "end;\n");
...
TEST(11_MOS3DeviceExtractorTestNotRectangularGate) {
  ...
  EXPECT_EQ(nl.to_string(), "circuit TOP ();\n"
                            "  device MOS3 $1 (S=(null),G=(null),D=(null)) "
                            "(L=0.3,W=1,AS=0.32,AD=0.18,PS=2.6,PD=2.4);\n"
                            "end;\n");
  EXPECT_EQ(o1.to_string(),
            "(-600,-200;-600,600;-300,600;-300,200;-100,200;-100,-200)");
  EXPECT_EQ(o2.to_string(), "(200,-200;200,500;0,500;0,600;400,600;400,-200)");
  EXPECT_EQ(
      o3.to_string(),
      "(-100,-200;-100,200;-300,200;-300,600;0,600;0,500;200,500;200,-200)");
}
...
TEST(12_MOS3DeviceExtractorTestCircular) {
  ...
  EXPECT_EQ(nl.to_string(), "circuit TOP ();\n"
                            "  device MOS3 $1 (S=(null),G=(null),D=(null)) "
                            "(L=0.3,W=3.8,AS=0.4,AD=4.18,PS=2.6,PD=14.6);\n"
                            "end;\n");
  EXPECT_EQ(o1.to_string(), "(200,-200;200,600;700,600;700,-200)");
  EXPECT_EQ(o2.to_string(), "(-600,-1200;-600,1400;1600,1400;1600,-1200/"
                            "-100,-500;1000,-500;1000,900;-100,900)");
  EXPECT_EQ(o3.to_string(), "(-100,-500;-100,900;1000,900;1000,-500/"
                            "200,-200;700,-200;700,600;200,600)");
}
...
TEST(20_MOS4DeviceExtractorTest) {
  ...
  db::Region l2(db::RecursiveShapeIterator(
                    ly, tc, ly.get_layer(db::LayerProperties(2, 0))),
                dss);
  db::Region l3(db::RecursiveShapeIterator(
                    ly, tc, ly.get_layer(db::LayerProperties(3, 0))),
                dss);
  db::Region o1(dss);
  db::Region o2(dss);
  db::Region o3(dss);
  ...
  EXPECT_EQ(nl.to_string(),
            "circuit TOP ();\n"
            "  device MOS4 $1 (S=(null),G=(null),D=(null),B=(null)) "
            "(L=0.3,W=0.8,AS=0.4,AD=0.16,PS=2.6,PD=2);\n"
            "end;\n");
  EXPECT_EQ(o1.to_string(), "(-600,-200;-600,600;-100,600;-100,-200)");
  EXPECT_EQ(o2.to_string(), "(200,-200;200,600;400,600;400,-200)");
...
TEST(22_MOS4DeviceExtractorTestCircular) {
  ...
  EXPECT_EQ(o3.to_string(), "(-100,-500;-100,900;1000,900;1000,-500/"
                            "200,-200;700,-200;700,600;200,600)");
  EXPECT_EQ(o4.to_string(), "(-100,-500;-100,900;1000,900;1000,-500/"
                            "200,-200;700,-200;700,600;200,600)");
}
...
TEST(30_DMOS3DeviceExtractorTest) {
  ...
  //  original layers
  db::Region l0(db::RecursiveShapeIterator(
                    ly, tc, ly.get_layer(db::LayerProperties(0, 0))),
                dss);
  db::Region l1(db::RecursiveShapeIterator(
                    ly, tc, ly.get_layer(db::LayerProperties(1, 0))),
                dss);
  ...
  EXPECT_EQ(nl.to_string(), "circuit TOP ();\n"
                            "  device DMOS3 $1 (S=(null),G=(null),D=(null)) "
                            "(L=0.3,W=0.8,AS=0.4,AD=0.16,PS=2.6,PD=2);\n"
                            "end;\n");
  EXPECT_EQ(o1.to_string(), "(-600,-200;-600,600;-100,600;-100,-200)");
  EXPECT_EQ(o2.to_string(), "(200,-200;200,600;400,600;400,-200)");
...
TEST(40_DMOS4DeviceExtractorTest) {
  ...
  EXPECT_EQ(nl.to_string(),
            "circuit TOP ();\n"
            "  device DMOS4 $1 (S=(null),G=(null),D=(null),B=(null)) "
            "(L=0.3,W=0.8,AS=0.4,AD=0.16,PS=2.6,PD=2);\n"
            "end;\n");
  EXPECT_EQ(o1.to_string(), "(-600,-200;-600,600;-100,600;-100,-200)");
  EXPECT_EQ(o2.to_string(), "(200,-200;200,600;400,600;400,-200)");
...
TEST(50_BJT3DeviceExtractorTest) {
  ...
  EXPECT_EQ(nl.to_string(), "circuit TOP ();\n"
                            "  device BJT3 $1 (C=(null),B=(null),E=(null)) "
                            "(AE=0.81,PE=3.6,AB=5,PB=9,AC=5,PC=9,NE=1);\n"
                            "end;\n");
  EXPECT_EQ(o1.to_string(), "(700,400;700,1300;1600,1300;1600,400)");
  EXPECT_EQ(
      o2.to_string(),
      "(0,0;0,2000;2500,2000;2500,0/700,400;1600,400;1600,1300;700,1300)");
  EXPECT_EQ(
      o3.to_string(),
      "(0,0;0,2000;2500,2000;2500,0/700,400;1600,400;1600,1300;700,1300)");
}
...
TEST(51_BJT3DeviceExtractorTest) {
  ...
  EXPECT_EQ(
      o2.to_string(),
      "(0,0;0,2000;2500,2000;2500,0/700,400;1600,400;1600,1300;700,1300)");
  EXPECT_EQ(o3.to_string(), "(-1000,-500;-1000,2500;3000,2500;3000,-500/"
                            "0,0;2500,0;2500,2000;0,2000)");
}
...
TEST(52_BJT3DeviceExtractorTestLateral) {
  ...
  EXPECT_EQ(nl.to_string(), "circuit TOP ();\n"
                            "  device BJT3 $1 (C=(null),B=(null),E=(null)) "
                            "(AE=0.81,PE=3.6,AB=5,PB=9,AC=0.8,PC=4.8,NE=1);\n"
                            "end;\n");
  EXPECT_EQ(o1.to_string(), "(700,400;700,1300;1600,1300;1600,400)");
  EXPECT_EQ(
      o2.to_string(),
      "(0,0;0,2000;2100,2000;2100,0/700,400;1600,400;1600,1300;700,1300)");
...
TEST(53_BJT3DeviceExtractorTestMultEmitter) {
  ...
  EXPECT_EQ(nl.to_string(), "circuit TOP ();\n"
                            "  device BJT3 $1 (C=(null),B=(null),E=(null)) "
                            "(AE=0.5,PE=3,AB=10,PB=14,AC=10,PC=14,NE=1);\n"
                            "  device BJT3 $2 (C=(null),B=(null),E=(null)) "
                            "(AE=0.5,PE=3,AB=10,PB=14,AC=10,PC=14,NE=1);\n"
                            "end;\n");
  EXPECT_EQ(o1.to_string(), "(1000,500;1000,1500;1500,1500;1500,500);(3500,500;"
                            "3500,1500;4000,1500;4000,500)");
  EXPECT_EQ(
      o2.to_string(),
      "(0,0;0,2000;5000,2000;5000,0/1000,500;1500,500;1500,1500;1000,1500/"
      "3500,500;4000,500;4000,1500;3500,1500);(0,0;0,2000;5000,2000;5000,0/"
      "1000,500;1500,500;1500,1500;1000,1500/"
      "3500,500;4000,500;4000,1500;3500,1500)");
  EXPECT_EQ(o3.to_string(), "(-500,-500;-500,2500;5500,2500;5500,-500/"
                            "0,0;5000,0;5000,2000;0,2000);(-500,-500;-500,2500;"
                            "5500,2500;5500,-500/0,0;5000,0;5000,2000;0,2000)");
}
...
TEST(54_BJT4DeviceExtractorTest) {
  ...
  EXPECT_EQ(nl.to_string(),
            "circuit TOP ();\n"
            "  device BJT4 $1 (C=(null),B=(null),E=(null),S=(null)) "
            "(AE=0.81,PE=3.6,AB=5,PB=9,AC=5,PC=9,NE=1);\n"
            "end;\n");
  EXPECT_EQ(o1.to_string(), "(700,400;700,1300;1600,1300;1600,400)");
  EXPECT_EQ(
