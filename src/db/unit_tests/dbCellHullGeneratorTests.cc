...
static std::string h2s(const std::vector<db::Polygon> &hull) {
  std::string r;
  for (std::vector<db::Polygon>::const_iterator h = hull.begin();
       h != hull.end(); ++h) {
    if (!r.empty()) {
      r += ";";
    }
...
static bool check_hull(const std::vector<db::Polygon> &hull,
                       const db::Shapes &shapes) {
  std::vector<db::Polygon> sp;
  for (db::ShapeIterator s =
           shapes.begin(db::ShapeIterator::Polygons | db::ShapeIterator::Boxes |
  ...
  if (!out.empty()) {
    ...
    for (std::vector<db::Polygon>::const_iterator p = out.begin();
         p != out.end(); ++p) {
...
TEST(1) {
  ...
  EXPECT_EQ(
      h2s(hull),
      "(-100,-100;-100,2000;0,2000;0,2100;2100,2100;2100,0;2000,0;2000,-100)");
  ...
  EXPECT_EQ(
      h2s(hull),
      "(0,0;0,2000;2000,2000;2000,1800;200,1800;200,200;2000,200;2000,0)");
  EXPECT_EQ(check_hull(hull, c1.shapes(l1)), true);
  EXPECT_EQ(check_hull(hull, c1.shapes(l2)), true);
  ...
  EXPECT_EQ(
      h2s(hull),
      "(0,0;0,2000;2000,2000;2000,0/200,200;1800,200;1800,1800;200,1800)");
  EXPECT_EQ(check_hull(hull, c1.shapes(l1)), true);
  EXPECT_EQ(check_hull(hull, c1.shapes(l2)), true);
  ...
  EXPECT_EQ(
      h2s(hull),
      "(0,0;0,2000;2000,2000;2000,0/200,100;1800,100;1800,150;200,150/"
      "100,200;150,200;150,1800;100,1800/200,200;1800,200;1800,1800;200,1800/"
      "200,1900;1950,1900;1950,1950;200,1950)");
  EXPECT_EQ(check_hull(hull, c1.shapes(l1)), true);
  EXPECT_EQ(check_hull(hull, c1.shapes(l2)), true);
  ...
  EXPECT_EQ(
      h2s(hull),
      "(0,0;0,200;200,200;200,0);(1800,1800;1800,2000;2000,2000;2000,1800)");
  EXPECT_EQ(check_hull(hull, c1.shapes(l1)), true);
  EXPECT_EQ(check_hull(hull, c1.shapes(l2)), true);
  ...
  {
    db::Point pts[3] = {db::Point(0, 0), db::Point(0, 200),
                        db::Point(200, 200)};
    db::Polygon poly;
  ...
  {
    db::Point pts[3] = {db::Point(1800, 1800), db::Point(1800, 2000),
                        db::Point(2000, 2000)};
    db::Polygon poly;
    poly.assign_hull(&pts[0], &pts[0] + 3);
    c1.shapes(l1).insert(poly);
  ...
  hull.clear();
  chg.generate_hull(c1, hull);
  EXPECT_EQ(h2s(hull), "(0,0;0,200;200,200;200,0);(1500,1500;1500,2000;2000,"
                       "2000;2000,1800;1700,1800;1700,1500)");
  EXPECT_EQ(check_hull(hull, c1.shapes(l1)), true);
  EXPECT_EQ(check_hull(hull, c1.shapes(l2)), true);
  ...
  chg.generate_hull(c1, hull);
  EXPECT_EQ(h2s(hull), "(0,0;0,1950;400,1950;400,1900;600,1900;600,1800;1000,"
                       "1800;1000,1950;1900,1950;1900,2000;2000,2000;2000,0)");
  EXPECT_EQ(check_hull(hull, c1.shapes(l1)), true);
  EXPECT_EQ(check_hull(hull, c1.shapes(l2)), true);
  ...
  chg.generate_hull(c1, hull);
  EXPECT_EQ(h2s(hull),
            "(0,0;0,1950;400,1950;400,1900;500,1900;500,1850;600,1850;600,1800;"
            "1000,1800;1000,1950;1200,1950;1200,1900;1400,1900;1400,1950;1900,"
            "1950;1900,2000;2000,2000;2000,0)");
  EXPECT_EQ(check_hull(hull, c1.shapes(l1)), true);
  EXPECT_EQ(check_hull(hull, c1.shapes(l2)), true);
  ...
  EXPECT_EQ(
      h2s(hull),
      "(0,0;0,1950;100,1950;100,1800;200,1800;200,1750;300,1750;300,1950;400,"
      "1950;400,1900;500,1900;500,1850;600,1850;600,1750;700,1750;700,1700;800,"
      "1700;800,1750;900,1750;900,1800;1000,1800;1000,1950;1100,1950;1100,1800;"
      "1200,1800;1200,1750;1300,1750;1300,1900;1400,1900;1400,1950;1500,1950;"
      "1500,1850;1600,1850;1600,1950;1700,1950;1700,1900;1800,1900;1800,1950;"
      "1900,1950;1900,2000;2000,2000;2000,0)");
  EXPECT_EQ(check_hull(hull, c1.shapes(l1)), true);
  EXPECT_EQ(check_hull(hull, c1.shapes(l2)), true);
}
