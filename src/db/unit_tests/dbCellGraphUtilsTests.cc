...
TEST(1) {
  ...
  db::Trans tt;
  c0.insert(db::CellInstArray(db::CellInst(c1.cell_index()), tt, db::Vector(),
                              db::Vector(), 5, 2));
  c0.insert(db::CellInstArray(db::CellInst(c2.cell_index()), tt));
  c4.insert(db::CellInstArray(db::CellInst(c2.cell_index()), tt, db::Vector(),
                              db::Vector(), 3, 4));
...
public:
  ...
  InstanceReferenceSum(size_t count, const db::Matrix2d &m,
                       const db::DVector &p)
