...
TEST(1) {
  ...
  EXPECT_EQ(e.transformed(db::Trans(1, db::Vector(0, 0))).dx_abs(),
            db::Edge::distance_type(200));
  EXPECT_EQ(e.transformed(db::Trans(1, db::Vector(0, -100))).dy_abs(),
            db::Edge::distance_type(100));
  EXPECT_EQ(e.dy(), 200);
  EXPECT_EQ(e != db::Edge(db::Point(0, 0), db::Point(100, 200)), false);
  EXPECT_EQ(e == db::Edge(db::Point(0, 0), db::Point(100, 200)), true);
  EXPECT_EQ(e.moved(db::Vector(10, 20)),
            db::Edge(db::Point(10, 20), db::Point(110, 220)));
  EXPECT_EQ(e.enlarged(db::Vector(10, 20)),
            db::Edge(db::Point(-10, -20), db::Point(110, 220)));
  EXPECT_EQ(e.length(), db::coord_traits<db::Coord>::rounded_distance(
                            sqrt(double(100 * 100 + 200 * 200))));
  ...
  EXPECT_EQ(e.transformed(db::Trans(5)).to_string(),
            "(200,100;0,0)"); //  mirroring transformations swap points
  ee = e;
...
TEST(2) {
  ...
  EXPECT_EQ(db::Edge(10, 20, 110, 230).distance_abs(db::Point(100, 200)),
            db::Edge::distance_type(4));
  EXPECT_EQ(db::Edge(10, 20, 110, 210).distance(db::Point(100, 200)), 4);
  EXPECT_EQ(db::Edge(10, 20, 110, 222).distance(db::Point(100, 200)), -1);
  EXPECT_EQ(db::Edge(10, 20, 110, 222).distance_abs(db::Point(100, 200)),
  ...
  EXPECT_EQ(db::Edge(10, 20, 110, 20).euclidian_distance(db::Point(100, 120)),
            100);
  EXPECT_EQ(db::Edge(10, 20, 110, 20).euclidian_distance(db::Point(100, -80)),
            100);
  EXPECT_EQ(db::Edge(10, 20, 110, 20).euclidian_distance(db::Point(-90, 120)),
            141);
  EXPECT_EQ(db::Edge(10, 20, 110, 20).euclidian_distance(db::Point(-90, -80)),
            141);
  EXPECT_EQ(db::Edge(10, 20, 110, 20).euclidian_distance(db::Point(210, 120)),
            141);
  EXPECT_EQ(db::Edge(10, 20, 110, 20).euclidian_distance(db::Point(210, -80)),
            141);
  EXPECT_EQ(db::Edge(10, 20, 110, 20).euclidian_distance(db::Point(-90, 20)),
            100);
  ...
  EXPECT_EQ(db::Edge(10, 20, 110, 20).euclidian_distance(db::Point(110, 20)),
            0);
}
...
TEST(4) {
  ...
  EXPECT_EQ(e.intersect_point(db::Edge(10, 20, 110, 220)).first, true);
  EXPECT_EQ(e.intersect_point(db::Edge(10, 20, 110, 220)).second,
            db::Point(10, 20));
  EXPECT_EQ(e.intersect_point(db::Edge(10, -20, -110, 220)).second,
            db::Point(0, 0));
  EXPECT_EQ(e.intersect_point(db::Edge(20, 0, -80, 200)).second,
            db::Point(10, 20));
  EXPECT_EQ(e.intersect_point(db::Edge(20, 10, -80, 200)).second,
            db::Point(12, 25));
  EXPECT_EQ(e.intersect_point(db::Edge(10, 20, -80, 200)).second,
            db::Point(10, 20));
}
...
TEST(5) {
  ...
  EXPECT_EQ(e.intersect_point(db::Edge(100000, 200000, 1100000, 2200000)).first,
            true);
  EXPECT_EQ(
      e.intersect_point(db::Edge(100000, -200000, -1100000, 2200000)).first,
      true);
  EXPECT_EQ(
      e.intersect_point(db::Edge(80000, -200000, -1100000, 2200000)).first,
      false);
  EXPECT_EQ(e.intersect_point(db::Edge(200000, 0, -800000, 2000000)).first,
            true);
  EXPECT_EQ(e.intersect_point(db::Edge(200000, 100000, -800000, 2000000)).first,
            true);
  EXPECT_EQ(e.intersect_point(db::Edge(100000, 200000, -800000, 2000000)).first,
            true);
  EXPECT_EQ(e.intersect_point(db::Edge(80000, 200000, -800000, 2000000)).first,
            false);
  EXPECT_EQ(e.intersect_point(db::Edge(100000, 200000, 1100000, 2200000)).first,
            true);
  EXPECT_EQ(
      e.intersect_point(db::Edge(100000, 200000, 1100000, 2200000)).second,
      db::Point(100000, 200000));
  EXPECT_EQ(
      e.intersect_point(db::Edge(100000, -200000, -1100000, 2200000)).second,
      db::Point(0, 0));
  EXPECT_EQ(e.intersect_point(db::Edge(200000, 0, -800000, 2000000)).second,
            db::Point(100000, 200000));
  EXPECT_EQ(
      e.intersect_point(db::Edge(200000, 100000, -800000, 2000000)).second,
      db::Point(123077, 246154));
  EXPECT_EQ(
      e.intersect_point(db::Edge(100000, 200000, -800000, 2000000)).second,
      db::Point(100000, 200000));
}
...
TEST(13) {
  ...
  cl = db::Edge(db::Point(0, 0), db::Point(100, 0))
           .clipped(db::Box(db::Point(50, -20), db::Point(60, 20)));
  EXPECT_EQ(cl.first, true);
  EXPECT_EQ(cl.second.to_string(), "(50,0;60,0)");
  cl = db::Edge(db::Point(0, 0), db::Point(100, 0))
           .clipped(db::Box(db::Point(50, 0), db::Point(60, 20)));
  EXPECT_EQ(cl.first, true);
  EXPECT_EQ(cl.second.to_string(), "(50,0;60,0)");
  cl = db::Edge(db::Point(0, 0), db::Point(100, 0))
           .clipped(db::Box(db::Point(50, 10), db::Point(60, 20)));
  EXPECT_EQ(cl.first, false);
  cl = db::Edge(db::Point(0, 0), db::Point(100, 0))
           .clipped(db::Box(db::Point(100, 0), db::Point(160, 20)));
  EXPECT_EQ(cl.first, true);
  EXPECT_EQ(cl.second.to_string(), "(100,0;100,0)");
  cl = db::Edge(db::Point(0, 0), db::Point(100, 0))
           .clipped(db::Box(db::Point(80, 0), db::Point(160, 20)));
  EXPECT_EQ(cl.first, true);
  EXPECT_EQ(cl.second.to_string(), "(80,0;100,0)");
  cl = db::Edge(db::Point(0, 0), db::Point(100, 0))
           .clipped(db::Box(db::Point(-100, 0), db::Point(0, 20)));
  EXPECT_EQ(cl.first, true);
  EXPECT_EQ(cl.second.to_string(), "(0,0;0,0)");
  cl = db::Edge(db::Point(0, 0), db::Point(100, 0))
           .clipped(db::Box(db::Point(-100, 0), db::Point(20, 20)));
  EXPECT_EQ(cl.first, true);
  EXPECT_EQ(cl.second.to_string(), "(0,0;20,0)");
  cl = db::Edge(db::Point(0, 0), db::Point(0, 0))
           .clipped(db::Box(db::Point(-100, 0), db::Point(20, 20)));
  EXPECT_EQ(cl.first, true);
  EXPECT_EQ(cl.second.to_string(), "(0,0;0,0)");
  cl = db::Edge(db::Point(0, 0), db::Point(0, 0))
  ...
  cl = db::Edge(db::Point(851, 98), db::Point(343, 466))
           .clipped(db::Box(db::Point(48, 134), db::Point(555, 438)));
  EXPECT_EQ(cl.first, true);
  EXPECT_EQ(cl.second.to_string(), "(555,312;382,438)");

  cl = db::Edge(db::Point(4, 0), db::Point(9, 2))
           .clipped(db::Box(db::Point(1, 2), db::Point(8, 6)));
  EXPECT_EQ(cl.first, true);
  ...
  EXPECT_EQ(db::Edge(db::Point(0, 100), db::Point(600, 500))
                .clipped(db::Box(db::Point(100, 200), db::Point(200, 300)))
                .second.to_string(),
            "(150,200;200,233)");
  EXPECT_EQ(db::Edge(db::Point(0, 100), db::Point(600, 500))
                .clipped(db::Box(db::Point(200, 200), db::Point(300, 300)))
                .second.to_string(),
            "(200,233;300,300)");
}
...
TEST(14) {
  ...
  EXPECT_EQ(e.coincident(db::Edge(db::Point(-100, 0), db::Point(100, 0))),
            true);
  EXPECT_EQ(e.coincident(db::Edge(db::Point(-100, 0), db::Point(200, 0))),
            true);
...
TEST(15) {
  ...
  EXPECT_EQ(db::div_exact(area_type(-3 * 11), area_type(2), area_type(176)), 0);
  EXPECT_EQ(db::div_exact(area_type(-4 * 11), area_type(2), area_type(176)),
            -1);
  EXPECT_EQ(db::div_exact(area_type(-5 * 11), area_type(2), area_type(176)),
            -1);
  EXPECT_EQ(db::div_exact(area_type(-7 * 11), area_type(2), area_type(176)),
            -1);
  EXPECT_EQ(db::div_exact(area_type(-8 * 11), area_type(2), area_type(176)),
            -1);
  EXPECT_EQ(db::div_exact(area_type(-12 * 11), area_type(2), area_type(176)),
            -2);
  EXPECT_EQ(db::div_exact(area_type(-13 * 11), area_type(2), area_type(176)),
            -2);

  area_type f = 790014345;

  EXPECT_EQ(db::div_exact(area_type(4), area_type(22) * f, area_type(176) * f),
            0);
  EXPECT_EQ(db::div_exact(area_type(5), area_type(22) * f, area_type(176) * f),
            1);
  EXPECT_EQ(db::div_exact(area_type(8), area_type(22) * f, area_type(176) * f),
            1);

  EXPECT_EQ(db::div_exact(area_type(-3), area_type(22) * f, area_type(176) * f),
            0);
  EXPECT_EQ(db::div_exact(area_type(-4), area_type(22) * f, area_type(176) * f),
            -1);
  EXPECT_EQ(db::div_exact(area_type(-5), area_type(22) * f, area_type(176) * f),
  ...
  EXPECT_EQ(db::div_exact(area_type(4) * 100000000, area_type(22) * f,
                          area_type(176) * f),
            50000000);
  EXPECT_EQ(db::div_exact(area_type(5) * 100000000, area_type(22) * f,
                          area_type(176) * f),
            62500000);
  EXPECT_EQ(db::div_exact(area_type(-4) * 100000000, area_type(22) * f,
                          area_type(176) * f),
  ...
  EXPECT_EQ(db::div_exact(1000000004, area_type(22) * f, area_type(176) * f),
            125000000);
  EXPECT_EQ(db::div_exact(1000000005, area_type(22) * f, area_type(176) * f),
            125000001);
  EXPECT_EQ(db::div_exact(-1000000003, area_type(22) * f, area_type(176) * f),
            -125000000);
  EXPECT_EQ(db::div_exact(-1000000004, area_type(22) * f, area_type(176) * f),
            -125000001);
  EXPECT_EQ(db::div_exact(-1000000005, area_type(22) * f, area_type(176) * f),
