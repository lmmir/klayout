...
TEST(11_SerialInductors) {
  ...
  EXPECT_EQ(nl.to_string(), "circuit '' (A=n1,B=n3);\n"
...
TEST(12_ParallelInductors) {
  ...
  EXPECT_EQ(nl.to_string(), "circuit '' (A=n1,B=n2);\n"
...
TEST(30_ParallelMOS4Transistors) {
  ...
  EXPECT_EQ(nl.to_string(), "circuit '' (A=n1,B=n2,C=n3,D=n0);\n"
                            "  device '' d1 (S=n1,G=n3,D=n2,B=n0) "
                            "(L=0.5,W=1,AS=2,AD=3,PS=12,PD=13);\n"
                            "  device '' d2 (S=n1,G=n3,D=n2,B=n0) "
                            "(L=0.5,W=2,AS=3,AD=4,PS=13,PD=14);\n"
                            "end;\n");
  ...
  EXPECT_EQ(nl.to_string(), "circuit '' (A=n1,B=n2,C=n3,D=n0);\n"
                            "  device '' d1 (S=n1,G=n3,D=n2,B=n0) "
                            "(L=0.5,W=3,AS=5,AD=7,PS=25,PD=27);\n"
                            "end;\n");
}
...
TEST(32_ParallelMOS4TransistorsDisconnectedGates) {
  ...
  EXPECT_EQ(nl.to_string(), "circuit '' (A=n1,B=n2,C1=n3a,C2=n3b,D=n0);\n"
                            "  device '' d1 (S=n1,G=n3a,D=n2,B=n0) "
                            "(L=0.5,W=1,AS=2,AD=3,PS=12,PD=13);\n"
                            "  device '' d2 (S=n1,G=n3b,D=n2,B=n0) "
                            "(L=0.5,W=2,AS=3,AD=4,PS=13,PD=14);\n"
                            "end;\n");
...
TEST(33_ParallelMOS4TransistorsDisconnectedBulk) {
  ...
  EXPECT_EQ(nl.to_string(), "circuit '' (A=n1,B=n2,C=n3,D1=n0a,D2=n0b);\n"
                            "  device '' d1 (S=n1,G=n3,D=n2,B=n0a) "
                            "(L=0.5,W=1,AS=2,AD=3,PS=12,PD=13);\n"
                            "  device '' d2 (S=n1,G=n3,D=n2,B=n0b) "
                            "(L=0.5,W=2,AS=3,AD=4,PS=13,PD=14);\n"
                            "end;\n");
...
TEST(34_ParallelMOS4TransistorsDifferentLength) {
  ...
  EXPECT_EQ(nl.to_string(), "circuit '' (A=n1,B=n2,C=n3,D=n0);\n"
                            ...
                            "(L=0.5,W=1,AS=2,AD=3,PS=12,PD=13);\n"
                            "  device '' d2 (S=n1,G=n3,D=n2,B=n0) "
                            "(L=0.75,W=2,AS=3,AD=4,PS=13,PD=14);\n"
                            "end;\n");
...
TEST(35_SerialCapacitorsWithBulk) {
  db::DeviceClassCapacitorWithBulk *cap =
      new db::DeviceClassCapacitorWithBulk();
  ...
  EXPECT_EQ(nl.to_string(), "circuit '' (A=n1,B=n3,BULK=nb);\n"
...
TEST(36_ParallelCapacitorsWithBulk) {
  ...
  EXPECT_EQ(nl.to_string(), "circuit '' (A=n1,B=n2,BULK=nb);\n"
...
TEST(39_ParallelBJT3Transistors) {
  ...
  EXPECT_EQ(nl.to_string(), "circuit '' (A=n1,B=n2,C=n3);\n"
                            "  device '' d1 (C=n1,B=n2,E=n3) "
                            "(AE=2,PE=12,AB=3,PB=13,AC=4,PC=14,NE=1);\n"
                            "  device '' d2 (C=n1,B=n2,E=n2) "
                            "(AE=3,PE=13,AB=4,PB=14,AC=5,PC=15,NE=4);\n"
                            "end;\n");
  ...
  EXPECT_EQ(nl.to_string(), "circuit '' (A=n1,B=n2,C=n3);\n"
                            "  device '' d1 (C=n1,B=n2,E=n3) "
                            "(AE=5,PE=25,AB=3,PB=13,AC=4,PC=14,NE=5);\n"
                            "end;\n");
}
...
TEST(40_ParallelBJT4Transistors) {
  ...
  EXPECT_EQ(nl.to_string(), "circuit '' (A=n1,B=n2,C=n3,D=n4);\n"
                            "  device '' d1 (C=n1,B=n2,E=n3,S=n4) "
                            "(AE=2,PE=12,AB=3,PB=13,AC=4,PC=14,NE=2);\n"
                            "  device '' d2 (C=n1,B=n2,E=n2,S=n4) "
                            "(AE=3,PE=13,AB=4,PB=14,AC=5,PC=15,NE=3);\n"
                            "end;\n");
...
TEST(50_SplitGatesSimple) {
  ...
  (dynamic_cast<db::DeviceClassMOS3Transistor *>(
       nl2->begin_device_classes().operator->()))
      ->join_split_gates(nl2->begin_top_down().operator->());
  ...
  mp2->connect_terminal(db::DeviceClassMOS3Transistor::terminal_id_G,
                        g1); //  NOTE: not g2!
...
TEST(52_SplitGatesMOS4) {
  ...
  EXPECT_EQ(
      ...
      "  device '' m21 (S=sd1,G=g2,D=n2,B=vss) "
      "(L=10,W=1,AS=0,AD=0,PS=0,PD=0);\n"
      "  device '' m12 (S=n1,G=g1,D=sd2,B=vss) (L=6,W=1,AS=0,AD=0,PS=0,PD=0);\n"
      "  device '' m22 (S=sd2,G=g2,D=n2,B=vss) "
      "(L=10,W=1,AS=0,AD=0,PS=0,PD=0);\n"
      "end;\n");
  ...
  EXPECT_EQ(
      ...
      "  device '' m22 (S=sd1,G=g2,D=n2,B=vss) "
      "(L=10,W=1,AS=0,AD=0,PS=0,PD=0);\n"
      "end;\n");
  ...
  EXPECT_EQ(
      ...
      "  device '' m21 (S=sd2,G=g2,D=n2,B=vss) "
      "(L=10,W=1,AS=0,AD=0,PS=0,PD=0);\n"
      "  device '' m12 (S=n1,G=g1,D=sd2,B=vss) (L=6,W=1,AS=0,AD=0,PS=0,PD=0);\n"
      "  device '' m22 (S=sd2,G=g2,D=n2,B=vss) "
      "(L=10,W=1,AS=0,AD=0,PS=0,PD=0);\n"
