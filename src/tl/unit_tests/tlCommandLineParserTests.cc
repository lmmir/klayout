...
TEST(1) {
  ...
  cmd << tl::arg("a", &a, "") << tl::arg("?b", &b, "") << tl::arg("-c", &c, "")
      << tl::arg("!-cc", &c, "") << tl::arg("--plong|-p", &d, "")
      << tl::arg("--elong", &e, "") << tl::arg("-f|--flong=value", &f, "");
...
TEST(4) {
  ...
  tl::CommandLineOptions cmd;
  cmd << tl::arg("*-a|--along", &a, "") << tl::arg("*-b|--blong", &b, "");
