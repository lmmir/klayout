...
static std::string test_url1(
    "http://www.klayout.org/svn-public/klayout-resources/trunk/testdata");
...
TEST(1) {
  ...
  EXPECT_EQ(s, "[dir] dir1 "
               "http://www.klayout.org/svn-public/klayout-resources/trunk/"
               "testdata/dir1/\n"
               "[dir] dir2 "
               "http://www.klayout.org/svn-public/klayout-resources/trunk/"
               "testdata/dir2/\n"
...
TEST(3) {
  ...
  EXPECT_EQ(collection.url(), "http://www.klayout.org/svn-public/"
                              "klayout-resources/trunk/testdata/text");
  EXPECT_EQ(collection2string(collection), "");
}
