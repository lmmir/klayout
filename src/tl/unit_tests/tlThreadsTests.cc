...
//  NOTE: QThread can't handle this - the pthread-based implementation will
//  terminate the thread in this case
...
void inc(volatile int &value) { value += s_mythread2_increment; }
...
//  NOTE: ThreadStorage is broken on Qt 4.6.2 (invalid static_cast from type
//  'void*' to type 'int')
...
public:
  ...
  void run() { m_value = do_run(10000000); }
