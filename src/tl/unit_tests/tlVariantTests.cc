...
TEST(2) {
  ...
  tl::Variant v2;
  //  note: because the UT's are defined outside the main DLL, A is also defined
  //  outside the main DLL. To access the right instance, we need to use
  //  dll_local_instance
