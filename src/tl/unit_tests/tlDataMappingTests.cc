...
class MyDataMapping : public tl::DataMappingBase {
public:
...
TEST(1) {
  ...
  EXPECT_EQ(lt.dump(), "xmin=-1.1,dx=0.2:0.5;0.5;0.5;0.5;0.5;0.5;0.6;0.7;0.8;0."
                       "9;1;1.2;1.4;1.6;1.8;2;2;2;2;2;");
...
TEST(5) {
  tl::LinearCombinationDataMapping dm(-1.0, new MyDataMapping(), 1.0,
                                      new MyDataMapping(), 2.0);
  EXPECT_EQ(dm_to_string(dm), "0..2:0,0.5;1,2;2,5;");
}

TEST(6) {
  tl::LinearCombinationDataMapping dm(0.0, new MyDataMapping(), 1.0,
                                      new MyDataMapping(0.2), 1.0);
  EXPECT_EQ(dm_to_string(dm), "0..2:0,1;0.2,1.1;1,1.9;1.2,2.2;2,3.8;2.2,4;");
}

TEST(7) {
  tl::LinearCombinationDataMapping dm(0.0, new MyDataMapping(), 1.0,
                                      new MyDataMapping(0.2), 0.5);
  EXPECT_EQ(dm_to_string(dm),
            "0..2:0,0.75;0.2,0.85;1,1.45;1.2,1.7;2,2.9;2.2,3;");
}

TEST(8) {
  tl::LinearCombinationDataMapping dm(-1.0, new MyDataMapping(0.2), 1.0,
                                      new MyDataMapping(), 2.0);
