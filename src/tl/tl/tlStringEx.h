...
template <class Iter> std::string to_string(Iter b, Iter e) {
  std::string res;
  for (Iter i = b; i != e; ++i) {
    if (i != b) {
      res += ",";
...
template <class T> std::string to_string(const std::list<T> &v) {
  return to_string(v.begin(), v.end());
}
...
template <class T, class V> std::string to_string(const std::map<T, V> &v) {
  return to_string(v.begin(), v.end());
}

template <class T> std::string to_string(const std::unordered_set<T> &v) {
  return to_string(v.begin(), v.end());
}
