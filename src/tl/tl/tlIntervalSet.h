 ...
 */
template <class I> class is_compare_f {
public:
 ...
 */
template <class I> class is_compare_f2 {
public:
  bool operator()(const std::pair<I, I> &p, const I &i) const {
    return !(i < p.second);
  }
 ...
 */
template <class I> class interval_set {
public:
   ...
   */
  template <class Iter> void add(Iter from, Iter to) {
   ...
   */
  void add(I i1, I i2) {
    typename index_set::iterator lb = std::lower_bound(
        m_index_set.begin(), m_index_set.end(), i1, is_compare_f<I>());
  ...
  void erase(I i1, I i2) {
    typename index_set::iterator lb = std::lower_bound(
        m_index_set.begin(), m_index_set.end(), i1, is_compare_f2<I>());
    typename index_set::iterator lb0 = lb;
    ...
    if (n == 0) {
      ...
      index_pair v(*lb0); //  this copy is important since the insert may
  ...
  bool mapped(I i) const {
    typename index_set::const_iterator lb = std::lower_bound(
        m_index_set.begin(), m_index_set.end(), i, is_compare_f2<I>());
