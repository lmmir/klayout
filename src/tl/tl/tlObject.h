...
public:
   ...
   *  The shared flag indicates whether the pointer will behave shared or weak
   * pointer like.
   */
   ...
   *  This method will remove this object from all events. After calling this
   * method, the object will no longer receive events.
   */
  void detach_from_all_events();
...
protected:
  /**
   *  @brief This method is called when the pointer is reset because the object
   * is deleted This method provides a way to detect whether the object gets
   * detached or destroyed. It is used by the containers to automatically remove
...
class TL_PUBLIC_TEMPLATE weak_or_shared_ptr : public WeakOrSharedPtr {
public:
  /**
   *  @brief Default constructor
   */
  weak_or_shared_ptr() : WeakOrSharedPtr() {}
   ...
   *  @brief Assignment
   */
  weak_or_shared_ptr<T, Shared> &
  operator=(const weak_or_shared_ptr<T, Shared> &o) {
   ...
   */
  T *get() { return dynamic_cast<T *>(WeakOrSharedPtr::get()); }
 ...
 */
template <class T>
class TL_PUBLIC_TEMPLATE weak_ptr : public weak_or_shared_ptr<T, false> {
public:
  /**
   *  @brief Default constructor
   */
  weak_ptr() : weak_or_shared_ptr<T, false>() {
    //  .. nothing yet ..
  }
 ...
 */
template <class T>
class TL_PUBLIC_TEMPLATE shared_ptr : public weak_or_shared_ptr<T, true> {
public:
  /**
   *  @brief Default constructor
   */
  shared_ptr() : weak_or_shared_ptr<T, true>() {
    //  .. nothing yet ..
  }
   ...
   *  @brief Constructor from a raw pointer
   */
  shared_ptr(T *t) : weak_or_shared_ptr<T, true>(t) {
    //  .. nothing yet ..
  }
};
