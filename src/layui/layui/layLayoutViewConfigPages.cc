...
void LayoutViewConfigPage::commit(lay::Dispatcher *root) {
  lay::ColorConverter cc;
  root->config_set(cfg_background_color, mp_ui->bkgnd_color_pb->get_color(),
                   cc);
}
...
void LayoutViewConfigPage1::commit(lay::Dispatcher *root) {
  ...
  root->config_set(cfg_abstract_mode_enabled,
                   mp_ui->abstract_mode_grp->isChecked());
  ...
  if (w <= 0.0) {
    throw tl::Exception(tl::to_string(QObject::tr(
        "Invalid abstract mode border with - must be larger than 0")));
  }
}
...
void LayoutViewConfigPage2a::setup(lay::Dispatcher *root) {
  ...
  if (mp_ui->cell_font_cb->count() == 0) {
    ...
    for (std::vector<std::string>::const_iterator f = ff.begin(); f != ff.end();
         ++f) {
  ...
  mp_ui->cell_min_size_for_label_edit->setText(
      tl::to_qstring(tl::to_string(n)));
...
void LayoutViewConfigPage2a::commit(lay::Dispatcher *root) {
  root->config_set(cfg_cell_box_text_transform,
                   mp_ui->cell_xform_text_cbx->isChecked());
  root->config_set(cfg_cell_box_text_font, mp_ui->cell_font_cb->currentIndex());
  root->config_set(cfg_cell_box_color, mp_ui->cell_box_color_pb->get_color(),
                   ColorConverter());
  root->config_set(cfg_cell_box_visible, mp_ui->cell_group->isChecked());

  root->config_set(cfg_guiding_shape_visible,
                   mp_ui->pcell_gs_group->isChecked());
  root->config_set(cfg_guiding_shape_line_width, mp_ui->pcell_gs_lw->value());
  root->config_set(cfg_guiding_shape_color,
                   mp_ui->pcell_gs_color_pb->get_color(), ColorConverter());
  root->config_set(cfg_guiding_shape_vertex_size, mp_ui->pcell_gs_vs->value());

  try {
    int n;
    tl::from_string_ext(
        tl::to_string(mp_ui->cell_min_size_for_label_edit->text()), n);
...
void LayoutViewConfigPage2b::commit(lay::Dispatcher *root) {
  root->config_set(cfg_text_color, mp_ui->text_color_pb->get_color(),
                   ColorConverter());
  root->config_set(cfg_apply_text_trans,
                   mp_ui->text_apply_trans_cbx->isChecked());
  root->config_set(cfg_text_visible, mp_ui->text_group->isChecked());
  root->config_set(cfg_show_properties,
                   mp_ui->show_properties_cbx->isChecked());
...
void LayoutViewConfigPage2c::commit(lay::Dispatcher *root) {
  ...
  root->config_set(cfg_sel_transient_mode,
                   mp_ui->transient_mode_cb->isChecked());
  root->config_set(cfg_sel_inside_pcells_mode,
                   mp_ui->sel_inside_pcells_cb->isChecked());
  root->config_set(cfg_text_point_mode, mp_ui->text_point_mode_cb->isChecked());
  root->config_set(cfg_search_range,
                   (unsigned int)mp_ui->search_range_spinbx->value());
  root->config_set(cfg_search_range_box,
                   (unsigned int)mp_ui->search_range_box_spinbx->value());
}
...
void LayoutViewConfigPage2d::commit(lay::Dispatcher *root) {
  ...
  root->config_set(cfg_tracking_cursor_enabled,
                   mp_ui->tracking_cb->isChecked());
}
...
void LayoutViewConfigPage3a::commit(lay::Dispatcher *root) {
  ...
  root->config_set(cfg_full_hier_new_cell,
                   mp_ui->full_hier_new_cell_cbx->isChecked());
  root->config_set(cfg_clear_ruler_new_cell,
                   mp_ui->clear_ruler_new_cell_cbx->isChecked());
}
...
void LayoutViewConfigPage3b::commit(lay::Dispatcher *root) {
  root->config_set(cfg_mouse_wheel_mode,
                   mp_ui->alt_mouse_wheel_mode_cbx->isChecked() ? 1 : 0);
  ...
  if (pd <= 0.0) {
    throw tl::Exception(tl::to_string(
        QObject::tr("Invalid pan distance: must be larger than 0.0")));
  }
...
void LayoutViewConfigPage3f::commit(lay::Dispatcher *root) {
  ...
  root->config_set(cfg_drop_small_cells,
                   mp_ui->drop_small_cells_cbx->isChecked());
  root->config_set(cfg_drop_small_cells_cond,
                   mp_ui->drop_small_cells_cond_cb->currentIndex());

  try {
    unsigned int s;
    tl::from_string_ext(tl::to_string(mp_ui->drop_small_cells_value_le->text()),
                        s);
    root->config_set(cfg_drop_small_cells_value, s);
  } catch (...) {
  }

  root->config_set(cfg_array_border_instances,
                   mp_ui->array_border_insts_cbx->isChecked());

  root->config_set(cfg_text_lazy_rendering,
                   mp_ui->text_lazy_rendering_cbx->isChecked());
...
static QToolButton *(Ui::LayoutViewConfigPage4::*cfg4_buttons[]) = {
    &Ui::LayoutViewConfigPage4::cb_1,  &Ui::LayoutViewConfigPage4::cb_2,
    &Ui::LayoutViewConfigPage4::cb_3,  &Ui::LayoutViewConfigPage4::cb_4,
    &Ui::LayoutViewConfigPage4::cb_5,  &Ui::LayoutViewConfigPage4::cb_6,
    &Ui::LayoutViewConfigPage4::cb_7,  &Ui::LayoutViewConfigPage4::cb_8,
    &Ui::LayoutViewConfigPage4::cb_9,  &Ui::LayoutViewConfigPage4::cb_10,
    &Ui::LayoutViewConfigPage4::cb_11, &Ui::LayoutViewConfigPage4::cb_12,
    &Ui::LayoutViewConfigPage4::cb_13, &Ui::LayoutViewConfigPage4::cb_14,
    &Ui::LayoutViewConfigPage4::cb_15, &Ui::LayoutViewConfigPage4::cb_16,
    &Ui::LayoutViewConfigPage4::cb_17, &Ui::LayoutViewConfigPage4::cb_18,
    &Ui::LayoutViewConfigPage4::cb_19, &Ui::LayoutViewConfigPage4::cb_20,
    &Ui::LayoutViewConfigPage4::cb_21, &Ui::LayoutViewConfigPage4::cb_22,
    &Ui::LayoutViewConfigPage4::cb_23, &Ui::LayoutViewConfigPage4::cb_24,
    &Ui::LayoutViewConfigPage4::cb_25, &Ui::LayoutViewConfigPage4::cb_26,
    &Ui::LayoutViewConfigPage4::cb_27, &Ui::LayoutViewConfigPage4::cb_28,
    &Ui::LayoutViewConfigPage4::cb_29, &Ui::LayoutViewConfigPage4::cb_30,
    &Ui::LayoutViewConfigPage4::cb_31, &Ui::LayoutViewConfigPage4::cb_32,
    &Ui::LayoutViewConfigPage4::cb_33, &Ui::LayoutViewConfigPage4::cb_34,
    &Ui::LayoutViewConfigPage4::cb_35, &Ui::LayoutViewConfigPage4::cb_36,
    &Ui::LayoutViewConfigPage4::cb_37, &Ui::LayoutViewConfigPage4::cb_38,
    &Ui::LayoutViewConfigPage4::cb_39, &Ui::LayoutViewConfigPage4::cb_40,
...
LayoutViewConfigPage4::LayoutViewConfigPage4(QWidget *parent)
  ...
  for (unsigned int i = 0; i < sizeof(cfg4_buttons) / sizeof(cfg4_buttons[0]);
       ++i) {
    connect(mp_ui->*(cfg4_buttons[i]), SIGNAL(clicked()), this,
            SLOT(color_button_clicked()));
  }
  ...
  connect(mp_ui->reset_pb, SIGNAL(clicked()), this,
          SLOT(reset_button_clicked()));
  connect(mp_ui->edit_order_cbx, SIGNAL(stateChanged(int)), this,
          SLOT(edit_order_changed(int)));
}
...
void LayoutViewConfigPage4::reset_button_clicked() {
  ...
  m_manager.queue(this,
                  new PaletteOp(m_palette, mp_ui->edit_order_cbx->isChecked(),
                                true /*before*/));
...
void LayoutViewConfigPage4::edit_order_changed(int s) {
  ...
  if (s) {
    ...
    m_manager.transaction(
        tl::to_string(QObject::tr("Stop changing assignment order")));
  ...
  if (mp_ui->edit_order_cbx->isChecked()) {
    ...
    for (unsigned int i = 0; i < sizeof(cfg4_buttons) / sizeof(cfg4_buttons[0]);
      ...
      if (sender() == mp_ui->*(cfg4_buttons[i])) {
        ...
        bool found = false;
        for (unsigned int j = 0; j < m_palette.luminous_colors() && !found;
             ++j) {
        ...
        if (!found) {
          m_manager.transaction(
              tl::to_string(QObject::tr("Set assignment order")));
          m_manager.queue(this,
                          new PaletteOp(m_palette, true, true /*before*/));
          m_palette.set_luminous_color_index(m_palette.luminous_colors(), i);
          m_manager.queue(this,
                          new PaletteOp(m_palette, true, false /*after*/));
          m_manager.commit();
          update();
        }
        break;
    ...
    for (unsigned int i = 0; i < sizeof(cfg4_buttons) / sizeof(cfg4_buttons[0]);
      ...
      if (sender() == mp_ui->*(cfg4_buttons[i])) {
        ...
        if (c.isValid()) {
          ...
          m_manager.queue(this,
                          new PaletteOp(m_palette, false, true /*before*/));
          m_palette.set_color(i, c.rgb());
          m_manager.queue(this,
                          new PaletteOp(m_palette, false, false /*after*/));
          m_manager.commit();
          update();
        }
...
void LayoutViewConfigPage4::update() {
  for (unsigned int i = 0; i < sizeof(cfg4_buttons) / sizeof(cfg4_buttons[0]);
    ...
    QColor text_color =
        color.green() > 128 ? QColor(0, 0, 0) : QColor(255, 255, 255);
    ...
    painter.fillRect(
        r, QBrush(palette().color(QPalette::Active, QPalette::ButtonText)));
    r = QRectF(1.0, 1.0, w - 2.0, h - 2.0);
    painter.fillRect(r, QBrush(color));
    painter.setFont(font());
    painter.setPen(QPen(text_color));
    painter.drawText(
        r, Qt::AlignHCenter | Qt::AlignVCenter | Qt::TextSingleLine, text);
...
void LayoutViewConfigPage5::commit(lay::Dispatcher *root) {
  if (mp_ui->lyp_file_gbx->isChecked()) {
    root->config_set(cfg_default_lyp_file,
                     tl::to_string(mp_ui->lyp_file_le->text()));
  } else {
    root->config_set(cfg_default_lyp_file, std::string());
  }
  root->config_set(cfg_default_add_other_layers,
                   mp_ui->add_other_layers_cb->isChecked());
  root->config_set(cfg_layers_always_show_source,
                   mp_ui->source_display_cb->isChecked());
  root->config_set(cfg_layers_always_show_ld,
                   mp_ui->ld_display_cb->isChecked());
  root->config_set(cfg_layers_always_show_layout_index,
                   mp_ui->ly_index_cb->isChecked());
}

void LayoutViewConfigPage5::browse_clicked() {
  std::string fn = tl::to_string(mp_ui->lyp_file_le->text());
  lay::FileDialog file_dialog(
      this, tl::to_string(QObject::tr("Select Layer Properties File")),
      tl::to_string(
...
class StipplePaletteOp : public db::Op {
public:
...
static QToolButton *(Ui::LayoutViewConfigPage6::*cfg6_buttons[]) = {
    &Ui::LayoutViewConfigPage6::cb_1,  &Ui::LayoutViewConfigPage6::cb_2,
    &Ui::LayoutViewConfigPage6::cb_3,  &Ui::LayoutViewConfigPage6::cb_4,
    &Ui::LayoutViewConfigPage6::cb_5,  &Ui::LayoutViewConfigPage6::cb_6,
    &Ui::LayoutViewConfigPage6::cb_7,  &Ui::LayoutViewConfigPage6::cb_8,
    &Ui::LayoutViewConfigPage6::cb_9,  &Ui::LayoutViewConfigPage6::cb_10,
    &Ui::LayoutViewConfigPage6::cb_11, &Ui::LayoutViewConfigPage6::cb_12,
    &Ui::LayoutViewConfigPage6::cb_13, &Ui::LayoutViewConfigPage6::cb_14,
    &Ui::LayoutViewConfigPage6::cb_15, &Ui::LayoutViewConfigPage6::cb_16,
};
...
LayoutViewConfigPage6::LayoutViewConfigPage6(QWidget *parent)
  ...
  for (unsigned int i = 0; i < sizeof(cfg6_buttons) / sizeof(cfg6_buttons[0]);
       ++i) {
    connect(mp_ui->*(cfg6_buttons[i]), SIGNAL(clicked()), this,
            SLOT(stipple_button_clicked()));
  }
...
void LayoutViewConfigPage6::commit(lay::Dispatcher *root) {
  ...
  if (m_palette.standard_stipples() == 0) {
    throw tl::Exception(tl::to_string(
        QObject::tr("No stipples selected for automatic assignment - use 'Set "
                    "assignment order' to do so")));
  }
...
void LayoutViewConfigPage6::reset_button_clicked() {
  m_manager.transaction(tl::to_string(QObject::tr("Reset palette")));
  m_manager.queue(this, new StipplePaletteOp(m_palette,
                                             mp_ui->edit_order_cbx->isChecked(),
                                             true /*before*/));
  m_palette = lay::StipplePalette::default_palette();
  m_manager.queue(this,
                  new StipplePaletteOp(m_palette, false, false /*after*/));
  m_manager.commit();
  set_edit_order(false);
  update();
}
...
void LayoutViewConfigPage6::edit_order_changed(int s) {
  ...
  if (s) {
    m_manager.transaction(tl::to_string(QObject::tr("Clear assignment order")));
    m_manager.queue(this,
                    new StipplePaletteOp(m_palette, false, true /*before*/));
    m_palette.clear_standard_stipples();
    m_manager.queue(this,
                    new StipplePaletteOp(m_palette, true, false /*after*/));
    m_manager.commit();
    update();
  } else {
    m_manager.transaction(
        tl::to_string(QObject::tr("Stop changing assignment order")));
    m_manager.queue(this,
                    new StipplePaletteOp(m_palette, true, true /*before*/));
    m_manager.queue(this,
                    new StipplePaletteOp(m_palette, false, false /*after*/));
    m_manager.commit();
  }
  ...
  if (mp_ui->edit_order_cbx->isChecked()) {
    ...
    for (unsigned int i = 0; i < sizeof(cfg6_buttons) / sizeof(cfg6_buttons[0]);
      ...
      if (sender() == mp_ui->*(cfg6_buttons[i])) {
        ...
        bool found = false;
        for (unsigned int j = 0; j < m_palette.standard_stipples() && !found;
             ++j) {
        ...
        if (!found) {
          m_manager.transaction(
              tl::to_string(QObject::tr("Set assignment order")));
          m_manager.queue(
              this, new StipplePaletteOp(m_palette, true, true /*before*/));
          m_palette.set_standard_stipple_index(m_palette.standard_stipples(),
                                               i);
          m_manager.queue(
              this, new StipplePaletteOp(m_palette, true, false /*after*/));
          m_manager.commit();
          update();
        }
        break;
      ...
      if (sender() == mp_ui->*(cfg6_buttons[i])) {
        ...
        if (m_palette.stipples() > i) {
          ...
          if (stipples_form.exec() && stipples_form.selected() >= 0) {
            ...
            m_manager.queue(
                this, new StipplePaletteOp(m_palette, false, true /*before*/));
            m_palette.set_stipple(i, s);
            m_manager.queue(
                this, new StipplePaletteOp(m_palette, false, false /*after*/));
            m_manager.commit();
            update();
          }
        }
...
void LayoutViewConfigPage6::update() {
  for (unsigned int i = 0; i < sizeof(cfg6_buttons) / sizeof(cfg6_buttons[0]);
    ...
    const lay::DitherPatternInfo &info =
        m_pattern.pattern((unsigned int)s).scaled(dpr);
    ...
    painter.setPen(
        QPen(palette().color(QPalette::Active, QPalette::Text), 1.0));
...
class LineStylePaletteOp : public db::Op {
public:
...
LayoutViewConfigPage6a::LayoutViewConfigPage6a(QWidget *parent)
  ...
  for (unsigned int i = 0; i < sizeof(cfg6a_buttons) / sizeof(cfg6a_buttons[0]);
       ++i) {
    connect(mp_ui->*(cfg6a_buttons[i]), SIGNAL(clicked()), this,
            SLOT(line_style_button_clicked()));
  }
    ...
    if (sender() == mp_ui->*(cfg6a_buttons[i])) {
      ...
      if (m_palette.styles() > i) {
        ...
        if (styles_form.exec() && styles_form.selected() >= 0) {
          ...
          m_manager.queue(this,
                          new LineStylePaletteOp(m_palette, true /*before*/));
          m_palette.set_style(i, s);
          m_manager.queue(this,
                          new LineStylePaletteOp(m_palette, false /*after*/));
          m_manager.commit();
          update();
        }
      }
...
void LayoutViewConfigPage6a::update() {
  for (unsigned int i = 0; i < sizeof(cfg6a_buttons) / sizeof(cfg6a_buttons[0]);
    ...
    //  NOTE: we intentionally don't apply devicePixelRatio here as this way,
    //  the image looks more like the style applied on the layout canvas.
...
LayoutViewConfigPage7::LayoutViewConfigPage7(QWidget *parent)
  ...
  for (int i = 0; i < lay::FixedFont::font_sizes(); ++i) {
    mp_ui->default_font_size->addItem(
        QString::fromUtf8(lay::FixedFont::font_size_name(i)));
  }
}
...
void LayoutViewConfigPage7::commit(lay::Dispatcher *root) {
  root->config_set(cfg_bitmap_oversampling,
                   mp_ui->oversampling->currentIndex() + 1);
  root->config_set(cfg_highres_mode, mp_ui->highres_mode->isChecked());
  root->config_set(cfg_default_font_size,
                   mp_ui->default_font_size->currentIndex());
  root->config_set(
      cfg_global_trans,
      db::DCplxTrans(db::DFTrans(mp_ui->global_trans->currentIndex()))
          .to_string());
...
class LayoutViewConfigDeclaration : public lay::PluginDeclaration {
public:
  virtual std::vector<std::pair<std::string, ConfigPage *>>
  config_pages(QWidget *parent) const {
    std::vector<std::pair<std::string, ConfigPage *>> pages;

    pages.push_back(
        std::make_pair(tl::to_string(QObject::tr("Display|General")),
                       new LayoutViewConfigPage7(parent)));
    pages.push_back(std::make_pair(tl::to_string(QObject::tr("Display|Cells")),
                                   new LayoutViewConfigPage2a(parent)));
    pages.push_back(std::make_pair(tl::to_string(QObject::tr("Display|Texts")),
                                   new LayoutViewConfigPage2b(parent)));
    pages.push_back(
        std::make_pair(tl::to_string(QObject::tr("Display|Color Palette")),
                       new LayoutViewConfigPage4(parent)));
    pages.push_back(
        std::make_pair(tl::to_string(QObject::tr("Display|Stipple Palette")),
                       new LayoutViewConfigPage6(parent)));
    pages.push_back(
        std::make_pair(tl::to_string(QObject::tr("Display|Line Style Palette")),
                       new LayoutViewConfigPage6a(parent)));
    pages.push_back(
        std::make_pair(tl::to_string(QObject::tr("Display|Background")),
                       new LayoutViewConfigPage(parent)));
    pages.push_back(
        std::make_pair(tl::to_string(QObject::tr("Display|Context")),
                       new LayoutViewConfigPage1(parent)));
    pages.push_back(
        std::make_pair(tl::to_string(QObject::tr("Display|Optimization")),
                       new LayoutViewConfigPage3f(parent)));

    pages.push_back(
        std::make_pair(tl::to_string(QObject::tr("Application|Selection")),
                       new LayoutViewConfigPage2c(parent)));
    pages.push_back(
        std::make_pair(tl::to_string(QObject::tr("Application|Tracking")),
                       new LayoutViewConfigPage2d(parent)));
    pages.push_back(std::make_pair(
        tl::to_string(QObject::tr("Application|Layer Properties")),
        new LayoutViewConfigPage5(parent)));
    pages.push_back(
        std::make_pair(tl::to_string(QObject::tr("Application|Units")),
                       new LayoutViewConfigPage3c(parent)));

    pages.push_back(
        std::make_pair(tl::to_string(QObject::tr("Navigation|New Cell")),
                       new LayoutViewConfigPage3a(parent)));
    pages.push_back(
        std::make_pair(tl::to_string(QObject::tr("Navigation|Zoom And Pan")),
                       new LayoutViewConfigPage3b(parent)));
...
static tl::RegisteredClass<lay::PluginDeclaration>
    config_decl(new LayoutViewConfigDeclaration(), 2000, "LayoutViewConfig");
