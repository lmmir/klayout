 ...
 */
class LibraryTreeWidget : public QTreeView {
  Q_OBJECT

public:
  LibraryTreeWidget(QWidget *parent, const char *name,
 ...
 */
class LAYUI_PUBLIC LibrariesView : public QFrame, public tl::Object {
  Q_OBJECT
...
public:
   ...
   */
  LibrariesView(LayoutViewBase *view, QWidget *parent = 0,
                const char *name = "libraries_view");
