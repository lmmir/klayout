 ...
 */
class LAYUI_PUBLIC DitherPatternSelectionButton : public QPushButton {
  Q_OBJECT
 ...
 */
class LAYUI_PUBLIC LibrarySelectionComboBox : public QComboBox {
  Q_OBJECT
...
public:
   ...
   *
   *  If a technology filter is set, only the libraries associated with the
   * given technology are shown. If enable is false, the technology name is
   * ignored and all libraries are shown.
   */
 ...
 */
class LAYUI_PUBLIC LayerSelectionComboBox : public QComboBox,
                                            public tl::Object {
  Q_OBJECT
...
public:
   ...
   *
   *  This method can be used instead of set_layout. If this method is used,
   * more functionality is available, i.e. the ability to create new layers. If
   * all_layers is set to true, layers are shown which are in the layer list,
   * but not created as layers yet.
   */
  void set_view(lay::LayoutViewBase *view, int cv_index,
 ...
 */
class LAYUI_PUBLIC CellViewSelectionComboBox : public QComboBox {
  Q_OBJECT
 ...
 */
class LAYUI_PUBLIC SimpleColorButton : public QPushButton {
  Q_OBJECT
 ...
 */
class LAYUI_PUBLIC MarginWidget : public QFrame {
  Q_OBJECT
 ...
 *  capability to switch to "auto" color mode.
 */
class LAYUI_PUBLIC ColorButton : public QPushButton {
  Q_OBJECT
...
public:
  ...
  QColor get_color() const;
  static void build_color_menu(QMenu *menu, QObject *receiver,
 ...
 */
class LAYUI_PUBLIC DecoratedLineEdit : public QLineEdit {
  Q_OBJECT
...
public:
   ...
   *  The clear button will be on the right side of the edit box. Pressing the
   * button will clear the text and emit a "textEdited" and "textChanged" event.
   */
   ...
   */
  bool is_clear_button_enabled() const { return m_clear_button_enabled; }

  /**
   *  @brief Sets a value indicating whether the options button is enabled
   *  The options button appears to the left. Pressing the button will either
   * show the options menu as set by "setOptionsMenu" or emit the
   * "optionsButtonClicked" signal.
   */
   ...
   */
  bool is_option_button_enabled() const { return m_options_button_enabled; }

  /**
   *  @brief Sets the options menu to be shown when the options button is
   * clicked. The DecoratedLineEdit object will not take ownership over the
   * menu.
   */
  ...
  /**
   *  @brief Sets a value indicating whether the widgets accepts ESC keys and
   * sends an esc_pressed signal for this
   */
  void set_escape_signal_enabled(bool f);

  /**
   *  @brief gets a value indicating whether the widgets accepts ESC keys and
   * sends an esc_pressed signal for this
   */
  bool escape_signal_enabled() const { return m_escape_signal_enabled; }

  /**
   *  @brief Sets a value indicating whether the widgets accepts Tab keys and
   * sends an tab_pressed or backtab_pressed signal for this
   */
  void set_tab_signal_enabled(bool f);

  /**
   *  @brief gets a value indicating whether the widgets accepts Tab keys and
   * sends an tab_pressed or backtab_pressed signal for this
   */
  bool tab_signal_enabled() const { return m_tab_signal_enabled; }
...
/**
 *  @brief An interactive list widget which offers slots to delete and move
 * items and interfaces to std::vector<std::string>
 */
class LAYUI_PUBLIC InteractiveListWidget : public QListWidget {
  Q_OBJECT
