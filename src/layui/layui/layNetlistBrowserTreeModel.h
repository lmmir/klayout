 ...
 */
class LAYUI_PUBLIC NetlistBrowserTreeModel : public QAbstractItemModel {
  Q_OBJECT
...
public:
  ...
  circuits_from_index(const QModelIndex &index) const;
  QModelIndex index_from_circuits(
...
private:
  ...
  cp_status_from_index(const QModelIndex &index, size_t &nprod, size_t &nlast,
                       size_t &nnlast) const;
  void build_circuits_to_index(
      size_t nprod,
      const std::pair<const db::Circuit *, const db::Circuit *> &circuits,
