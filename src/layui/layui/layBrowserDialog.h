 ...
 *  URL's with the special scheme "int" are retrieved from a BrowserSource
 * object. This will act as a kind of "server" for these URL's.
 */
class LAYUI_PUBLIC BrowserDialog : public QDialog, private Ui::BrowserDialog {
  Q_OBJECT
...
public:
   ...
   *
   *  Reimplement this callback to implement on-close functionality such as
   * cleanup.
   */
  virtual void closed() {
