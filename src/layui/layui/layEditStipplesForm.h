...
class EditStipplesForm : public QDialog, public db::Object {
  Q_OBJECT

public:
  EditStipplesForm(QWidget *parent, lay::LayoutViewBase *view,
                   const lay::DitherPattern &pattern);
  ~EditStipplesForm();

  //  ...

  const lay::DitherPattern &pattern() const { return m_pattern; }
