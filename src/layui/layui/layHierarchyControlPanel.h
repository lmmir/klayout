 ...
 */
class HCPCellTreeWidget : public QTreeView {
  Q_OBJECT
 ...
 */
class LAYUI_PUBLIC HierarchyControlPanel : public QFrame, public tl::Object {
  Q_OBJECT
...
public:
   ...
   */
  HierarchyControlPanel(lay::LayoutViewBase *view, QWidget *parent = 0,
                        const char *name = "control_panel");
   ...
   */
  int active() { return m_active_index; }
   ...
   *  the layouts.
   */
  void do_update_content() { do_update_content(-1); }
   ...
   */
  bool split_mode() const { return m_split_mode; }
...
private:
  ...
  //  locate the CellTreeItem in the tree corresponding to a partial path
  //  starting from p.
  CellTreeItem *find_child_item(cell_path_type::const_iterator start,
  ...
  void path_from_index(const QModelIndex &index, int cv_index,
