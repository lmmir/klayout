...
class LAYUI_PUBLIC SelectCellViewForm : public QDialog {
  Q_OBJECT

public:
  SelectCellViewForm(QWidget *parent, lay::LayoutViewBase *view,
                     const std::string &title, bool single = false);
  ...
  /**
   *  @brief This method must be called on all cv's before setup () to make the
   * cv's known
   */
