...
TEST(1) {
  ...
  v = e.parse("var a1=A.new; a1.a5(-15); var a2=a1.dup; a2.a5(107); a1.a1")
          .execute();
  EXPECT_EQ(v.to_string(), std::string("-15"));
  v = e.parse("var a1=A.new; a1.a5(-15); var a2=a1.dup; a2.a5(107); a2.a1")
          .execute();
  ...
  v = e.parse("var a=A.new; a.push_ev(Enum.a); a.push_ev(Enum.new); "
              "a.push_ev(Enum.b); a.ev")
          .execute();
  ...
  EXPECT_EQ(v.to_string(), std::string(""));
  v = e.parse("var a=A.new; a.set_efptr(Enums.new(Enum.c)); a.get_ef")
          .execute();
  EXPECT_EQ(v.to_string(), std::string("a|b|c"));
  v = e.parse("var a=A.new; a.set_efcptr(nil); a.get_ef").execute();
  EXPECT_EQ(v.to_string(), std::string(""));
  v = e.parse("var a=A.new; a.set_efcptr(Enums.new(Enum.b)); a.get_ef")
          .execute();
  EXPECT_EQ(v.to_string(), std::string("b"));
  ...
  EXPECT_EQ(v.to_string(), std::string("b"));
  v = e.parse("var a=A.new; a.set_efcref(Enums.new(Enum.a)); a.get_ef")
          .execute();
  EXPECT_EQ(v.to_string(), std::string("a"));
  v = e.parse("var a=A.new; a.set_efref(Enums.new(Enum.c)); a.get_ef")
          .execute();
  EXPECT_EQ(v.to_string(), std::string("a|b|c"));
  v = e.parse("var a=A.new; a.set_efref(Enums.new(Enum.c)); a.get_efptr")
          .execute();
  EXPECT_EQ(v.to_string(), std::string("a|b|c"));
  v = e.parse("var a=A.new; a.set_efref(Enums.new(Enum.c)); a.get_efref")
          .execute();
  EXPECT_EQ(v.to_string(), std::string("a|b|c"));
  v = e.parse("var a=A.new; a.set_efref(Enums.new(Enum.c)); a.get_efcptr")
          .execute();
  EXPECT_EQ(v.to_string(), std::string("a|b|c"));
  v = e.parse("var a=A.new; a.set_efref(Enums.new(Enum.c)); a.get_efcref")
          .execute();
  EXPECT_EQ(v.to_string(), std::string("a|b|c"));
...
TEST(2) {
  ...
  EXPECT_EQ(v.to_string(), std::string("5"));
  v = e.parse("var b=B.new; var a1=A.new(-17); var a2=A.new(42); b.av = [ a1, "
              "a2 ]; to_s(b.av)")
          .execute();
  EXPECT_EQ(v.to_string(), std::string("A: -17,A: 42"));
  v = e.parse("var b=B.new; var a1=A.new(-17); var a2=A.new(1); b.av_cref = [ "
              "a1, a2 ]; to_s(b.av_cref)")
          .execute();
  EXPECT_EQ(v.to_string(), std::string("A: -17,A: 1"));
  v = e.parse("var b=B.new; b.av = [ A.new(-13) ]; b.av_cptr = nil; to_s(b.av)")
          .execute();
  EXPECT_EQ(v.to_string(), std::string("A: -13"));
  v = e.parse("var b=B.new; b.av = [ A.new(13) ]; b.av_ptr = nil; to_s(b.av)")
          .execute();
  EXPECT_EQ(v.to_string(), std::string("A: 13"));
  v = e.parse(
           "var b=B.new; var a1=A.new(17); b.av_ref = [ a1 ]; to_s(b.av_ref)")
          .execute();
  ...
  */
  ...
  v = e.parse("var a=A.new; a.a5(22); var b=B.new; a.a5(-6); b.aptr_to_n(a)")
          .execute();
  EXPECT_EQ(v.to_string(), std::string("-6"));
  v = e.parse("var a=A.new; a.a5(22); var b=B.new; a.a5(-6); b.aref_to_s(a)")
          .execute();
...
TEST(3) {
  ...
  //  Currently there is no way to override virtual methods in expressions so we
...
TEST(6) {
  ...
  v = e.parse("var o=Box.new(1, 2, 11, 12); var p=Box.new(5, 6, 15, 16); "
              "(o*p).to_s")
          .execute();
  ...
  v = e.parse("var o=Box.new(1, 2, 11, 12); var p=Box.new(5, 6, 15, 16); o<p")
          .execute();
  EXPECT_EQ(v.to_string(), std::string("true"));
  v = e.parse("var o=Box.new(1, 2, 11, 12); var p=Box.new(5, 6, 15, 16); p<o")
          .execute();
  EXPECT_EQ(v.to_string(), std::string("false"));
  v = e.parse("var o=Box.new(1, 2, 11, 12); var p=Box.new(5, 6, 15, 16); o<o")
          .execute();
  EXPECT_EQ(v.to_string(), std::string("false"));
  v = e.parse("var o=Box.new(1, 2, 11, 12); var p=Box.new(5, 6, 15, 16); p==o")
          .execute();
...
TEST(7) {
  ...
  EXPECT_EQ(v.to_string(), std::string("nil"));
  v = e.parse("var o=B.new(); o.insert_map1(1, 'hello'); to_s(o.map1)")
          .execute();
  EXPECT_EQ(v.to_string(), std::string("1=>hello"));
  v = e.parse("var o=B.new(); o.insert_map1(2, 'hello'); to_s(o.map1_cref)")
          .execute();
  EXPECT_EQ(v.to_string(), std::string("2=>hello"));
  v = e.parse("var o=B.new(); o.insert_map1(3, 'hello'); to_s(o.map1_cptr)")
          .execute();
  EXPECT_EQ(v.to_string(), std::string("3=>hello"));
  v = e.parse("var o=B.new(); o.insert_map1(2, 'hello'); to_s(o.map1_ref)")
          .execute();
  EXPECT_EQ(v.to_string(), std::string("2=>hello"));
  v = e.parse("var o=B.new(); o.insert_map1(3, 'hello'); to_s(o.map1_ptr)")
          .execute();
  EXPECT_EQ(v.to_string(), std::string("3=>hello"));
  v = e.parse("var o=B.new(); o.map1 = { 42 => 1, -17 => true }; to_s(o.map1)")
          .execute();
  EXPECT_EQ(v.to_string(), std::string("-17=>true,42=>1"));
  v = e.parse(
           "var o=B.new(); o.set_map1({ 42 => 1, -17 => true }); to_s(o.map1)")
          .execute();
  EXPECT_EQ(v.to_string(), std::string("-17=>true,42=>1"));
  v = e.parse("var o=B.new(); o.set_map1_cref({ 42 => 1, -17 => true }); "
              "to_s(o.map1)")
          .execute();
  EXPECT_EQ(v.to_string(), std::string("-17=>true,42=>1"));
  v = e.parse("var o=B.new(); o.set_map1_cptr({ 42 => 1, -17 => true }); "
              "to_s(o.map1)")
          .execute();
  EXPECT_EQ(v.to_string(), std::string("-17=>true,42=>1"));
  v = e.parse("var o=B.new(); o.set_map1_cptr(nil); to_s(o.map1)").execute();
  EXPECT_EQ(v.to_string(), std::string(""));
  v = e.parse("var o=B.new(); o.set_map1_ref({ 42 => 1, -17 => true }); "
              "to_s(o.map1)")
          .execute();
  EXPECT_EQ(v.to_string(), std::string("-17=>true,42=>1"));
  v = e.parse("var o=B.new(); o.set_map1_ptr({ 42 => 1, -17 => true }); "
              "to_s(o.map1)")
          .execute();
  EXPECT_EQ(v.to_string(), std::string("-17=>true,42=>1"));
  ...
  EXPECT_EQ(v.to_string(), std::string(""));
  v = e.parse(
           "var o=B.new(); o.map2 = { 'xy' => 1, -17 => true }; to_s(o.map2)")
          .execute();
...
TEST(8) {
  ...
  v = e.parse("var l = Layout.new(); l.create_cell('TOP'); l.top_cell.name")
          .execute();
  ...
  v = e.parse("var l = Layout.new(); l.create_cell('TOP'); var c = l.top_cell; "
              "c.name = 'X'; l.top_cell.name")
          .execute();
  EXPECT_EQ(v.to_string(), std::string("X"));
  v = e.parse("var l = Layout.new(); l.create_cell('TOP'); var c = l.top_cell; "
              "l._destroy; c._destroyed")
          .execute();
  EXPECT_EQ(v.to_string(), std::string("true"));
}
...
class CollectFunction : public tl::EvalFunction {
public:
...
TEST(9) {
  ...
  tl::Variant v;
  v = e.parse("var x=Region.new(Box.new(0,0,100,100)); put(x.area); "
              "x=x.sized(10); put(x.area); x=x.sized(10); put(x.area);")
          .execute();
