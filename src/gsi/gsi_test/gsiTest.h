 ...
 *  @brief A test enum
 */
enum Enum { Enum_a = 1, Enum_b = 2, Enum_c = 11 };
 ...
 */
struct A : public gsi::ObjectBase {
  /**
   *  @brief Constructor
   */
  A();
  ...
  static std::vector<int> qba_ref_to_ia(QByteArray &ba) {
    return qba_cref_to_ia(ba);
  }
  static std::vector<int> qba_cptr_to_ia(const QByteArray *ba) {
    return qba_cref_to_ia(*ba);
  }
  static std::vector<int> qba_ptr_to_ia(QByteArray *ba) {
    return qba_cref_to_ia(*ba);
  }
  static std::vector<int> qba_to_ia(QByteArray ba) {
    return qba_cref_to_ia(ba);
  }
  ...
  static std::vector<int> qbav_ref_to_ia(QByteArrayView &ba) {
    return qbav_cref_to_ia(ba);
  }
  static std::vector<int> qbav_cptr_to_ia(const QByteArrayView *ba) {
    return qbav_cref_to_ia(*ba);
  }
  static std::vector<int> qbav_ptr_to_ia(QByteArrayView *ba) {
    return qbav_cref_to_ia(*ba);
  }
  static std::vector<int> qbav_to_ia(QByteArrayView ba) {
    return qbav_cref_to_ia(ba);
  }
  ...
  static std::vector<int> qs_ref_to_ia(QString &qs) {
    return qs_cref_to_ia(qs);
  }
  static std::vector<int> qs_cptr_to_ia(const QString *qs) {
    return qs_cref_to_ia(*qs);
  }
  static std::vector<int> qs_ptr_to_ia(QString *qs) {
    return qs_cref_to_ia(*qs);
  }
  ...
  static std::vector<int> ql1s_ref_to_ia(QLatin1String &qs) {
    return ql1s_cref_to_ia(qs);
  }
  static std::vector<int> ql1s_cptr_to_ia(const QLatin1String *qs) {
    return ql1s_cref_to_ia(*qs);
  }
  static std::vector<int> ql1s_ptr_to_ia(QLatin1String *qs) {
    return ql1s_cref_to_ia(*qs);
  }
  static std::vector<int> ql1s_to_ia(QLatin1String qs) {
    return ql1s_cref_to_ia(qs);
  }
  ...
  static std::vector<int> qsv_ref_to_ia(QStringView &qs) {
    return qsv_cref_to_ia(qs);
  }
  static std::vector<int> qsv_cptr_to_ia(const QStringView *qs) {
    return qsv_cref_to_ia(*qs);
  }
  static std::vector<int> qsv_ptr_to_ia(QStringView *qs) {
    return qsv_cref_to_ia(*qs);
  }
  static std::vector<int> qsv_to_ia(QStringView qs) {
    return qsv_cref_to_ia(qs);
  }
  ...
  static const QByteArray &ia_cref_to_qba_cref(const std::vector<int> &ia) {
    return ia_cref_to_qba_ref(ia);
  }
  static const QByteArray *ia_cref_to_qba_cptr(const std::vector<int> &ia) {
    return &ia_cref_to_qba_ref(ia);
  }
  static QByteArray *ia_cref_to_qba_ptr(const std::vector<int> &ia) {
    return &ia_cref_to_qba_ref(ia);
  }
  ...
  /**
   *  @brief Byte sequences: tests return of QByteArrayView (uses a static
   * buffer)
   */
  ...
  static const QByteArrayView &
  ia_cref_to_qbav_cref(const std::vector<int> &ia) {
    return ia_cref_to_qbav_ref(ia);
  }
  static const QByteArrayView *
  ia_cref_to_qbav_cptr(const std::vector<int> &ia) {
    return &ia_cref_to_qbav_ref(ia);
  }
  static QByteArrayView *ia_cref_to_qbav_ptr(const std::vector<int> &ia) {
    return &ia_cref_to_qbav_ref(ia);
  }
  ...
  static const QString &ia_cref_to_qs_cref(const std::vector<int> &ia) {
    return ia_cref_to_qs_ref(ia);
  }
  static const QString *ia_cref_to_qs_cptr(const std::vector<int> &ia) {
    return &ia_cref_to_qs_ref(ia);
  }
  static QString *ia_cref_to_qs_ptr(const std::vector<int> &ia) {
    return &ia_cref_to_qs_ref(ia);
  }
  ...
  static const QLatin1String &ia_cref_to_ql1s_cref(const std::vector<int> &ia) {
    return ia_cref_to_ql1s_ref(ia);
  }
  static const QLatin1String *ia_cref_to_ql1s_cptr(const std::vector<int> &ia) {
    return &ia_cref_to_ql1s_ref(ia);
  }
  static QLatin1String *ia_cref_to_ql1s_ptr(const std::vector<int> &ia) {
    return &ia_cref_to_ql1s_ref(ia);
  }
  ...
  static const QStringView &ia_cref_to_qsv_cref(const std::vector<int> &ia) {
    return ia_cref_to_qsv_ref(ia);
  }
  static const QStringView *ia_cref_to_qsv_cptr(const std::vector<int> &ia) {
    return &ia_cref_to_qsv_ref(ia);
  }
  static QStringView *ia_cref_to_qsv_ptr(const std::vector<int> &ia) {
    return &ia_cref_to_qsv_ref(ia);
  }
  ...
  /**
   *  @brief Byte sequences: tests access to std::vector<char> (another byte
   * array)
   */
  static std::vector<int> ba_cref_to_ia(const std::vector<char> &ba);
  static std::vector<int> ba_ref_to_ia(std::vector<char> &ba) {
    return ba_cref_to_ia(ba);
  }
  static std::vector<int> ba_cptr_to_ia(const std::vector<char> *ba) {
    return ba_cref_to_ia(*ba);
  }
  static std::vector<int> ba_ptr_to_ia(std::vector<char> *ba) {
    return ba_cref_to_ia(*ba);
  }
  static std::vector<int> ba_to_ia(std::vector<char> ba) {
    return ba_cref_to_ia(ba);
  }
  ...
  ia_cref_to_ba_cref(const std::vector<int> &ia) {
    return ia_cref_to_ba_ref(ia);
  }
  static std::vector<char> *ia_cref_to_ba_ptr(const std::vector<int> &ia) {
    return &ia_cref_to_ba_ref(ia);
  }
  static const std::vector<char> *
  ia_cref_to_ba_cptr(const std::vector<int> &ia) {
    return &ia_cref_to_ba_ref(ia);
  }
  ...
  int a1() { return n; }
  int a1c() const { return n; }
  void a2() const {}
  int a3(const std::string &x) { return int(x.size()); }
  int a3_ba(const std::vector<char> &x) { return int(x.size()); }
#if defined(HAVE_QT)
  int a3_qstr(const QString &x) { return x.size(); }
  int a3_qstrref(const QStringRef &x) { return x.size(); }
  int a3_qba(const QByteArray &x) { return x.size(); }
#endif
  ...
  void a5(int nn) { n = nn; }
  std::vector<double>::iterator a6b() { return m_d.begin(); }
  std::vector<double>::iterator a6e() { return m_d.end(); }
  double *a7b() { return &*m_d.begin(); }
  double *a7e() { return a7b() + m_d.size(); }
  const double *a8b() const { return &*m_d.begin(); }
  const double *a8e() const { return a8b() + m_d.size(); }
  ...
  std::vector<char> a10_d_ba(double f) {
    std::string s = tl::to_string(f);
    return std::vector<char>(s.begin(), s.end());
  }

#if defined(HAVE_QT)
  QByteArray a10_d_qba(double f) {
    return tl::to_qstring(tl::to_string(f)).toUtf8();
  }
  QString a10_d_qstr(double f) { return tl::to_qstring(tl::to_string(f)); }
  QStringRef a10_d_qstrref(double f) {
    m_s = tl::to_qstring(tl::to_string(f));
    return QStringRef(&m_s);
  }
#endif
  ...
  std::string a10_fptr(float *f) {
    if (f) {
      *f += 5;
      return tl::to_string(*f);
    } else {
      return "nil";
    }
  }
  std::string a10_dptr(double *f) {
    if (f) {
      *f += 6;
      return tl::to_string(*f);
    } else {
  ...
  std::string a10_uiptr(unsigned int *f) {
    if (f) {
      *f += 10;
      return tl::to_string(*f);
    } else {
  ...
  std::string a10_ulptr(unsigned long *f) {
    if (f) {
      *f += 11;
      return tl::to_string(*f);
    } else {
  ...
  std::string a10_llptr(long long *f) {
    if (f) {
      *f += 13;
      return tl::to_string(*f);
    } else {
  ...
  std::string a10_ullptr(unsigned long long *f) {
    if (f) {
      *f += 14;
      return tl::to_string(*f);
    } else {
  ...
  std::string a10_cfptr(const float *f) {
    if (f) {
      return tl::to_string(*f);
    } else {
      return "nil";
  ...
  std::string a10_cdptr(const double *f) {
    if (f) {
      return tl::to_string(*f);
    } else {
      return "nil";
  ...
  std::string a10_ciptr(const int *f) {
    if (f) {
      return tl::to_string(*f);
    } else {
      return "nil";
  ...
  std::string a10_cbptr(const bool *f) {
    if (f) {
      return tl::to_string(*f);
    } else {
      return "nil";
  ...
  std::string a10_cuiptr(const unsigned int *f) {
    if (f) {
      return tl::to_string(*f);
    } else {
      return "nil";
  ...
  std::string a10_culptr(const unsigned long *f) {
    if (f) {
      return tl::to_string(*f);
    } else {
      return "nil";
  ...
  std::string a10_clptr(const long *f) {
    if (f) {
      return tl::to_string(*f);
    } else {
      return "nil";
  ...
  std::string a10_cllptr(const long long *f) {
    if (f) {
      return tl::to_string(*f);
    } else {
      return "nil";
  ...
  std::string a10_cullptr(const unsigned long long *f) {
    if (f) {
      return tl::to_string(*f);
    } else {
      return "nil";
  ...
  std::string a10_sptr(std::string *f) {
    if (f) {
      *f += "x";
      return *f;
    } else {
  ...
  std::string a10_csptr(const std::string *f) {
    if (f) {
      return *f;
    } else {
      return "nil";
  ...
  std::string a10_fref(float &f) {
    f += 10;
    return tl::to_string(f);
  }
  std::string a10_dref(double &f) {
    f += 11;
    return tl::to_string(f);
  }
  std::string a10_iref(int &f) {
    f += 12;
    return tl::to_string(f);
  }
  std::string a10_bref(bool &f) {
    f = true;
    return tl::to_string(f);
  }
  std::string a10_uiref(unsigned int &f) {
    f += 14;
    return tl::to_string(f);
  }
  std::string a10_ulref(unsigned long &f) {
    f += 15;
    return tl::to_string(f);
  }
  std::string a10_lref(long &f) {
    f += 16;
    return tl::to_string(f);
  }
  std::string a10_llref(long long &f) {
    f += 17;
    return tl::to_string(f);
  }
  std::string a10_ullref(unsigned long long &f) {
    f += 18;
    return tl::to_string(f);
  }
  std::string a10_sref(std::string &f) {
    f += "y";
    return f;
  }
  ...
  std::string a10_cullref(const unsigned long long &f) {
    return tl::to_string(f);
  }
  ...
  void mod_efptr(QFlags<Enum> *_ef, Enum ee) {
    if (_ef)
      *_ef |= ee;
  }
...
template <class Iter> struct ValueIter {
public:
  ...
  bool operator==(const ValueIter &d) const { return iter == d.iter; }

private:
  Iter iter;
};

template <class Iter> struct FreeIter {
public:
  typedef typename std::iterator_traits<Iter> it_traits;
  typedef typename it_traits::value_type value_type;
  typedef std::forward_iterator_tag iterator_category;
  ...
  value_type operator*() const { return *mb; }
  ...
  bool operator==(const FreeIter &d) const { return mb == d.mb; }

  bool at_end() const { return mb == me; }

private:
  Iter mb, me;
};

template <class Iter> struct FreeIterUseRef {
public:
  typedef typename std::iterator_traits<Iter> it_traits;
  typedef typename it_traits::value_type value_type;
  typedef std::forward_iterator_tag iterator_category;
  ...
  reference operator*() const { return *mb; }
  ...
  bool operator==(const FreeIterUseRef &d) const { return mb == d.mb; }
...
template <class Iter> struct FreeIterUsePtr {
public:
  typedef typename std::iterator_traits<Iter> it_traits;
  ...
  bool operator==(const FreeIterUsePtr &d) const { return mb == d.mb; }
...
struct B {
  ...
  static std::optional<int> int_to_optional(int value, bool exists) {
    return exists ? std::optional<int>(value) : std::optional<int>();
  }
  static std::optional<A> int_to_optional_a(int value, bool exists) {
    return exists ? std::optional<A>(A(value)) : std::optional<A>();
  }

  static int optional_to_int(std::optional<int> optional, int def) {
    return optional ? optional.value() : def;
  }
  static int optional_cref_to_int(const std::optional<int> &optional, int def) {
    return optional_to_int(optional, def);
  }
  static int optional_ref_to_int(std::optional<int> &optional, int def) {
    return optional_to_int(optional, def);
  }
  static int optional_cptr_to_int(const std::optional<int> *optional, int def) {
    return optional_to_int(*optional, def);
  }
  static int optional_ptr_to_int(std::optional<int> optional, int def) {
    return optional_to_int(*optional, def);
  }

  static int optional_a_to_int(std::optional<A> optional, int def) {
    return optional ? optional.value().a1() : def;
  }
  static int optional_a_cref_to_int(const std::optional<A> &optional, int def) {
    return optional_a_to_int(optional, def);
  }
  static int optional_a_ref_to_int(std::optional<A> &optional, int def) {
    return optional_a_to_int(optional, def);
  }
  static int optional_a_cptr_to_int(const std::optional<A> *optional, int def) {
    return optional_a_to_int(*optional, def);
  }
  static int optional_a_ptr_to_int(std::optional<A> optional, int def) {
    return optional_a_to_int(*optional, def);
  }
#endif
  ...
  int b3(A *aptr) const { return aptr->n; }

  std::string b4(const A &aref) { return tl::sprintf("b4_result: %d", aref.n); }

  A make_a(int n) { return A(n); }

  void set_an(int n) { a.n = n; }

  int an(A a) { return a.n; }

  void set_an_cref(const int &n) { a.n = n; }

  const int &an_cref(const A &a) { return a.n; }

  std::vector<A>::const_iterator b10b() const { return av.begin(); }

  std::vector<A>::const_iterator b10e() const { return av.end(); }

  std::vector<A>::iterator b10b_nc() { return av.begin(); }

  std::vector<A>::iterator b10e_nc() { return av.end(); }
  ...
  std::vector<A_NC *>::const_iterator b12b() const { return av_nc.begin(); }

  std::vector<A_NC *>::const_iterator b12e() const { return av_nc.end(); }
  ...
  bool b15(A *a) { return a != 0; }

  std::vector<A> b16a() const { return av; }

  const std::vector<A> &b16b() const { return av; }

  std::vector<A> &b16c() { return av; }

  void b17a(const std::vector<A> &v) { av = v; }

  void b17b(std::vector<A> &v) { av = v; }

  void b17c(std::vector<A> v) { av = v; }
  ...
  bool b20c(tl::Variant var) const {
    return var.is_long() || var.is_longlong();
  }
  ...
  const tl::Variant *var_cptr() const {
    return m_vars.empty() ? 0 : &m_vars.back();
  }
  ...
  void set_map1_cptr(const std::map<int, std::string> *m) {
    if (m) {
      m_map1 = *m;
    }
  }
  void set_map1_ptr(std::map<int, std::string> *m) {
    if (m) {
      m_map1 = *m;
    }
  }
  ...
  void insert_map2(const tl::Variant &k, const tl::Variant &v) {
    m_map2[k] = v;
  }
  ...
  static void insert_map_iaptr(std::map<int, A *> &m, int k, A *v) {
  ...
  static void insert_map_iacptr(std::map<int, const A *> &m, int k,
                                const A *v) {
    m.insert(std::make_pair(k, v));
  }
  ...
  static void insert_map_ia(std::map<int, A> &m, int k, A v) {
    m.insert(std::make_pair(k, v));
  }
  const std::map<int, A> &map_ia() { return m_map_ia; }
  void set_map_ia(const std::map<int, A> &m) { m_map_ia = m; }

  static void insert_map_iav(std::map<int, std::vector<A>> &m, int k,
                             const std::vector<A> &v) {
    m.insert(std::make_pair(k, v));
  }
  static void push_map_iav(std::map<int, std::vector<A>> &m, int k,
                           const A &v) {
    m[k].push_back(v);
  }
  ...
  static void push_vvs(std::vector<std::vector<std::string>> &m,
  ...
  const std::vector<std::vector<std::string>> &vvs_cref() const {
    return m_vvs;
  }
  const std::vector<std::vector<std::string>> *vvs_cptr() const {
    return &m_vvs;
  }
  void set_vvs(std::vector<std::vector<std::string>> v) { m_vvs = v; }
  void set_vvs_ref(std::vector<std::vector<std::string>> &v) { m_vvs = v; }
  void set_vvs_cref(const std::vector<std::vector<std::string>> &v) {
    m_vvs = v;
  }
  ...
  static void push_ls(std::list<std::string> &m, const std::string &v) {
    m.push_back(v);
  }
  std::list<std::string> ls() { return m_ls; }
  void set_ls(std::list<std::string> v) { m_ls = v; }

  static void push_ss(std::set<std::string> &m, const std::string &v) {
    m.insert(v);
  }
  ...
  static void push_qlv(QList<QVariant> &m, const QVariant &v) {
    m.push_back(v);
  }
  QList<QVariant> qlv() { return m_qlv; }
  void set_qlv(QList<QVariant> v) { m_qlv = v; }

  static void push_qvs(QVector<QString> &m, const QString &v) {
    m.push_back(v);
  }
  ...
  static void insert_qmap_is(QMap<int, QString> &m, int k, const QString &v) {
    m.insert(k, v);
  }
  QMap<int, QString> qmap_is() { return m_qmap_is; }
  void set_qmap_is(QMap<int, QString> v) { m_qmap_is = v; }

  static void insert_qhash_is(QHash<int, QString> &m, int k, const QString &v) {
    m.insert(k, v);
  }
...
class CopyDetector {
public:
  CopyDetector(int x) : m_x(x), m_xx(x) {}

  CopyDetector() : m_x(0), m_xx(0) {}
...
public:
  ...
  virtual unsigned int f(const std::string & /*s*/) const { return 1977; }

  unsigned int g(const std::string s) const { return f(s); }

  virtual void vfunc(const CopyDetector &) {
    //  .. nothing yet ..
  }

  void call_vfunc(const CopyDetector &cd) { vfunc(cd); }
  ...
  CopyDetector *pass_cd_ptr(const CopyDetector &cd) {
    return const_cast<CopyDetector *>(&cd);
  }
  CopyDetector &pass_cd_ref(const CopyDetector &cd) {
    return const_cast<CopyDetector &>(cd);
  }
...
public:
  virtual unsigned int f(const std::string &s) const {
    return f_cb.can_issue()
               ? f_cb.issue<C, unsigned int, const std::string &>(&C::f, s)
               : C::f(s);
  }

  virtual void vfunc(const CopyDetector &cd) {
    return vfunc_cb.can_issue()
               ? vfunc_cb.issue<C, const CopyDetector &>(&C::vfunc, cd)
               : C::vfunc(cd);
  }
...
struct E : public gsi::ObjectBase {
  E();
  ~E();
...
struct G {
  ...
  void set_vv(int i, const std::string &s) {
    m_iv = i;
    m_sv = s;
  }
...
public:
  ...
  static size_t g_inst_count() { return s_g_inst_count; }
