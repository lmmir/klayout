 ...
 */
template <class Tag, class X> struct adaptor_factory {
  /**
   *  @brief The factory method
   *  This method will return a new adaptor object providing access to the raw
   * object v.
   */
...
/**
 *  @brief An exception thrown if there are not enough arguments on the
 * serialization buffer
 */
struct GSI_PUBLIC ArglistUnderflowException : public tl::Exception {
  ArglistUnderflowException()
      : tl::Exception(tl::to_string(
            tr("Too few arguments or no return value supplied"))) {}
};
 ...
 * serialization buffer
 */
struct GSI_PUBLIC ArglistUnderflowExceptionWithType : public tl::Exception {
  ArglistUnderflowExceptionWithType(const ArgSpecBase &as)
      : tl::Exception(tl::to_string(tr("Too few arguments - missing '%s'")),
                      as.name()) {}
};
 ...
 */
struct GSI_PUBLIC NilPointerToReference : public tl::Exception {
 ...
 *  @brief An exception thrown if a reference is null (nil)
 */
struct GSI_PUBLIC NilPointerToReferenceWithType : public tl::Exception {
  NilPointerToReferenceWithType(const ArgSpecBase &as)
      : tl::Exception(
            tl::to_string(tr("nil object passed to a reference for '%s'")),
            as.name()) {}
};

/**
 *  @brief This class provides the basic argument serialization mechanism for
 * the C++/scripting interface
 */
...
public:
   ...
   */
  SerialArgs() : mp_buffer(0) { mp_write = mp_read = mp_buffer; }

  /**
   *  @brief Constructor
   *  Creates a buffer with space for len bytes.
   */
  SerialArgs(size_t len) : mp_buffer(0) {
    //  use the internal buffer for small argument lists (which are quite
    //  common)
   ...
   */
  template <class X> inline X read(tl::Heap &heap) {
   ...
   *  @brief Reads a value from the buffer
   */
  template <class X> inline X read(tl::Heap &heap, const ArgSpecBase *as) {
   ...
   */
  operator bool() const { return mp_read && mp_read < mp_write; }
...
private:
  ...
  template <class X> void write_impl(const pod_direct_tag &, const X &x) {
    *((X *)mp_write) = x;
    mp_write += item_size<X>();
  }

  template <class X> void write_impl(const x_tag &, const X &x) {
    *((X **)mp_write) = new X(x);
    mp_write += item_size<X *>();
  }

  template <class X> void write_impl(const ref_tag &, X &x) {
    *((X **)mp_write) = &x;
    mp_write += item_size<X *>();
  }

  template <class X> void write_impl(const ptr_tag &, X *x) {
    *((X **)mp_write) = x;
    mp_write += item_size<X *>();
  }

  template <class X> void write_impl(const pod_cref_tag &, const X &x) {
    X *r = (X *)mp_write;
    new (r) X(x);
    mp_write += item_size<X>();
  }

  template <class X> void write_impl(const npod_cref_tag &, const X &x) {
    *((X const **)mp_write) = &x;
    mp_write += item_size<const X *>();
  }

  template <class X> void write_impl(const x_cref_tag &, const X &x) {
    *((X const **)mp_write) = &x;
    mp_write += item_size<const X *>();
  }

  template <class X> void write_impl(const pod_cptr_tag &, const X *x) {
    *(bool *)mp_write = (x != 0);
  ...
  template <class X> void write_impl(const npod_cptr_tag &, const X *x) {
    *((X const **)mp_write) = x;
    mp_write += item_size<const X *>();
  }

  template <class X> void write_impl(const x_cptr_tag &, const X *x) {
    *((X const **)mp_write) = x;
    mp_write += item_size<const X *>();
  }
  ...
  template <class X> void write_impl(const adaptor_direct_tag &, const X &x) {
    *((void **)mp_write) =
        adaptor_factory<typename gsi::type_traits<X>::tag, X>::get(x);
    mp_write += item_size<void *>();
  }

  template <class X> void write_impl(const adaptor_ptr_tag &, X *x) {
    if (x) {
      *((void **)mp_write) =
          adaptor_factory<typename gsi::type_traits<X *>::tag, X *>::get(x);
    } else {
  ...
  template <class X> void write_impl(const adaptor_cptr_tag &, const X *x) {
    if (x) {
      *((void **)mp_write) =
          adaptor_factory<typename gsi::type_traits<const X *>::tag,
                          const X *>::get(x);
    } else {
      *((void **)mp_write) = 0;
    }
  ...
  template <class X> void write_impl(const adaptor_ref_tag &, X &x) {
    *((void **)mp_write) =
        adaptor_factory<typename gsi::type_traits<X &>::tag, X &>::get(x);
    mp_write += item_size<void *>();
  }

  template <class X> void write_impl(const adaptor_cref_tag &, const X &x) {
    *((void **)mp_write) =
        adaptor_factory<typename gsi::type_traits<const X &>::tag,
                        const X &>::get(x);
    mp_write += item_size<void *>();
  ...
  X read_impl(const adaptor_direct_tag &, tl::Heap &heap,
    ...
    tl_assert(p != 0);
    //  late-destroy the adaptor since the new X object may still need data from
    //  there (e.g. QLatin1String)
    heap.push(p);
  ...
  X read_impl(const adaptor_cptr_tag &, tl::Heap &heap, const ArgSpecBase *as) {
    ...
    if (p != 0) {
      ...
      //  late-destroy the adaptor since the new X object may still need data
      //  from there (e.g. QLatin1String)
      heap.push(p);
...
template <class X> struct GSI_PUBLIC_TEMPLATE arg_reader {
...
template <class X> struct GSI_PUBLIC_TEMPLATE arg_maker {
  inline X operator()(const X &x, tl::Heap &) { return x; }
};

template <class X> struct GSI_PUBLIC_TEMPLATE arg_maker<X &> {
  inline X &operator()(X &x, tl::Heap &) { return x; }
};

template <class X> struct GSI_PUBLIC_TEMPLATE arg_maker<const X &> {
 ...
 */
class GSI_PUBLIC StringAdaptor : public AdaptorBase {
public:
  /**
   *  @brief Default constructor
   */
  ...
  /**
   *  @brief Returns a pointer to a UTF8 encoded character array with size
   * size()
   */
 ...
 */
template <class X>
class GSI_PUBLIC_TEMPLATE StringAdaptorImpl : public StringAdaptor {};
 ...
 */
template <> class GSI_PUBLIC StringAdaptorImpl<QString> : public StringAdaptor {
public:
  StringAdaptorImpl(QString *s) : mp_s(s), m_is_const(false) {
    //  .. nothing yet ..
  }
  ...
  StringAdaptorImpl(const QString &s) : m_is_const(false), m_s(s) {
    mp_s = &m_s;
  }

  StringAdaptorImpl() : m_is_const(false) { mp_s = &m_s; }

  virtual ~StringAdaptorImpl() {
    //  .. nothing yet ..
  }

  virtual size_t size() const { return mp_s->toUtf8().size(); }
  ...
  virtual void copy_to(AdaptorBase *target, tl::Heap &heap) const {
    StringAdaptorImpl<QString> *s =
        dynamic_cast<StringAdaptorImpl<QString> *>(target);
    if (s) {
      *s->mp_s = *mp_s;
    } else {
 ...
 */
template <>
class GSI_PUBLIC StringAdaptorImpl<QStringRef> : public StringAdaptor {
public:
  StringAdaptorImpl(QStringRef *s) : mp_s(s), m_is_const(false) {
    //  .. nothing yet ..
  }
  ...
  StringAdaptorImpl(const QStringRef &s) : m_is_const(false), m_s(s) {
    mp_s = &m_s;
  }
  ...
  virtual size_t size() const { return mp_s->toString().toUtf8().size(); }
  ...
  virtual void copy_to(AdaptorBase *target, tl::Heap &heap) const {
    StringAdaptorImpl<QStringRef> *s =
        dynamic_cast<StringAdaptorImpl<QStringRef> *>(target);
    if (s) {
      *s->mp_s = *mp_s;
    } else {
      StringAdaptor::copy_to(target, heap);
 ...
 */
template <>
class GSI_PUBLIC StringAdaptorImpl<QStringView> : public StringAdaptor {
public:
  StringAdaptorImpl(QStringView *s) : mp_s(s), m_is_const(false) {
    //  .. nothing yet ..
  }
  ...
  StringAdaptorImpl(const QStringView &s) : m_is_const(false), m_s(s) {
    mp_s = &m_s;
  }
  ...
  virtual void copy_to(AdaptorBase *target, tl::Heap &heap) const {
    StringAdaptorImpl<QStringView> *s =
        dynamic_cast<StringAdaptorImpl<QStringView> *>(target);
    if (s) {
      QString *hstr = heap.create<QString>();
      *hstr = mp_s->toString();
 ...
 */
template <>
class GSI_PUBLIC StringAdaptorImpl<QLatin1String> : public StringAdaptor {
public:
  StringAdaptorImpl(QLatin1String *s) : mp_s(s), m_is_const(false) {
    //  .. nothing yet ..
  }
  ...
  StringAdaptorImpl(const QLatin1String &s) : m_is_const(false), m_s(s) {
    mp_s = &m_s;
  }
  ...
  virtual void set(const char *c_str, size_t s, tl::Heap &heap) {
    if (!m_is_const) {
      QByteArray *latin1_holder =
          new QByteArray(QString::fromUtf8(c_str, int(s)).toLatin1());
 ...
 */
template <>
class GSI_PUBLIC StringAdaptorImpl<std::string> : public StringAdaptor {
public:
  StringAdaptorImpl(std::string *s) : mp_s(s), m_is_const(false) {
    //  .. nothing yet ..
  }
  ...
  StringAdaptorImpl(const std::string &s) : m_is_const(false), m_s(s) {
    mp_s = &m_s;
  }
  ...
  virtual size_t size() const { return mp_s->size(); }

  virtual const char *c_str() const { return mp_s->c_str(); }
  ...
  virtual void copy_to(AdaptorBase *target, tl::Heap &heap) const {
    StringAdaptorImpl<std::string> *s =
        dynamic_cast<StringAdaptorImpl<std::string> *>(target);
    if (s) {
      *s->mp_s = *mp_s;
    } else {
      StringAdaptor::copy_to(target, heap);
 ...
 */
template <class CP>
class GSI_PUBLIC_TEMPLATE StringAdaptorImplCCP : public StringAdaptor {
public:
  StringAdaptorImplCCP(CP *s) : mp_s(s), m_is_const(false) {
    //  .. nothing yet ..
  }
  ...
  StringAdaptorImplCCP(CP s) : m_is_const(false), m_s((const char *)s) {
    mp_s = 0;
  }

  StringAdaptorImplCCP() : m_is_const(false) { mp_s = 0; }
  ...
  virtual void set(const char *c_str, size_t s, tl::Heap &heap) {
    if (!m_is_const) {
      if (!mp_s) {
        //  This adaptor is not attached to an external "const char *" pointer,
        //  so we can safely use the internal storage.
        m_s = std::string(c_str, s);
      } else {
        //  This means we assign a simple pointer some other pointer without
        //  knowning how long the other points lives. To account for that we
        //  create a temporary string on the heap and take the pointer from
        //  there. Since the target is a pointer outside this adaptor, we cannot
        //  use the adaptor's internal storage since the adaptor won't survive
        //  the outside use case.
...
public:
  ...
  StringAdaptorImpl(const char_type **s)
      : StringAdaptorImplCCP<const char_type *>(s) {}
  StringAdaptorImpl(const char_type *const *s)
      : StringAdaptorImplCCP<const char_type *>(s) {}
  StringAdaptorImpl(const char_type *s)
      : StringAdaptorImplCCP<const char_type *>(s) {}
};
 ...
 *  This is the base class for implementing generic access to strings
 */
class GSI_PUBLIC ByteArrayAdaptor : public AdaptorBase {
public:
  /**
   *  @brief Default constructor
   */
 ...
 */
template <class X>
class GSI_PUBLIC_TEMPLATE ByteArrayAdaptorImpl : public ByteArrayAdaptor {};
 ...
 */
template <>
class GSI_PUBLIC ByteArrayAdaptorImpl<QByteArray> : public ByteArrayAdaptor {
public:
  ByteArrayAdaptorImpl(QByteArray *s) : mp_s(s), m_is_const(false) {
    //  .. nothing yet ..
  }
  ...
  ByteArrayAdaptorImpl(const QByteArray &s) : m_is_const(false), m_s(s) {
    mp_s = &m_s;
  }

  ByteArrayAdaptorImpl() : m_is_const(false) { mp_s = &m_s; }
  ...
  virtual const char *c_str() const { return mp_s->constData(); }
  ...
  virtual void copy_to(AdaptorBase *target, tl::Heap &heap) const {
    ByteArrayAdaptorImpl<QByteArray> *s =
        dynamic_cast<ByteArrayAdaptorImpl<QByteArray> *>(target);
    if (s) {
      *s->mp_s = *mp_s;
    } else {
...
public:
  ByteArrayAdaptorImpl(QByteArrayView *s) : mp_s(s), m_is_const(false) {
    //  .. nothing yet ..
  }
  ...
  ByteArrayAdaptorImpl(const QByteArrayView &s) : m_is_const(false), m_s(s) {
    mp_s = &m_s;
  }
  ...
  virtual void copy_to(AdaptorBase *target, tl::Heap &heap) const {
    ByteArrayAdaptorImpl<QByteArrayView> *s =
        dynamic_cast<ByteArrayAdaptorImpl<QByteArrayView> *>(target);
    if (s) {
      QByteArray *str = heap.create<QByteArray>();
...
class GSI_PUBLIC ByteArrayAdaptorImpl<std::vector<char>>
    : public ByteArrayAdaptor {
public:
  ByteArrayAdaptorImpl(std::vector<char> *s) : mp_s(s), m_is_const(false) {
    //  .. nothing yet ..
  }
  ...
  ByteArrayAdaptorImpl(const std::vector<char> &s) : m_is_const(false), m_s(s) {
    mp_s = &m_s;
  }
  ...
  virtual const char *c_str() const { return &mp_s->front(); }
  ...
  virtual void copy_to(AdaptorBase *target, tl::Heap &heap) const {
    ByteArrayAdaptorImpl<std::vector<char>> *s =
        dynamic_cast<ByteArrayAdaptorImpl<std::vector<char>> *>(target);
    if (s) {
      *s->mp_s = *mp_s;
    } else {
      ByteArrayAdaptor::copy_to(target, heap);
 ...
 */
class GSI_PUBLIC VariantAdaptor : public AdaptorBase {
public:
  /**
   *  @brief Default constructor
   */
 ...
 */
template <class X>
class GSI_PUBLIC_TEMPLATE VariantAdaptorImpl : public VariantAdaptor {};
 ...
 */
template <>
class GSI_PUBLIC VariantAdaptorImpl<QVariant> : public VariantAdaptor {
public:
  VariantAdaptorImpl(QVariant *v) : mp_v(v), m_is_const(false) {
    //  .. nothing yet ..
  }
  ...
  VariantAdaptorImpl(const QVariant &v) : m_is_const(true), m_v(v) {
    mp_v = &m_v;
  }

  VariantAdaptorImpl() : m_is_const(false) { mp_v = &m_v; }

  virtual ~VariantAdaptorImpl() {
    //  .. nothing yet ..
  }

  virtual tl::Variant var() const { return tl::Variant(*mp_v); }

  const QVariant &qvar() const { return *mp_v; }
  ...
  virtual void copy_to(AdaptorBase *target, tl::Heap &heap) const {
    VariantAdaptorImpl<QVariant> *v =
        dynamic_cast<VariantAdaptorImpl<QVariant> *>(target);
    if (v) {
      *v->mp_v = qvar();
    } else {
...
public:
  VariantAdaptorImpl(QPointer<T> *v) : mp_v(v), m_is_const(false) {
    //  .. nothing yet ..
  }
  ...
  VariantAdaptorImpl(const QPointer<T> &v) : m_is_const(true), m_v(v) {
    mp_v = &m_v;
  }
    ...
    if (m_is_const) {
      ...
      if (v.user_is_ref()) {
        *mp_v = (T *)v.to_user();
        ...
        //  basically should not happen as the QPointer cannot hold anything
        //  other than a reference (a tl::Variant terminology)
        tl_assert(false);
      }
    } else {
      //  basically should not happen as the QPointer cannot hold anything other
      //  than a user object (a tl::Variant terminology)
      tl_assert(false);
    }
  }
  ...
  virtual void copy_to(AdaptorBase *target, tl::Heap &heap) const {
    VariantAdaptorImpl<QPointer<T>> *v =
        dynamic_cast<VariantAdaptorImpl<QPointer<T>> *>(target);
    if (v) {
      if (mp_v->isNull()) {
        v->mp_v->clear();
      } else {
 ...
 */
template <>
class GSI_PUBLIC VariantAdaptorImpl<tl::Variant> : public VariantAdaptor {
public:
  VariantAdaptorImpl(tl::Variant *v) : mp_v(v), m_is_const(false) {
    //  .. nothing yet ..
  }
  ...
  VariantAdaptorImpl(const tl::Variant &v) : m_is_const(true), m_v(v) {
    mp_v = &m_v;
  }
  ...
  virtual tl::Variant var() const { return *mp_v; }

  const tl::Variant &var_ref() const { return *mp_v; }

  tl::Variant &var_ref_nc() { return *mp_v; }
  ...
  virtual void copy_to(AdaptorBase *target, tl::Heap &heap) const {
    VariantAdaptorImpl<tl::Variant> *v =
        dynamic_cast<VariantAdaptorImpl<tl::Variant> *>(target);
    if (v) {
      *v->mp_v = var_ref();
    } else {
      VariantAdaptor::copy_to(target, heap);
...
class GSI_PUBLIC_TEMPLATE VariantAdaptorImpl<std::optional<T>>
    : public VariantAdaptor {
public:
  VariantAdaptorImpl(std::optional<T> *v) : mp_v(v), m_is_const(false) {
    //  .. nothing yet ..
  }
  ...
  VariantAdaptorImpl(const std::optional<T> &v) : m_is_const(true), m_v(v) {
    mp_v = &m_v;
  }
  ...
  virtual void copy_to(AdaptorBase *target, tl::Heap &heap) const {
    VariantAdaptorImpl<std::optional<T>> *v =
        dynamic_cast<VariantAdaptorImpl<std::optional<T>> *>(target);
    if (v) {
      if (*mp_v) {
        v->mp_v->reset();
      } else {
 ...
 *  This is the base class for implementing generic access to vectors or other
 * linear containers.
 */
class GSI_PUBLIC VectorAdaptor : public AdaptorBase {
public:
  /**
   *  @brief Default constructor
   */
   ...
   *  The heap must be provided to account for cases where temporary objects
   * need to be created upon reading (for example a vector<vector *>).
   */
...
/**
 *  @brief Implementation of the generic iterator adaptor for a specific
 * container
 */
template <class Cont>
...
public:
  ...
  VectorAdaptorIteratorImpl(const Cont &v) : m_b(v.begin()), m_e(v.end()) {}

  void get(SerialArgs &ww, tl::Heap &) const { ww.write<value_type>(*m_b); }
...
template <class X> void push_vector(std::vector<X> &v, const X &x) {
  v.push_back(x);
}

template <class X> void push_vector(std::list<X> &v, const X &x) {
  v.push_back(x);
}

template <class X> void push_vector(std::set<X> &v, const X &x) { v.insert(x); }

#if defined(HAVE_QT)

#if QT_VERSION < 0x60000
template <class X> void push_vector(QVector<X> &v, const X &x) {
  v.push_back(x);
}
#endif

inline void push_vector(QStringList &v, const QString &x) { v.push_back(x); }

template <class X> void push_vector(QList<X> &v, const X &x) { v.push_back(x); }

template <class X> void push_vector(QSet<X> &v, const X &x) { v.insert(x); }
 ...
 */
template <class Cont>
class GSI_PUBLIC_TEMPLATE VectorAdaptorImpl : public VectorAdaptor {
public:
  typedef typename Cont::value_type value_type;

  VectorAdaptorImpl(Cont *v) : mp_v(v), m_is_const(false) {
    //  .. nothing yet ..
  }
  ...
  VectorAdaptorImpl() : m_is_const(false) { mp_v = &m_v; }

  VectorAdaptorImpl(const Cont &v) : m_is_const(false), m_v(v) { mp_v = &m_v; }

  virtual ~VectorAdaptorImpl() {
    //  .. nothing yet ..
  }

  virtual size_t size() const { return mp_v->size(); }
  ...
  virtual void copy_to(AdaptorBase *target, tl::Heap &heap) const {
    ...
    VectorAdaptorImpl<Cont> *t =
        dynamic_cast<VectorAdaptorImpl<Cont> *>(target);
    if (t) {
      if (!t->m_is_const) {
        *t->mp_v = *mp_v;
      }
 ...
 *  This is the base class for implementing generic access to map or other
 * associative containers.
 */
class GSI_PUBLIC MapAdaptor : public AdaptorBase {
public:
  /**
   *  @brief Default constructor
   */
   ...
   *  The key and value is expected as a serialized object on the SerialArgs
   * buffers. The heap must be provided to account for cases where temporary
   * objects need to be created upon reading (for example a map<int, vector *>).
   */
 ...
 */
template <class Cont> struct map_access {
  ...
  static const key_type &get_key(const_iterator i) { return i->first; }

  static const value_type &get_value(const_iterator i) { return i->second; }
};
 ...
 */
template <class X, class Y> struct map_access<QMap<X, Y>> {
  ...
  static const key_type &get_key(const_iterator i) { return i.key(); }

  static const value_type &get_value(const_iterator i) { return i.value(); }
};

/**
 *  @brief Specialization for QHash
 */
template <class X, class Y> struct map_access<QHash<X, Y>> {
 ...
 */
template <class Cont>
class GSI_PUBLIC_TEMPLATE MapAdaptorIteratorImpl : public MapAdaptorIterator {
public:
  typedef typename Cont::key_type key_type;
  typedef typename Cont::mapped_type value_type;

  MapAdaptorIteratorImpl(const Cont &v) : m_b(v.begin()), m_e(v.end()) {}
 ...
 */
template <class Cont>
class GSI_PUBLIC_TEMPLATE MapAdaptorImpl : public MapAdaptor {
public:
  typedef typename Cont::key_type key_type;
  typedef typename Cont::mapped_type value_type;

  MapAdaptorImpl(Cont *m) : mp_m(m), m_is_const(false) {
    //  .. nothing yet ..
  }
  ...
  MapAdaptorImpl(const Cont &m) : m_is_const(false), m_m(m) { mp_m = &m_m; }

  MapAdaptorImpl() : m_is_const(false) { mp_m = &m_m; }

  virtual ~MapAdaptorImpl() {
    //  .. nothing yet ..
  }

  virtual size_t size() const { return mp_m->size(); }
  ...
  virtual size_t serial_size() const {
    return (gsi::type_traits<key_type>::serial_size() +
            gsi::type_traits<value_type>::serial_size());
  }
...
inline AdaptorBase *
create_adaptor_by_category(const vector_adaptor_tag & /*tag*/, V v) {
  return new VectorAdaptorImpl<X>(v);
}

template <class X, class V>
inline AdaptorBase *create_adaptor_by_category(const map_adaptor_tag & /*tag*/,
                                               V v) {
...
template <class X, class V>
inline AdaptorBase *
create_adaptor_by_category(const string_adaptor_tag & /*tag*/, V v) {
  return new StringAdaptorImpl<X>(v);
}

template <class X, class V>
inline AdaptorBase *
create_adaptor_by_category(const byte_array_adaptor_tag & /*tag*/, V v) {
  return new ByteArrayAdaptorImpl<X>(v);
}

template <class X, class V>
inline AdaptorBase *
create_adaptor_by_category(const variant_adaptor_tag & /*tag*/, const V &v) {
  return new VariantAdaptorImpl<X>(v);
}

template <class Tag, class X>
inline AdaptorBase *create_adaptor2(const adaptor_direct_tag & /*tag*/,
                                    const Tag &tag2, const X &v) {
  return create_adaptor_by_category<X>(tag2, v);
}

template <class Tag, class X>
inline AdaptorBase *create_adaptor2(const adaptor_cref_tag & /*tag*/,
                                    const Tag &tag2, const X &v) {
  return create_adaptor_by_category<X>(tag2, &v);
}

template <class Tag, class X>
inline AdaptorBase *create_adaptor2(const adaptor_ref_tag & /*tag*/,
                                    const Tag &tag2, X &v) {
  return create_adaptor_by_category<X>(tag2, &v);
}

template <class Tag, class X>
inline AdaptorBase *create_adaptor2(const adaptor_cptr_tag & /*tag*/,
                                    const Tag &tag2, const X *v) {
  return create_adaptor_by_category<X>(tag2, v);
}

template <class Tag, class X>
inline AdaptorBase *create_adaptor2(const adaptor_ptr_tag & /*tag*/,
                                    const Tag &tag2, X *v) {
  return create_adaptor_by_category<X>(tag2, v);
}
...
template <class X> inline void copy_to(AdaptorBase &a, X &x, tl::Heap &heap) {
  std::unique_ptr<AdaptorBase> t(
      adaptor_factory<typename gsi::type_traits<X &>::tag, X &>::get(x));
