 ...
 */
struct GSI_PUBLIC Callee : public tl::Object {
  Callee() {}
  virtual ~Callee() {}
 ...
 *
 *  This object holds information about the actual implementation of the
 * callback on the scripting client's side.
 */
struct Callback {
  Callback() : id(-1), callee(0), argsize(0), retsize(0) {
    //  .. nothing yet ..
  }
  ...
  bool can_issue() const { return callee && callee->can_call(); }
