...
static int type(const ArgType *t) { return t->type(); }
...
Class<ArgType> decl_ArgType(
    "tl", "ArgType",
    gsi::method("TypeVoid", &t_void) + gsi::method("TypeBool", &t_bool) +
        gsi::method("TypeChar", &t_char) + gsi::method("TypeSChar", &t_schar) +
        gsi::method("TypeUChar", &t_uchar) +
        gsi::method("TypeShort", &t_short) +
        gsi::method("TypeUShort", &t_ushort) + gsi::method("TypeInt", &t_int) +
        gsi::method("TypeUInt", &t_uint) + gsi::method("TypeLong", &t_long) +
        ...
        gsi::method("TypeFloat", &t_float) + gsi::method("TypeVar", &t_var) +
        ...
        gsi::method("TypeVector", &t_vector) + gsi::method("TypeMap", &t_map) +
        gsi::method_ext("type", &type,
                        "@brief Return the basic type (see t_.. constants)\n") +
        gsi::method("inner", &ArgType::inner,
                    "@brief Returns the inner ArgType object (i.e. value of a "
                    "vector/map)\n"
                    "Starting with version 0.22, this method replaces the "
                    "is_vector method.\n") +
        gsi::method(
            "inner_k", &ArgType::inner_k,
            "@brief Returns the inner ArgType object (i.e. key of a map)\n"
            "This method has been introduced in version 0.27.") +
        gsi::method("pass_obj?", &ArgType::pass_obj,
                    "@brief True, if the ownership over an object represented "
                    "by this type is passed to the receiver\n"
                    "In case of the return type, a value of true indicates, "
                    "that the object is a freshly created one and "
                    "the receiver has to take ownership of the object.\n\n"
                    "This method has been introduced in version 0.24.") +
        gsi::method(
            "is_ref?", &ArgType::is_ref,
            "@brief True, if the type is a reference to the given type\n"
            "Starting with version 0.22 there are more methods that describe "
            "the "
            "type of reference and is_ref? only applies to non-const reference "
            "(in C++: 'X &').\n") +
        gsi::method(
            "is_cref?", &ArgType::is_cref,
            "@brief True, if the type is a const reference to the given type\n"
            "This property indicates that the argument is a const reference "
            "(in C++: 'const X &').\n") +
        gsi::method("is_ptr?", &ArgType::is_ptr,
                    "@brief True, if the type is a non-const pointer to the "
                    "given type\n"
                    "This property indicates that the argument is a non-const "
                    "pointer (in C++: 'X *').\n") +
        gsi::method(
            "is_cptr?", &ArgType::is_cptr,
            "@brief True, if the type is a const pointer to the given type\n"
            "This property indicates that the argument is a const pointer (in "
            "C++: 'const X *').\n") +
        gsi::method("is_iter?", &ArgType::is_iter,
                    "@brief (Return value only) True, if the return value is "
                    "an iterator rendering the given type\n") +
        ...
        gsi::method_ext("has_default?", &has_default_value,
                        "@brief Returns true, if a default value is specified "
                        "for this argument\n"
                        "Applies to arguments only. This method has been "
                        "introduced in version 0.24.") +
        gsi::method_ext("default", &default_value,
                        "@brief Returns the default value or nil is there is "
                        "no default value\n"
                        "Applies to arguments only. This method has been "
                        "introduced in version 0.24.") +
        gsi::method_ext("name", &arg_name,
                        "@brief Returns the name for this argument or an empty "
                        "string if the argument is not named\n"
                        "Applies to arguments only. This method has been "
                        "introduced in version 0.24.") +
...
Class<MethodBase::MethodSynonym> decl_MethodOverload(
    "tl", "MethodOverload",
    gsi::method_ext("name", &_syn_name,
                    "@brief The name of this overload\n"
                    "This is the raw, unadorned name. I.e. no question mark "
                    "suffix for predicates, no "
                    "equal character suffix for setters etc.\n") +
        gsi::method_ext(
            "deprecated?", &_syn_deprecated,
            "@brief A value indicating that this overload is deprecated\n") +
        gsi::method_ext("is_getter?", &_syn_is_getter,
                        "@brief A value indicating that this overload is a "
                        "property getter\n") +
        gsi::method_ext("is_setter?", &_syn_is_setter,
                        "@brief A value indicating that this overload is a "
                        "property setter\n") +
        gsi::method_ext(
            "is_predicate?", &_syn_is_predicate,
            "@brief A value indicating that this overload is a predicate\n"),
    "@hide");

Class<MethodBase> decl_Method(
    "tl", "Method",
    gsi::iterator("each_argument", &MethodBase::begin_arguments,
                  &MethodBase::end_arguments,
                  "@brief Iterate over all arguments of this method\n") +
        gsi::method("ret_type",
                    (const gsi::ArgType &(MethodBase::*)() const) &
                        MethodBase::ret_type,
        ...
        gsi::method("is_protected?", &MethodBase::is_protected,
                    ...
                    "This method has been introduced in version 0.24.") +
        gsi::iterator(
            "each_overload", &MethodBase::begin_synonyms,
            &MethodBase::end_synonyms,
            "@brief This iterator delivers the synonyms (overloads).\n"
            "\n"
            "This method has been introduced in version 0.24.") +
        gsi::method("accepts_num_args", &MethodBase::compatible_with_num_args,
                    "@brief True, if this method is compatible with the given "
                    "number of arguments\n"
                    "\n"
                    "This method has been introduced in version 0.24.") +
        ...
        gsi::method(
            "is_static?", &MethodBase::is_static,
        ...
        gsi::method("is_signal?", &MethodBase::is_signal,
                    ...
                    "\n"
                    "Signals replace events for version 0.25. is_event? is no "
                    "longer available.") +
        gsi::method(
            "name", &MethodBase::combined_name,
            "@brief The name string of the method\n"
            "A method may have multiple names (aliases). The name string "
            "delivers all of them in a combined way.\n"
            "\n"
            "The names are separated by pipe characters (|). A trailing star "
            "(*) indicates that the method is protected.\n"
            "\n"
            "Names may be prefixed by a colon (:) to indicate a property "
            "getter. This colon does not appear in the "
            "method name.\n"
            "\n"
            "A hash prefix indicates that a specific alias is deprecated.\n"
            "\n"
            "Names may be suffixed by a question mark (?) to indicate a "
            "predicate or a equal character (=) to indicate "
            "a property setter. Depending on the preferences of the language, "
            "these characters may appear in the "
            "method names of not - in Python they don't, in Ruby they will be "
            "part of the method name.\n"
            "\n"
            "The backslash character is used inside the names to escape these "
            "special characters.\n"
            "\n"
            "The preferred method of deriving the overload is to iterate then "
            "using \\each_overload.\n") +
        gsi::method(
            "primary_name", &MethodBase::primary_name,
...
Class<ClassBase> decl_Class(
    "tl", "Class",
    gsi::iterator("each_class", &ClassBase::begin_classes,
                  &ClassBase::end_classes,
                  "@brief Iterate over all classes\n") +
        gsi::iterator("each_method", &ClassBase::begin_methods,
                      &ClassBase::end_methods,
                      "@brief Iterate over all methods of this class\n") +
        gsi::iterator("each_child_class", &ClassBase::begin_child_classes,
                      &ClassBase::end_child_classes,
                      "@brief Iterate over all child classes defined within "
                      "this class\n") +
        ...
        gsi::method("base", &ClassBase::base,
                    "@brief The base class or nil if the class does not have a "
                    "base class\n"
                    "\n"
