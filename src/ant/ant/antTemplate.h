...
public:
  ...
  enum ruler_mode_type {
    /**
     *  @brief The rulers acts normal and a start and end point need to be
     * defined
     */
    RulerNormal = 0,

    /**
     *  @brief The ruler is single-click: a single click is sufficient to place
     * a ruler and p1 will be == p2
     */
    RulerSingleClick = 1,

    /**
     *  @brief The ruler is auto-metric: a single click will place a ruler and
     * the ruler will extend to the next adjacent structures
     */
    RulerAutoMetric = 2,

    /**
     *  @brief The ruler an angle type (two segments, three mouse clicks) for
     * angle and circle radius measurements
     */
    RulerThreeClicks = 3,
   ...
   */
  static ant::Template from_object(const ant::Object &object,
   ...
   */
  Template(const std::string &title, const std::string &fmt_x,
           const std::string &fmt_y, const std::string &fmt, style_type style,
           outline_type outline, bool snap,
           lay::angle_constraint_type angle_constraints,
   ...
   *  The category string is used to label the rulers generated from this
   * template. Templates that use a category string are regarded "system
   * templates" and are not editable.
   */
   ...
   */
  void category(const std::string &c) { m_category = c; }

  /**
   *  @brief Sets the ruler mode
   */
  void set_mode(ruler_mode_type mode) { m_mode = mode; }

  /**
   *  @brief Gets the ruler mode
   */
  ruler_mode_type mode() const { return m_mode; }
   ...
   */
  void fmt(const std::string &s) { m_fmt = s; }

  /**
   *  @brief Sets the position of the main label
   *  See the \position_type enum for details.
   */
  void set_main_position(position_type pos) { m_main_position = pos; }
   ...
   */
  void set_main_xalign(alignment_type a) { m_main_xalign = a; }
   ...
   *  See \alignment_type for details.
   */
  void set_main_yalign(alignment_type a) { m_main_yalign = a; }
   ...
   *
   *  If the ruler has a horizontal component (that is in a non-diagonal outline
   * mode), this component is labelled with a string formatted with this format.
   */
  void fmt_x(const std::string &s) { m_fmt_x = s; }

  /**
   *  @brief Sets the x alignment flag of the x axis label
   *  See \alignment_type for details.
   */
  void set_xlabel_xalign(alignment_type a) { m_xlabel_xalign = a; }
   ...
   *  See \alignment_type for details.
   */
  void set_xlabel_yalign(alignment_type a) { m_xlabel_yalign = a; }
   ...
   *
   *  If the ruler has a vertical component (that is in a non-diagonal outline
   * mode), this component is labelled with a string formatted with this format.
   */
  void fmt_y(const std::string &s) { m_fmt_y = s; }

  /**
   *  @brief Sets the x alignment flag of the y axis label
   *  See \alignment_type for details.
   */
  void set_ylabel_xalign(alignment_type a) { m_ylabel_xalign = a; }
   ...
   *  See \alignment_type for details.
   */
  void set_ylabel_yalign(alignment_type a) { m_ylabel_yalign = a; }
   ...
   */
  void style(style_type s) { m_style = s; }
   ...
   *  as a set of horizonal and vertical lines or as a set of horizontal,
   * vertical and diagonal lines. As a marker it may appear as a box.
   */
  void outline(outline_type s) { m_outline = s; }
   ...
   *  for the rulers derived from this template or if the global setting is to
   * be used (if ant::Service::Global is used for the angle constraint).
   */
