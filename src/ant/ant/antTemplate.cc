...
int Template::current_version() { return 1; }

ant::Template Template::from_object(const ant::Object &a,
...
Template::Template()
    : m_version(current_version()), m_title(tl::to_string(tr("Ruler"))),
      ...
      m_xlabel_xalign(ant::Object::AL_auto),
      m_xlabel_yalign(ant::Object::AL_auto),
      m_ylabel_xalign(ant::Object::AL_auto),
      m_ylabel_yalign(ant::Object::AL_auto),
      m_mode(ant::Template::RulerNormal) {
  //  .. nothing yet ..
}

Template::Template(const std::string &title, const std::string &fmt_x,
    ...
    : m_version(current_version()), m_title(title), m_category(cat),
      m_fmt_x(fmt_x), m_fmt_y(fmt_y), m_fmt(fmt), m_style(style),
...
Template::Template(const ant::Template &d)
    : m_version(d.m_version), m_title(d.m_title), m_category(d.m_category),
      m_fmt_x(d.m_fmt_x), m_fmt_y(d.m_fmt_y), m_fmt(d.m_fmt),
      m_style(d.m_style), m_outline(d.m_outline), m_snap(d.m_snap),
      ...
      m_ylabel_yalign(d.m_ylabel_yalign), m_mode(d.m_mode) {
  //  .. nothing else ..
}

Template &Template::operator=(const ant::Template &d) {
  if (this != &d) {
...
std::vector<Template> Template::from_string(const std::string &s) {
...
std::string Template::to_string(const std::vector<Template> &v) {
  std::string r;
