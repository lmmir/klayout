...
TEST(1) {
  ant::Template tmp = ant::Template(
      "title", "fmt_x", "fmt_y", "fmt", ant::Object::STY_arrow_both,
      ant::Object::OL_diag_xy, true, lay::AC_Ortho, "cat");

  ant::Object a =
      ant::Object(db::DPoint(1.0, 2.0), db::DPoint(3.0, 4.0), 17, tmp);
