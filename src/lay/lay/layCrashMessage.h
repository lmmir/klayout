 ...
 */
class LAY_PUBLIC CrashMessage : public QDialog, private Ui::CrashMessage {
  Q_OBJECT
...
public:
   ...
   */
  bool is_cancel_pressed() { return m_cancel_pressed; }

  /**
   *  @brief Resets the flag indicating whether Cancel was pressed
   */
  void reset_cancel_pressed() { m_cancel_pressed = false; }
