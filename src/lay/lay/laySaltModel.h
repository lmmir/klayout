...
public:
   ...
   */
  enum Severity { None = 0, Info = 1, Warning = 2, Error = 3 };

  /**
   *  @brief Constructor
   */
  SaltModel(QObject *parent, lay::Salt *salt, Salt *salt_filtered = 0,
            bool salt_exclude = false);
  ...
  /**
   *  @brief Sets the explanation text for an empty list (i.e. "there are no new
   * packages")
   */
   ...
   */
  void set_message(const std::string &name, Severity severity,
