...
class TechBaseEditorPage : public TechnologyComponentEditor {
  Q_OBJECT
...
class TechMacrosPage : public TechnologyComponentEditor {
  Q_OBJECT

public:
  TechMacrosPage(QWidget *parent, const std::string &cat,
...
class TechLoadOptionsEditorPage : public TechnologyComponentEditor {
  Q_OBJECT
...
class TechSaveOptionsEditorPage : public TechnologyComponentEditor {
  Q_OBJECT
...
class LAY_PUBLIC TechSetupDialog : public QDialog {
  Q_OBJECT
...
protected slots:
  void current_tech_changed(QTreeWidgetItem *current,
...
class LAY_PUBLIC TechComponentSetupDialog : public QDialog {
public:
  TechComponentSetupDialog(QWidget *parent, db::Technology *tech,
