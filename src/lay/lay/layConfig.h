...
static const std::string
    cfg_navigator_all_hier_levels("navigator-show-all-hier-levels");
...
static const std::string
    cfg_layout_file_watcher_enabled("layout-file-watcher-enabled");
...
static const std::string
    cfg_always_exit_without_saving("always-exit-without-saving");
