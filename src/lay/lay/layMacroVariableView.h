 ...
 */
class LAY_PUBLIC MacroVariableView : public QTreeWidget {
  Q_OBJECT
...
public slots:
   ...
   *
   *  If the "show all" flag is set, items with "IfRequested" visibility are
   * shown too.
   */
...
private:
  ...
  void sync_item(QTreeWidgetItem *parent, gsi::Inspector *inspector,
                 const QString &key, size_t index, int pos, bool fresh);
