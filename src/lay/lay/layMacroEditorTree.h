...
class MacroTreeModel : public QAbstractItemModel {
  Q_OBJECT

public:
  MacroTreeModel(QObject *parent, lay::MacroEditorDialog *dialog,
                 lym::MacroCollection *root, const std::string &cat);
  MacroTreeModel(QWidget *parent, lym::MacroCollection *root,
...
class MacroEditorTree : public QTreeView {
  Q_OBJECT
...
public:
  ...
  void update_data() { mp_model->update_data(); }
...
private slots:
  ...
  void model_move_folder(lym::MacroCollection *source,
